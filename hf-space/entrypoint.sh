...
echo "  === ENV CHECK ==="
echo "  OPENROUTER_API_KEY: ${OPENROUTER_API_KEY:+SET (${#OPENROUTER_API_KEY} chars)}${OPENROUTER_API_KEY:-UNSET}"
echo "  PINECONE_API_KEY: ${PINECONE_API_KEY:+SET (${#PINECONE_API_KEY} chars)}${PINECONE_API_KEY:-UNSET}"
echo "  JINA_API_KEY: ${JINA_API_KEY:+SET (${#JINA_API_KEY} chars)}${JINA_API_KEY:-UNSET}"
echo "  SUPABASE_PASSWORD: ${SUPABASE_PASSWORD:+SET (${#SUPABASE_PASSWORD} chars)}${SUPABASE_PASSWORD:-UNSET}"
echo "  NEO4J_AUTH: ${NEO4J_AUTH:+SET (${#NEO4J_AUTH} chars)}${NEO4J_AUTH:-UNSET}"
echo "  N8N_ENCRYPTION_KEY: ${N8N_ENCRYPTION_KEY:+SET}"
echo "  ================="
