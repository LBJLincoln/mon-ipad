...
> Auto-compiled from 64 raw sources on 2026-04-12

## Overview

This topic covers 64 research files spanning political alpha & prediction markets.
...
- **Political Trading Season 2025-26 -- Agent GLM-5.1 ARCHITECT** (2641 words) -- `raw/arena-docs/political-glm-season-2025-26.md`
...
- **NOMOS42 Political Alpha — Scientific Experiment Report** (842 words) -- `raw/political/political-experiment-2026-04-12.md`
...
- **NOMOS42 Political Alpha — Scientific Experiment Report** (842 words) -- `raw/scientific/political-experiment-2026-04-12.md`
...
- Three-File Architecture (CRITICAL) (from `agent-memory/karpathy-researcher_karpathy_autoresearch_pattern.md`)
- 1. `train.py` — THE MODIFIABLE FILE (from `agent-memory/karpathy-researcher_karpathy_autoresearch_pattern.md`)
- 2. `prepare.py` — IMMUTABLE EVALUATION HARNESS (from `agent-memory/karpathy-researcher_karpathy_autoresearch_pattern.md`)
- 3. `program.md` — AGENT INSTRUCTIONS (HUMAN EDITABLE) (from `agent-memory/karpathy-researcher_karpathy_autoresearch_pattern.md`)
- Constraints (from `agent-memory/karpathy-researcher_karpathy_autoresearch_pattern.md`)
- Strategy (Priority Order) (from `agent-memory/karpathy-researcher_karpathy_autoresearch_pattern.md`)
- Prior Near-Misses (from `agent-memory/karpathy-researcher_karpathy_autoresearch_pattern.md`)
- Research Questions (from `agent-memory/karpathy-researcher_karpathy_autoresearch_pattern.md`)
- The Autonomous Loop (CORE PATTERN) (from `agent-memory/karpathy-researcher_karpathy_autoresearch_pattern.md`)
- Cycle Structure: Hypothesis → Modify → Measure → Decide → Loop (from `agent-memory/karpathy-researcher_karpathy_autoresearch_pattern.md`)
- Key Timing Constraints (from `agent-memory/karpathy-researcher_karpathy_autoresearch_pattern.md`)
- Git-Based Ratcheting Mechanism (from `agent-memory/karpathy-researcher_karpathy_autoresearch_pattern.md`)
- Critical Success Requirements (3 Rules) (from `agent-memory/karpathy-researcher_karpathy_autoresearch_pattern.md`)
- 1. Single, Unambiguous Metric (from `agent-memory/karpathy-researcher_karpathy_autoresearch_pattern.md`)
