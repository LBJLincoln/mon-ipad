...
> Auto-generated from experiment data on 2026-04-20 05:00 UTC
...
- **change_min_samples_leaf**: tried 9 times, ZERO improvements. Skip this.
- **change_n_estimators**: tried 4 times, ZERO improvements. Skip this.
- **add_features**: tried 3 times, ZERO improvements. Skip this.
- **change_max_features_ratio**: tried 3 times, ZERO improvements. Skip this.
- **change_model**: tried 7 times, ZERO improvements. Skip this.
- **swap_features**: tried 8 times, ZERO improvements. Skip this.

## NBA — Underperforming Models

- **catboost**: best=1.00000, avg=1.00000 (vs champion random_forest best=0.22158)
- **xgboost**: best=1.00000, avg=1.00000 (vs champion random_forest best=0.22158)
- **gradient_boosting**: best=0.27566, avg=0.27672 (vs champion random_forest best=0.22158)
- **lightgbm**: best=0.23555, avg=0.24917 (vs champion random_forest best=0.22158)
