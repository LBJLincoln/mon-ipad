...
- **change_min_samples_leaf**: tried 11 times, ZERO improvements. Skip this.
...
- **change_min_samples_leaf**: tried 13 times, ZERO improvements. Skip this.
...
- **change_n_estimators**: tried 8 times, ZERO improvements. Skip this.
- **change_max_depth**: tried 4 times, ZERO improvements. Skip this.

## NBA — Underperforming Models

- **random_forest**: best=0.21663, avg=0.21663 (vs champion gradient_boosting best=0.19097)
