...
CHANNELS = {
    ...
    # 2026-04-21 wave 3 REVERTED — mainstream NBA/POL channels removed per user rule
    # (feedback_youtube_channels_no_mainstream.md). DO NOT re-seed @NBA / @HoopsHype /
    # @HouseOfHighlights / @BleacherReport / @TheRingerNBA / @LockedOnNBA / @NBAonESPN /
    # @Axios / @Vox / @POLITICO / @RealClearPolitics — they drown specialized signal in
    # highlight/headline noise and eat YT API quota. Use OAuth @bartolipower subscriptions
    # (scripts/youtube_oauth_subscriptions.py) for NBA/POL breadth instead.
