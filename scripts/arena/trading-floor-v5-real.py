...
def run_backtest():
    # -- Paths --
    odds_path = str(ROOT.parent / "nomos-nba-agent" / "data" / "historical-odds" / "nba_2025-26_odds.csv")
    games_path = str(ROOT / "nba-quant-space" / "data" / "historical" / "games-2025-26.json")
    output_path = str(ROOT / "data" / "nba-agent" / "trading-floor-v5-real.json")
