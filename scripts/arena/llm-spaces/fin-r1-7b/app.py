#!/usr/bin/env python3
"""
Nomos42 Qwen2.5-0.5B CPU LLM Space — Pure FastAPI, OpenAI-compatible.
Model: Qwen2.5-0.5B-Instruct GGUF Q4_K_M (~400 MB)
"""
import os
import time
import threading
...
log = logging.getLogger("qwen25-05b")
...
MODEL_DISPLAY = os.environ.get("MODEL_DISPLAY", "qwen2.5-0.5b-instruct")
