...
SPACES=(
    "D1:research:testforge42-nomos-dept-d1-research"
    "D2:engineering:testforge42-nomos-dept-d2-engineering"
    "D3:evolution:testforge42-nomos-dept-d3-evolution"
    "D4:product:testforge42-nomos-dept-d4-product"
    "D5:business:testforge42-nomos-dept-d5-business"
    "D6:evaluation:testforge42-nomos-dept-d6-evaluation"
