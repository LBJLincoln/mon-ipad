...
- `data/departments/evaluation/`
- `scripts/calibration.py`
- `scripts/calibration_fit.py`
- `scripts/monitoring/auto_pav_refit.sh`
- `data/calibration/`
- `data/nba-agent/calibration-map.json`

Anything outside these paths will be rejected by the runner's allowlist. The PAV refit script is `scripts/monitoring/auto_pav_refit.sh` (NOT `scripts/calibration/pav_refit.py`).
...
```json
{
  ...
  "files_changed": [...],
  "git_diff_stat": "...",
  "calibration_metric": "ECE" | "Brier" | "logloss",
  "metric_value": 0.0042,
  "commit_sha": null,
  "reason_if_no_op": ""
}
