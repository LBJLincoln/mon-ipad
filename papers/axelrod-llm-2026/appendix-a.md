...
literature on regression to the mean in sports performance
[@surowiecki2004wisdom]: in a balanced league, streaks are partially
noise, and extreme recent performance tends to revert. This archetype
...
deliberation is intended to reduce anchoring to the first salient signal,
a well-documented failure mode in LLM prediction [@du2023improving].
