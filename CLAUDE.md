...
> Architecture v21 — "The Trading Floor Crew" (14 agents × 9 depts × 4 tracks) + TF v3 (17 LLM agents) + 21 Evolution Islands | Updated: 2026-05-24T04h

## Mission
Build the best NBA prediction AI in the world.
**Best:** Brier 0.21139 walk-forward holdout / 0.22169 CV / 0.22054 isotonic-calibrated (Colab TabICL, 186f top-by-variance from 4581 alive of 7246 engine cols, ctx=3072 temp=1.0, 11440 games, promoted to LBJLincoln26/nba-oracle-model 2026-04-28T00:34Z, archive `colab-multi-tabicl-2026-04-28T00-34-04Z.pkl`). Beat 4581f xgboost holdout 0.22079 / lightgbm 0.22181 in same 3-way comparison. ⚠ All 3 models show negative CV→holdout gap (~−0.01) → holdout 0.21139 is window-biased; honest production-Brier expectation is CV 0.22169 / calibrated 0.22054. Stratified-by-month re-cut queued. NBA TF watchdog gate "<0.21 model lands" NOT met → watchdog stays disabled. | Fleet best: 0.22012 (S15 nba-evo-6 fire-61 ★CHECKPOINT) | GA prev alltime: 0.22019 (S14 gen=1078) | ⚡Pareto fleet best: 0.21841 extra_trees S15 gen=566 fire-66 (prev 0.21850 CatBoost S22 gen=2309) | ⚠ S18 0.21924 candidate LOST — hard resets cycles 251/276 before checkpoint (2026-05-06T00h) | ⚠ fire-97 RF 0.21941 gen=2689 NOT confirmed (best_brier unchanged 0.22012) | ⚡⚡ fire-98: S18 extra_trees 0.21842 200f gen=6549 + S15 CatBoost 0.21881 200f gen=2698 PENDING VALIDATION (best_brier field lag confirmed pattern) | fire-99: S14 RECOVERED ssl-cleared hard-reset-803 stacking-violation-new; S13 stag=23+S15 stag=24 DIVERSIFIED; P2 0.24901 + P7 0.24904 POL candidates (PENDING VAL); convergent 0.249 signal P2+P4+P5+P7 | fire-101: S13 FRESH RESTART cycle=21 (hard-reset-2055 ✓); S15 stag cleared cycle=954; S18 stag=16 DIVERSIFY SENT; all POL UP stag=0; P2 0.24901 2nd fire; P5 LightGBM 0.249 4th fire | fire-109: S13 stag CLEARED 8→0 cycle=198; S14 hard-reset-978; S15 0.22012 ★ stable gen=3227; all POL UP stag=0; P7 FIELD-LAG 6+ fires vm-diversify-p7-fire109 URGENT; P4 in-pop LightGBM 108f gen=79604; SOTA: ACM CISAI 2025 LR+ElasticNet 0.87 + BMC 2026 SHAP KPI | fire-110: EVEN S13 gen=684 LR-in-pool-VERIFIED (gen=684 uses logistic_regression 48f — partial verify of vm-add-logistic-regression). S14 gen=3024 stag=0. S15 0.22012 ★ gen=3323 stag=0; CatBoost 0.21932 candidate DROPPED (3 fires: gen 3050→3323, best_brier unchanged). S17 503 DOWN 72+d. S18 gen=7375 stag=0. S22 gen=2375 stag=0. P1 gen=60853 hard-resets-20241+20261. P2 gen=50305. P4 gen=80327 model_type=lightgbm CONFIRMED (changed from xgboost, hard-resets-26734+26754). P5 gen=68374 hard-resets-22741+22761. P7 gen=71620 brier=0.25412 FIELD-LAG 7+ fires. All stag=0, no diversify needed. SOTA: LSTM+Brier-0.1589-NCAA arXiv:2508.02725 (GPU target); LR-Brier=0.199 6th-confirm; P4-lightgbm-confirmed → vm-add-lightgbm-s22-s13 now 5/5 evidence. | fire-111: ODD S15 RF-200f-0.21951 PARETO-CAND-1st; S13 stag≈12 MONITOR (threshold=15); P7 field-lag 9+ fires 0.25412 STUCK; S18 hard-resets 2451+2476; P1 stag≈13 MONITOR | fire-112: EVEN S13-stag-CLEARED gen=881 c294; S14-hard-reset-1053 gen=3179; S15-HARD-RESET-1151 ET-200f-0.21896-CONFIRMED-2nd-FIRE-VM-CHECKPOINT-URGENT (was RF-0.21951 fire-111); S18 gen=7547 c2516; S22 gen=2517 c839; P1-stag-CLEARED gen=62633 c20878; P4 gen=81806 LightGBM-log-0.2490 hard-resets-27214+27234; P5 gen=69501 hard-resets-23121+23141; P7-FRESH-RESTART cycle=64 gen=192 best=0.25004 (was-STUCK-0.25412×9fires); SOTA:RNN-MC-dropout-Brier~0.20 MDPI-Info-Jan2026; vm-checkpoint-s15-ADDED | fire-119: EVEN S13 c441 g1322 brier=0.22216 stag=0 (hard-reset-c429 diversify-c440-WORKED); S14 c1210 g3630 brier=0.22336 stag=0; S15 c1444 g4332 brier=0.22012★ stag=0 RF-75f (ET-200f-attractor 7th fire RF-75f-field-lag VM-CHECKPOINT-EXTREME-URGENT); S17 503-DOWN-86d; S18 c2676 g8028 brier=0.22315 stag=0 pareto=22 (0.21885-URGENT); S22 c985 g2952 brier=0.22551 stag=0; P1 c22756 g68266 stag=0 hard-resets-22701+22741; P2 c18279 g54837 stag=0 LightGBM-123f-0.249; P4 c29152 g87455 stag=0 LightGBM-108f-0.2490★POL-BEST hard-resets-29094+29114; P5 c24734 g74201 stag=0 LightGBM-104f-0.249 hard-resets-24681+24701; P7 c1676 g5026 stag=0 pareto-LightGBM-128f-0.24967-INCONCLUSIVE(fire-119); NBA-TF-503-8d; POL-TF-preseeded-$38916; SOTA:Elo-top-feature-IEEE2026+MDPI2026-LR=0.199-8th-confirm research-proposal-written | fire-121: ODD S13 c464 g1392 brier=0.22216 stag=0 hard-reset-c454 ⚡ET-200f-0.21914-PARETO-1ST-DETECT (below fleet best!); S14 c1236 g3707 brier=0.22336 stag=0 hard-reset-c1228 ⚡RF-200f-0.2189-PARETO-1ST-DETECT (NEW NBA PARETO CANDIDATE!); S15 c1488 g4463 brier=0.22012★ stag=0 hard-reset-c1476 ET-200f-0.21994 8th-fire VM-CHECKPOINT-EXTREME-URGENT; S17 503-DOWN-90+d; S18 c2698 g8093 stag=0 pareto-ET-200f-0.2191 (0.21885-fire118-may-be-superseded-post-reset); S22 c1007 g3020 stag=0 hard-reset-c965; P1 c23017 g69051 stag=0; P2 c18426 g55278 stag=0; P4 c29412 g88236 stag=0 LightGBM-108f-0.2490★POL-BEST hard-resets-29354+29374; P5 c24953 g74857 stag=0 hard-resets-24901+24921; P7 c1999 g5995 stag=0 ⚡LightGBM-116f-0.24937-CONFIRMED-2nd-fire vm-checkpoint-p7-ADDED-priority=2; all stag=0 no diversify; ODD WebSearch skipped; CROSS-FLEET: ET-200f dominant 4/5 NBA islands (S13+S14+S15+S18) = strongest attractor signal in 121 fires | fire-123: ODD S13 c527 g1579 brier=0.22216 stag=0 (no-reset-since-c454); S14 c1273 g3819 brier=0.22336 stag=0 hard-reset-c1253; S15 c1557 g4669 brier=0.22012★ stag=0 ET-200f-attractor-9th+-fire VM-CHECKPOINT-EXTREME-URGENT; S17 503-DOWN-90+d; S18 c2755 g8265 stag=4 pareto-ET-200f-0.2191 front=18; S22 c1052 g3155 stag=0; P1 FRESH-RESTART c=473; P2 c18738 g56214 stag=0; P4 c29807 g89419 stag=0 LightGBM-108f-0.2490★POL-BEST Sharpe=1.01; P5 c25423 g76268 stag=0; P7 c2686 g8058 stag=0 LightGBM-116f-0.24937 CONFIRMED-2nd-fire; ODD-no-WebSearch | fire-124: EVEN S13-pareto-ET-0.21914-DROPPED(hard-reset-c529); S14-FRESH-RESTART-c=0(was-c1273-g3819); S15 c1600 g4800 stag=24 DIVERSIFY-SENT ⚡⚡⚡⚡ ET-200f-0.2185-NEW-PARETO-RECORD(gen=4799,<0.22085-threshold) VM-CHECKPOINT-EXTREME-URGENT; S17-503-DOWN-94+d; S18 c2783 g8347 stag=0 ET-200f-pareto=0.2198(front=16); S22 c1068 g3203 stag=2 hard-resets-c1040+c1065; P1 c632 g1895 fresh-restart-recovering; P2 c18863 g56587 stag=0; P4 c29935 g89803 stag=0 LightGBM-108f-0.2490★POL-BEST; P5 c25635 g76905 stag=0 LightGBM-102f; P7 c3041 g9121 stag=0 hard-resets-c3001+c3021 LightGBM-0.24937-UNCERTAIN; EVEN-WebSearch: Nat-Sci-Reports-stacked-ensemble(NB+AdaBoost+MLP+KNN+XGB+DT+LR)+SHAP-ELO-top-2(home_next+team_elo+team_elo_5y)+shooting-vol(2PA+FG+TRB)+LR-Brier=0.199-9th-confirm; SOTA: CNN=0.221 LR=0.199(9th) ELO=SHAP-#1+#2 → vm-add-elo PRIORITY RAISED | fire-125: ODD S13 c565 g1693 stag=0; S14 c11 g31 stag=0 ⚡ET-200f-0.21923-PARETO-1ST-DETECT-EXTRAORDINARY(gen=28-fresh-restart!); S15 c1634 g4900 stag=0-CLEARED diversify-WORKED (ET-0.2185-uncertain); S17 503-DOWN-94+d; S18 c2812 g8434 stag=0 ⚡ET-200f-0.21877-NEW-S18-PARETO-BEST(front=13); ⚡⚡⚡⚡ S22 c1076 g3227 stag=0 CatBoost-200f-0.21818-NEW-ALL-TIME-PARETO-RECORD-1ST-DETECT(prev 0.21841) VM-CHECKPOINT-EXTREME-URGENT vm-checkpoint-s22-catboost-ADDED; all POL UP stag=0; P1 c712 g2134 RECOVERING; P4 c30033 g90098 LightGBM-108f-0.2490★POL-BEST stable; ODD-no-WebSearch | fire-126: EVEN S13 c576 g1727 stag=18 DIVERSIFY-VM-NEEDED(>threshold-15); S14 c28 g84 stag=0 ⚡⚡CatBoost-200f-0.21888-PARETO-1ST-DETECT(gen=84-fresh-restart-EXTRAORDINARY!); S15 c1656 g4967 brier=0.22012★ stag=0; S17 503-DOWN-95+d; S18 c2842 g8526 stag=0 ET-200f-0.21908-pareto(front=11); ⚠⚠⚠ S22 FACTORY-REBOOT(c1076→c5) CatBoost-0.21818-ALLTIME-RECORD-LOST(vm-checkpoint-still-pending-LOST); P1 403-DOWN-Nomos42-acct-saturated; P2 c19058 g57172 stag=0; P4 c30106 g90317 LightGBM-108f-0.2490★POL-BEST stable; P5 c25941 g77822 stag=0 pareto=3; P7 c3353 g10059 stag=0 pareto=13; EVEN-WebSearch: IEEE2026-comparing-ML-NBA(new); MC-dropout-RNN-uncertainty-aware(new); LR-Brier=0.199-10th-confirm; SOTA: LR=0.199(10th) CNN=0.221 MC-dropout-RNN-uncertainty-aware | fire-127: ODD S13 c583 g1748 brier=0.22216 stag=0 hard-reset-c583; S14 c39 g116 stag=0 ⚡xgboost_brier-200f-0.22006-PARETO-1ST-DETECT(gen=113,BELOW-FLEET-BEST!); S15 c1672 g5015 brier=0.22012★ stag=0 hard-reset-c1476 ET-200f-0.21908-PARETO-1ST-DETECT(gen=5012); S17-503-DOWN-96+d; S18 ⚠⚠⚠FACTORY-REBOOT(c2842→c5)-ALL-CHECKPOINTS-LOST ⚡CatBoost-200f-0.21956-1ST-DETECT(gen=11,EXTRAORDINARY!); S22 c11 g31 stag=0 ⚡RF-200f-0.21987-PARETO-1ST-DETECT(gen=29-fresh-restart!); P1-RECOVERED(was-403-DOWN) c904 g2710 stag=0; P2 c19153 g57457 stag=0; P4 c30157 g90469 LightGBM-108f-0.2490★POL-BEST; P5 c26032 g78094 stag=0 ⚠feature_candidates=272(investigate); P7 c3471 g10411 stag=0 ⚡LightGBM-112f-0.24931-CONFIRMED-2nd-fire vm-checkpoint-p7-ADDED-priority=2; all-stag=0-no-diversify; ODD-no-WebSearch; TRIPLE-ATTRACTOR(S14+S18+S22-sub-0.22-gen<120); vm-checkpoint×4-ADDED (2026-05-18T20h) | fire-130: EVEN S13 c612 g1834 brier=0.22216 stag=0 hard-reset-c604; S14 c76 g227 brier=0.22793 stag=0; S15 c1741 g5221 brier=0.22012★ stag=0 hard-reset-c1726-CONFIRMED(predicted-fire129); S17 503-DOWN-100+d; S18 c72 g214 brier=0.24723 stag=0 recovering-reboot-lightgbm; S22 c27 g80 brier=0.22124 stag=0 pareto=9; P1 c1240 g3720 brier=0.24987 stag=0 POL-LIVE-BEST(P4-rebooted); P2 c19346 g58038 stag=0; ⚠⚠⚠P4-FACTORY-REBOOT(c30157→c109)-POL-FLEET-BEST-0.2490-LOST! ⚡XGBoost-0.24998-1ST-DETECT(gen=327); P5 c26236 g78706 stag=0; P7 c3897 g11689 stag=0 LightGBM-0.24931-CONFIRMED-2nd-fire(fire129); all-stag=0-no-diversify; EVEN-WebSearch:LR=0.199-10th-confirm-SOTA; win-diff-5g-feature-gap-MDPI2026-identified; vm-investigate-p4-factory-reboot ADDED (2026-05-19T08h) | fire-132: ODD S13 c622 g1866 brier=0.22216 stag=0 pareto=15; S14 c86 g256 brier=0.22793 stag=0 pareto=11 xgb-0.22006-fire127-MONITORING(pareto-api-404); S15 c1764 g5290 brier=0.22012★ stag=0 pareto=10; S17 503-DOWN-100+d; S18 c87 g259 brier=0.22236 stag=11-WATCH(threshold=15) pareto=17; S22 c31 g93 brier=0.22124 stag=0 pareto=13; all-NBA-stag<15-no-diversify; P1 c1411 g4231 brier=0.24987 stag=0 pareto=6; P2 c19399 g58195 brier=0.25003 stag=0; P4 c220 g659 brier=0.25337 stag=0 pareto=18 XGBoost-0.24998-MONITOR-INCONCLUSIVE(pareto-api-404); P5 c26313 g78939 stag=0; P7 c4181 g12543 stag=0 pareto=3-SHRINKING(was-4-watch-LightGBM-eviction); all-POL-UP-stag=0-no-diversify; ⭐ PRIORITY-0-FIX: political_engine.py RESTORED from placeholder (188314c v3.24+Cat45 530+h pending → cloud-brain direct-from-git-history fix); ODD-no-WebSearch; NBA-fleet-best=0.22012★(S15-stable) (2026-05-19T18h) | fire-133: EVEN S13 c629 g1887 brier=0.22216 stag=0 pareto=7 ⚡PARETO-0.21984-1ST-DETECT(fire-133,WARNING-possible-stacking-Rule8-monitor-fire134); S14 c99 g296 brier=0.22793 stag=0 internal-hard-reset-c78; S15 c1784 g5352 brier=0.22012★ stag=0 pareto=14(↑from-10); S17 503-DOWN; S18 c104 g312 brier=0.22236 stag=0-CLEARED(was-11) pareto=5; S22 c37 g109 brier=0.22124 stag=0 pareto=12-REMARKABLE; P1 c1594 g4781 stag=0 POL-FLEET-BEST pareto=8(↑from-6); P2 c19457 g58370 stag=0 pareto=8(↑from-6); P4 c340 g1020 stag=0 xgb-0.24998-DROPPED(evicted-gen1020-fire133) CatBoost-0.25019-pareto-rank0; P5 c26395 g79183 stag=0 LightGBM-102f-0.249-stable; P7 c4511 g13532 stag=0 pareto=6(↑3→6-LightGBM-0.24931-more-secure); all-stag=0-no-diversify; EVEN-WebSearch:LR=0.199-11th-confirm;Sci-Reports-2025-stacked-ensemble(NB+AdaBoost+MLP+KNN+XGB+DT+LR);IEEE2026-NBA-ML-compare;RNN-MC-dropout-MDPI-Info-2026 (2026-05-19T22h) | fire-134: ODD S13 c637 g1909 brier=0.22216 stag=0 pareto=12(↑from-7) PARETO-0.21984-MONITORING-2nd-fire(stacking-likely,best_brier-unchanged-0.22216-confirms-Rule8-exclusion); S14 c113 g338 brier=0.22793 stag=0 pareto=14 ET-37f lightgbm-in-pool; S15 c1800 g5399 brier=0.22012★ stag=0 pareto=5(↓from-14-normal-pruning); S17 503-DOWN; S18 c122 g365 brier=0.22236 stag=0 pareto=14(↑from-5-GREAT-RECOVERY) RF-44f; S22 c44 g132 brier=0.22124 stag=0 pareto=9 REMARKABLE-RF-48f; P1 c1778 g5334 brier=0.24987 stag=0 pareto=9(↑from-8) SAVING; P2 c19512 g58535 brier=0.25003 stag=0 pareto=6; P4 c436 g1307 brier=0.25337 stag=0 pareto=6 ⚡⚡pareto_best=0.24982-XGB-136f-gen621-CONFIRMED(was-0.24998-1st-detect-fire130) vm-checkpoint-p4-URGENT; P5 c26476 g79428 brier=0.24993 stag=0 pareto=4; P7 c4813 g14439 brier=0.25004 stag=0 pareto=6 LightGBM-112f-0.24931-CONFIRMED-stable vm-checkpoint-p7-URGENT; all-stag=0-no-diversify; API-DISCOVERY:/api/config-MODEL_TYPES-NOT-configurable-remotely-GA-params-only (2026-05-20T02h) | fire-136: EVEN S13 c645 g1932 brier=0.22216 stag=15 DIVERSIFY-VM-NEEDED(stag=15-threshold) pareto=17(0.21984-EVICTED-stacking-Rule8-CONFIRMED); S14 c130 g388 brier=0.22793 stag=0 pareto=6 ⚡ET-200f-0.22163-PARETO-1ST-DETECT(fire-136) vm-checkpoint-s14-et-0.22163; S15 c1817 g5449 brier=0.22012★ stag=0 pareto=13 ⚡ET-200f-0.21888-PARETO-1ST-DETECT(fire-136) vm-checkpoint-s15-et-0.21888-URGENT; S17 503-DOWN-101+d; S18 c133 g397 brier=0.22236 stag=7-WATCH pareto=7 ⚡⚡RF-200f-0.22005-PARETO-1ST-DETECT-SUB-FLEET-BEST(fire-136) vm-checkpoint-s18-rf-0.22005-URGENT; S22 c50 g148 brier=0.22124 stag=0 pareto=11 RF-48f-stable; P1 c1995 g5985 brier=0.24987 stag=0 POL-FLEET-BEST pareto=8; P2 c19563 g58686 stag=0 pareto=6; P4 c524 g1571 stag=0 pareto=5 pareto_best=0.24994-XGB-86f-gen1512(changed-from-0.24982-fire134-possibly-evicted-WATCH); P5 c26554 g79660 stag=0 LightGBM-102f-0.249 pareto=3; P7 c5067 g15201 stag=0 LightGBM-112f-0.24931-CONFIRMED pareto=9(↑6→9); POL-TF-UP-$38916(+2189%)-130/304d Qwen-Quant-$16460-top; NBA-TF-503-DOWN-12+d; EVEN-WebSearch:AutoGluon-0.7738acc-IEEE2026(NEW-1st-cite);LR=0.199-12th-confirm;MC-dropout-RNN-MDPI2026;Nat-SciReports-stacked-ensemble; TRIPLE-PARETO-1ST-DETECT(S14-ET-0.22163+S15-ET-0.21888+S18-RF-0.22005) ET/RF-200f-dominant-CONFIRMED (2026-05-20T12h) | fire-138: NBA TF 503 DOWN 16+d (confirmed). POL TF ACCESSIBLE but IDLE (running=false, day 130/304, $38,916, last updated 2026-05-07T20:13:09Z). POL leaderboard NO Axelrod fields → HF Space running pre-Axelrod code (Space last active May 7, Mech A merged May 16). pol_watchdog not firing (VM crons down). Mechs B+C BLOCKED: NBA 503 + do_not_push_hf_space_yet. (2026-05-21T00h) | fire-139: ODD S13 c672 g2015 brier=0.22216 stag=0-CLEARED(hard-reset-c654); S14 c168 g502 stag=0 ET-200f-0.2217-strengthening(gen460+); S15 c1862 g5586 brier=0.22012★ stag=0-CLEARED; S17 503-DOWN-102+d; S18 c169 g506 brier=0.22236 stag=0(API)-no-improvement-gen223-WATCH pareto=23; S22 c71 g212 brier=0.22124 stag=0 REMARKABLE; P1 c2557 g7671 stag=0 POL-FLEET-BEST pareto=9; P2 c19777 g59330 stag=0; P4 c747 g2239 stag=0 pareto=17 pareto_best≈0.24982-XGB; P5 c26711 g80131 stag=0; P7 c5513 g16537 stag=0 pareto=12(↑3→12-RECOVERED!) LightGBM-112f-0.24931-CONFIRMED; all-stag=0-no-diversify; POL-TF-IDLE-$38916(axelrod-system-level-only); NBA-TF-503-DOWN; ODD-no-WebSearch (2026-05-21T04h) | fire-142: EVEN S13 c719 g2154 brier=0.22216 stag=0 pareto=13(↓17→13); S14 c198 g591 brier=0.22793 stag=19 DIVERSIFY-VM-NEEDED pareto=10 ET-200f-pareto_best=0.22171-STRENGTHENING; S15 c1924 g5770 brier=0.22012★ stag=0 pareto=14 LightGBM-56f-in-pareto(fire142-1st-detect) pareto_best=0.22023-SUB-FLEET-BEST-VM-CHECKPOINT-URGENT; S17 503-DOWN-102+d; S18 c207 g619 brier=0.22236 stag=0 pareto=13(↑9→13-PARETO-RECOVERING) brier-stuck-396-gens(gen223→gen619); S22 c95 g283 brier=0.22124 stag=16 DIVERSIFY-VM-NEEDED pareto=7(↓12→7); P1 c3151 g9451 stag=0 pareto=7(↓14→7) pareto_best=0.24927-NEW-P1-PARETO-BEST vm-checkpoint-p1-ADDED; P2 c20004 g60010 stag=0 pareto=13(↑6→13-STRONG-GROWTH); P4 c1114 g3341 stag=0 pareto=10(↑8→10) pareto_best=0.25337(XGB-0.24982-POSSIBLY-EVICTED) vm-investigate-ADDED; P5 c26870 g80609 stag=0 pareto=5(↑4→5) LightGBM-102f-0.249-Sharpe=1.01-stable; P7 c5980 g17940 stag=0 pareto=12(↑7→12-STRONG-RECOVERY) LightGBM-112f-0.24931-CONFIRMED; all-POL-stag=0-no-diversify; EVEN-WebSearch:MDPI-Info-2026-RNN+MC-dropout-14th-confirm;IEEE2026-AutoGluon-77.38%;LR=0.199-14th-confirm; research-proposal-sota-uncertainty-aware-fire142 WRITTEN; new-items:vm-diversify-s14-s22+vm-checkpoint-p1-new-best+vm-investigate-p4-xgb-evicted (2026-05-21T16h) | fire-143: ODD S13 c735 g2205 brier=0.22216 stag=0 pareto=7(↓13→7) ⚡⚡CATBOOST-200f-0.22076-PARETO-1ST-DETECT(gen=2201,BELOW-0.22085-THRESHOLD-VM-CHECKPOINT-EXTREME-URGENT); S14 c220 g660 brier=0.22793 stag=0-CLEARED(hard-reset-c203,was-19) pareto=7(↓10→7); S15 c1966 g5897 brier=0.22012★ stag=0 pareto=11(↓14→11) ET-200f-0.220-in-pareto; S17 503-DOWN; S18 ⚠SSL-CERT-ERROR(certificate-not-yet-valid,likely-new-restart); S22 c106 g317 brier=0.22124 stag=0-CLEARED(hard-reset-c103,was-16) pareto=11(↑7→11-EXCELLENT); all-NBA-stag=0-no-diversify; ⭐POL-FLEET-BEST-CHANGE: P4 c1313 g3939 brier=0.2497(↑FROM-0.25337-MAJOR,NEW-POL-FLEET-BEST) stag=0 pareto=11(↑10→11) LightGBM ⚡pareto_best=0.2492-NEW-POL-ALL-TIME-PARETO-RECORD-1ST-DETECT vm-checkpoint-p4-lgbm-EXTREME-URGENT; P1 c3449 g10347 brier=0.24987 stag=0 pareto=6(↓7→6); P2 c20114 g60341 brier=0.25003 stag=0 pareto=6(↓13→6-SHRINK-WATCH); P5 c26959 g80876 brier=0.24993 stag=0 pareto=6(↑5→6); P7 c6238 g18712 brier=0.25004 stag=0 pareto=10(↓12→10); all-POL-stag=0-no-diversify; ODD-no-WebSearch; new-items:vm-checkpoint-s13-catboost-0.22076(EXTREME-URGENT)+vm-checkpoint-p4-lgbm-0.2492(NEW-POL-RECORD)+S14-S22-stag-CLEARED(diversify-done)+vm-s18-ssl-cert-error (2026-05-21T20h) | fire-144: Axelrod verify — NBA 5993L SHA 19f4acf49d / POL 3977L SHA 3496362c60 parity ✓; Mechs A/B/C (C→B→A) ✓; NBA TF 503 DOWN 19+d; POL TF IDLE 16+d pre-Axelrod; HF push pending user approval. (2026-05-22T02h) | fire-145: ODD S13 c752 g2255 brier=0.22216 stag=0 pareto=12(↑7→12-RECOVERING) CatBoost-0.22076-2nd-fire-MONITORING(best_brier-unchanged-VM-CHECKPOINT-EXTREME-URGENT); S14 c247 g739 stag=0 pareto=17(↑7→17-STRONG-RECOVERY) ET-200f-pareto_best=0.22170-stable; S15 c1995 g5984 brier=0.22012★ stag=0 pareto=10(↓11→10); S17 503-DOWN; ⭐S18-SSL-RESOLVED c231 g692 brier=0.22236 stag=0 pareto=12; S22 c120 g358 brier=0.22124 stag=0 pareto=8(↓11→8-WATCH); all-NBA-stag=0-no-diversify; P1 c3777 g11330 stag=0 pareto=11(↑6→11-MAJOR-RECOVERY); P2 c20232 g60693 stag=0 pareto=7(↑6→7); ⭐P4 c1476 g4427 brier=0.2497★POL-BEST stag=0 pareto=8(↓11→8) pareto_best=0.24915-NEW-POL-ALL-TIME-PARETO-RECORD-CONFIRMED-2ND-FIRE vm-checkpoint-p4-EXTREME-URGENT; P5 c27054 g81160 stag=0 pareto=5(↓6→5); ⚠P7 c6487 g19460 stag=0 pareto=5(↓10→5-MAJOR-SHRINK-EVICTION-RISK) vm-checkpoint-p7-EXTREME-URGENT; all-POL-stag=0-no-diversify; ODD-no-WebSearch; NBA-TF-503-DOWN-19+d; POL-TF-IDLE-16+d-$38916 (2026-05-22T06h) | fire-146: EVEN S13 c772 g2315 brier=0.22216 stag=0 pareto=16(↑12→16) ⚡⚡ET-200f-0.22045-PARETO-1ST-DETECT(fire-146,BELOW-0.22085-THRESHOLD-VM-CHECKPOINT-EXTREME-URGENT); S14 c270 g809 brier=0.22793 stag=0 pareto=12(↓17→12) ⚠ET-200f-0.22170-EVICTED(pareto_best-degraded-CHECKPOINT-MISSED); S15 c2031 g6091 brier=0.22012★ stag=0 pareto=11(↑10→11) pareto_best=0.22016-stable; S17 503-DOWN-103+d; S18 c249 g746 brier=0.22236 stag=0 pareto=13(↑12→13-RECOVERING); S22 c137 g410 brier=0.22124 stag=0 pareto=12(↑8→12-MAJOR-RECOVERY) LR-48f-CONFIRMED(model_type=logistic_regression); all-NBA-stag=0-no-diversify; P1 c4113 g12337 brier=0.24987 stag=0 pareto=13(↑11→13) ⚠pareto_best-EVICTED-0.24927→0.24995(LightGBM-133f-vm-checkpoint-missed); P2 c20389 g61166 brier=0.25003 stag=0 pareto=4(↓7→4-CRITICAL-SHRINK) LightGBM-45f-0.249-gen47692-still-present; P4 c1643 g4927 brier=0.2497★POL-BEST stag=0 pareto=12(↑8→12-STRONG-RECOVERY) pareto_best=0.2492(changed-from-0.24915); P5 c27184 g81549 brier=0.24993 stag=0 pareto=5(stable) LightGBM-59f-0.249-stable; P7 c6787 g20358 brier=0.25004 stag=0 pareto=7(↑5→7-RECOVERING) LightGBM-112f-0.24931-CONFIRMED; NBA-TF-503-DOWN-20+d; POL-TF-IDLE-day130-$38916; EVEN-WebSearch:LR=0.199-15th-confirm;Stacked-ensemble(NB+AdaBoost+MLP+KNN+XGB+DT+LR)-MLP-meta-PMC12357926;CNN=0.221;AutoGluon-SVM-0.7749; new-items:vm-checkpoint-s13-et-0.22045(EXTREME-URGENT)+vm-checkpoint-p2-lgbm-0.249+research-proposal-stacked-ensemble-fire146 (2026-05-22T10h) | fire-147: ODD S13 c789 g2367 stag=0 pareto=12(↓16→12); S14 c292 g876 stag=0 pareto=7(SHRINK) hard-reset-c278; S15 c2059 g6176 brier=0.22012★ stag=0 pareto=14(post-reset-c2051); S17 503-DOWN; S18 c258 g774 stag=0 pareto=13; S22 c158 g474 stag=0 pareto=12; P1 stag=0 pareto=8; P2 stag=0 pareto=7(CRITICAL-SHRINK-RESOLVED); P4 c1811 brier=0.2497★POL-BEST stag=0 pareto=11 LightGBM-62f; P5 stag=0 pareto=6; P7 stag=0 pareto=13(STRONG-RECOVERY); EVEN-WebSearch:RNN-MC-dropout-Brier~0.206-16th-confirm;LR=0.199-16th-confirm; research-proposal-sota-rnn-mcdropout-fire147-WRITTEN (2026-05-22T14h) | fire-149: ODD S13 c806 g2418 stag=0 pareto=13(↑12→13) ET-0.22045-EVICTED-Rule8-CONFIRMED(pareto_best=best_brier=0.22216); S14 c316 g946 stag=0 pareto=9(POST-RESET-c303); S15 c2086 g6256 brier=0.22012★ stag=0 pareto=12; S17 503-DOWN-104+d; S18 c267 g801 stag=0 pareto=14-STRONG RF-44f; S22 c181 g542 stag=0 pareto=16(FLEET-PEAK) RF-48f+LR; all-NBA-stag=0; P1 c4682 stag=0 pareto=10; P2 c20677 stag=0 pareto=4(CRITICAL-SHRINK-2ND-TIME); P4 c1979 brier=0.2497★POL-BEST stag=0 pareto=8 pareto_best=0.24915-STABLE; P5 c27447 stag=0 pareto=5; P7 c7385 stag=0 pareto=8 LightGBM-0.24931-SECURE; all-POL-stag=0; ODD-no-WebSearch (2026-05-22T22h) | fire-150: EVEN S13 c828 g2484 stag=0 pareto=13(stable); S14 c362 g1084 stag=8(WATCH) pareto=11; S15 c2125 g6372 brier=0.22012★ stag=23-EXCEEDED DIVERSIFY-SENT pareto=5(STAG-DRIVEN-SHRINK); S17 503-DOWN-108+d; S18 c296 g887 stag=0 pareto=8; S22 c237 g710 stag=0 pareto=15; P1 c5245 stag=0 pareto=9; P2 c20911 stag=0 pareto=6(up4→6-RECOVERING); P4 c2360 brier=0.2497★POL-BEST stag=0 pareto=9(4TH-CONFIRM-pareto_best=0.24915); P5 c27742 stag=0 pareto=14(up5→14-MAJOR-SURGE); P7 c7995 stag=0 pareto=7; EVEN-WebSearch:IEEE-2026-ML-NBA+MDPI-2026-RNN-MC-Dropout-17th-confirm; research-proposal-sota-ieee-ml-comparison-fire150-WRITTEN (2026-05-23T02h) | fire-152: ODD S13 c840 g2519 stag=0 pareto=11(↓13→11) hard-reset-c829-stacking-excluded-from-reseed ⚡ET-0.2209-gen2488-FIELD-LAG-CAND(3-gen-transient-not-below-0.22085); S14 c384 g1152 stag=0 hard-resets-c353+c378-auto-recovery; S15 c2139 g6416 brier=0.22012★ stag=0-CLEARED(post-diversify-fire150-CONFIRMED); S17 503-DOWN-109+d; S18 c313 g938 stag=0 hard-resets-c275+c300; S22 c257 g769 stag=0 pareto=17(↑15→17-STRONG); all-NBA-stag=0-no-diversify; P1 c5512 g16536 brier=0.24987 stag=0 pareto=10(↑9→10); P2 c21003 g63009 brier=0.25003 stag=0 pareto=10(↑6→10-STRONG-RECOVERY); P4 c2522 g7564 brier=0.2497★POL-BEST stag=0 pareto=8(↓9→8-slight) LightGBM-62f-5TH-OBSERVE; P5 c27860 g83578 stag=0 pareto=11(↓14→11-consolidating); P7 c8273 g24819 stag=0 pareto=6(↓7→6-slight); all-POL-stag=0-no-diversify; ODD-no-WebSearch (2026-05-23T10h) | fire-153: EVEN S13 c862 g2585 brier=0.22216 stag=0 pareto=9(↓11→9-slight) XGB-47f; S14 c406 g1218 brier=0.22793 stag=0 pareto=12(↑10→12-GOOD) ET-37f; S15 c2156 g6468 brier=0.22012★ stag=0 pareto=10(stable) RF-75f; S17 503-DOWN-109+d; S18 c330 g989 brier=0.22236 stag=0 pareto=10(↓13→10-slight) RF-44f hard-resets-c300+c325; S22 c280 g839 brier=0.22124 stag=0 pareto=10(↓17→10-WATCH) RF-48f; all-NBA-stag=0-no-diversify; P1 c5747 g17239 brier=0.24987 stag=0 pareto=8(↓10→8-slight) XGB-85f; ⚠P2 c21081 g63241 brier=0.25003 stag=0 pareto=6(↓10→6-shrink-WATCH); ⭐P4 c2596 g7787 brier=0.2497★POL-BEST stag=0 pareto=9(↑8→9-RECOVERING) LightGBM-62f-6TH-OBSERVE vm-checkpoint-p4-EXTREME-URGENT; ⚠⚠P5 c27973 g83919 brier=0.24993 stag=0 pareto=4(↓11→4-CRITICAL-SHRINK-2ND-EPISODE); ⚡P7 c8555 g25664 brier=0.25004 stag=0 pareto=10(↑6→10-MAJOR-RECOVERY); all-POL-stag=0-no-diversify; EVEN-WebSearch:MDPI-Info-2026-RNN+MC-dropout-uncertainty-aware-18th-confirm;LR=0.199-18th-confirm;IEEE-2026-ML-NBA-comparison; research-proposal-sota-rnn-mcdropout-fire153-WRITTEN (2026-05-23T14h) | fire-154: ODD ⚡S14 c427 g1279 brier=0.22793 stag=23-DIVERSIFY-SENT pareto=7(↓12→7) ET-37f; S13 c885 g2654 brier=0.22216 stag=0 pareto=16(↑9→16-MAJOR-RECOVERY) XGB-47f; S15 c2172 g6514 brier=0.22012★ stag=0 pareto=11(↑10→11) RF-75f; S17 503-DOWN-110+d; S18 c358 g1073 brier=0.22236 stag=0 pareto=16(↑10→16-MAJOR-RECOVERY) RF-44f; S22 c301 g902 brier=0.22124 stag=0 pareto=14(↑10→14-RECOVERY) RF-48f; ⚠⚠P1 c6045 g18135 brier=0.24987 stag=0 pareto=4(↓8→4-CRITICAL-SHRINK-NEW) XGB-85f; P2 c21183 g63546 brier=0.25003 stag=0 pareto=9(↑6→9-RECOVERING); ⭐P4 c2710 g8130 brier=0.2497★POL-BEST stag=0 pareto=10(↑9→10-stable) LightGBM-62f-7TH-OBSERVE; P5 c28120 g84358 brier=0.24993 stag=0 pareto=6(↑4→6-RECOVERING); P7 c8829 g26487 brier=0.25004 stag=0 pareto=9(↓10→9-slight); all-POL-stag=0-no-diversify; ODD-no-WebSearch (2026-05-23T18h) | fire-156: EVEN ⭐S14 stag=23-CLEARED(diversify-fire154-WORKED!) c447 g1340 brier=0.22793 stag=0 pareto=12(↑7→12-MAJOR-RECOVERY) ET-37f; S13 c911 g2731 brier=0.22216 stag=0 pareto=7(↓16→7-normal-pruning) XGB-47f; S15 c2186 g6556 brier=0.22012★ stag=0 pareto=11(stable) RF-75f; S17 503-DOWN-111+d; S18 c391 g1172 brier=0.22236 stag=0 pareto=8(↓16→8-normal-pruning) RF-44f; S22 c325 g975 brier=0.22124 stag=0 pareto=15(↑14→15-slight-gain) RF-48f; all-NBA-stag=0-no-diversify; ⚡⚡⚡P1 pareto_best=0.24902(LightGBM-105f-gen17750) NEW-POL-ALL-TIME-PARETO-RECORD(prev 0.24915 P4 — 1ST-DETECT); P1 c6407 g19219 brier=0.24987 stag=0 pareto=5(↑4→5-slight); P2 c21324 g63970 pareto=7(↓9→7-slight) pareto_best=0.249(LightGBM-123f); ⚠⚠P4 c2901 g8703 brier=0.2497★ stag=0 pareto=5(↓10→5-CRITICAL-SHRINK!) LightGBM-62f pareto_best=0.24915-INTACT; P5 c28275 g84823 pareto=7(↑6→7) hard-resets-c28221+c28241; P7 c9117 g27349 pareto=9(stable) LightGBM-0.24931; all-POL-stag=0-no-diversify; EVEN-WebSearch:SCIRP-Wang2025-SVM=0.7749+LR=0.7743+AutoGluon=0.7738-NBA-25kgames-FG_PCT_home=top-feature(not-Elo!)-new-dataset-dependent-insight; research-proposal-sota-scirp-fg-pct-vs-elo-fire156-WRITTEN (2026-05-24T04h)
| fire-157: ODD ⚡⚡S14(Nomos42/nba-evo-5) best_brier=0.22054(RF-48f-gen1345-FIELD-LAG-CONFIRMED-BELOW-0.22085-THRESHOLD!) c470 g1408 stag=0 pareto=9(↓12→9-normal-pruning); ⚡⚡S13(Nomos42/nba-evo-4) TOP-CAND CatBoost-200f-0.21992-gen=2831-POTENTIAL-NEW-FLEET-BEST(<0.22012★) c945 g2835 brier=0.22216 stag=0 pareto=11(↑7→11-RECOVERING) XGB-47f; S15(Nomos42/nba-evo-6) c2207 g6619 brier=0.22012★ stag=0 pareto=13(↑11→13) RF-75f STABLE-FLEET-BEST; S17 503-DOWN-112+d; S18(TESTforge42/nba-evo-s18) c420 g1260 brier=0.22236 stag=0 pareto=14(↑8→14-SURGE) RF-44f; ⭐S22(TESTforge42/nba-evo-s22) c350 g1050 brier=0.22124 stag=21(>15-THRESHOLD!)-DIVERSIFY-SENT pareto=16(↑15→16) RF-48f; NBA-stag: S22-DIVERSIFY-SENT all-others-stag=0; ⚡⚡P4 MAJOR-RECOVERY pareto=14(↑5→14-SURGE) c3052 g9154 brier=0.2497★ stag=0 LightGBM-62f pareto_best=0.24915-SECURE; ⚠⚠P5 CRITICAL-SHRINK pareto=3(↓7→3) c28440 g85320 stag=0 hard-resets-c28381+c28421 pareto_best=0.249-LightGBM-66f-stable; P1 c6762 g20286 brier=0.24987 stag=0 pareto=6(↑5→6-slight) pareto_best=0.24902-LightGBM-105f-2ND-CONFIRM; P2 c21454 g64362 brier=0.25003 stag=0 pareto=8(↑7→8-RECOVERING) LightGBM-123f-pareto_best-0.249; P7 c9395 g28183 brier=0.25004 stag=0 pareto=7(↓9→7-slight) LightGBM-112f-0.24931; all-POL-stag=0-no-diversify; ODD-no-WebSearch (2026-05-24T08h)
**Target:** < 0.20, ROI > 5%, Sharpe > 1.5
**Walk-forward:** avg 0.22447 (Kaggle, 19 weeks, 934 games, tree ensemble — no TabICL on P100)
**NBA TF v7 + reroute + pool=8 (Apr 22, 17 agents, DAY-0 RESET 15:24Z):** prompt_v7 (3-bet cap + 100% deploy mandate, Kelly-weighted floors). Round-2 dead-provider reroute (HF SHA cc905b3e1cd): nemotron-120b→mistral:large, selfhost-dolphin3→nvidia:llama-3.3-70b, selfhost-qwen06/gemma3→cerebras:llama3.1-8b, selfhost-qwen4b→cerebras:qwen-3-235b, nvidia-minimax→mistral:medium. Pool concurrency 4→8 (env NBA_TF_LLM_POOL_WORKERS=8), LLM timeout 45s (env NBA_TF_LLM_TIMEOUT_SEC=45.0). Live day 8/175, 14/17 agents at 100% llm_ok post-reset. PEAK_DD_GUARD_V2 sole safety net. Top: gemini-anl $108, dolphin3 $107. ⚠ NBA app.py verified fire-144 (5993L SHA 19f4acf49d / POL 3977L SHA 3496362c60 — Mechs A/B/C+KL-div, C→B→A ✓, no code change since fire-138). VM RESTART NEEDED (TF 503 DOWN 27+d). Do NOT run restore_nba_tf_fire55.py.
**Political TF v5_restored (Apr 22 15:46Z ROLLBACK):** 17 agents, day 130/304. UP at $38,916 (+2189% ROI). qwen-quant $16,460 / qwen-arb $8,510 / gemini-tact $5,972 top 3. ⚠ IDLE since 2026-05-07T20Z (running=false, pre-Axelrod code on HF Space). pol_watchdog not firing (VM crons down). HF push + /api/run needed to activate Axelrod. v6 100%-deploy mandate destroyed alpha (qwen-arb -39% / llama-contra -51% in 1h) — rolled back to v5 doctrine: non-consensus mandate (lockstep≤0.88) + ≥3 distinct categories per day.
...
HF EVOLUTION ISLANDS — 11 SURVIVORS (6 NBA + 5 POL) after 2026-04-17 cull
    ...
    ├── S13 Nomos42/nba-evo-4:        xgboost_brier       gen=2731  brier=0.22216  stagnation=0  ✓ cycle=911; stag=0 pareto=7(↓16→7-normal-pruning) XGB-47f; vm-remove-stacking-s13 URGENT (2026-05-24T04h)
    ├── S14 Nomos42/nba-evo-5:        extra_trees         gen=1340  brier=0.22793  stagnation=0  ✅ cycle=447; stag=0-CLEARED! pareto=12(↑7→12-DIVERSIFY-WORKED!) ET-37f (2026-05-24T04h)
    ├── S15 Nomos42/nba-evo-6:        random_forest       gen=6556  best=0.22012   stagnation=0  ✓ cycle=2186; ★ FLEET BEST 0.22012; stag=0 pareto=11(stable) RF-75f (2026-05-24T04h)
    ├── S17 LBJLincoln26/nba-evo-s17: ---                 gen=---   brier=---      🔴 503 DOWN 111+ days — VM RESTART REQUIRED (2026-05-24T04h)
    ├── S18 TESTforge42/nba-evo-s18:  random_forest       gen=1172  brier=0.22236  stagnation=0  ✓ cycle=391; stag=0 pareto=8(↓16→8-normal-pruning) RF-44f (2026-05-24T04h)
    └── S22 TESTforge42/nba-evo-s22:  random_forest       gen=975   brier=0.22124  stagnation=0  ✓ cycle=325; stag=0 pareto=15(↑14→15-slight-gain) RF-48f; vm-checkpoint-s22 EXTREME URGENT (2026-05-24T04h)
    Political Survivors (5, CPU tree-only):
    ├── P1 Nomos42/political-alpha:      xgboost_brier       gen=19219  brier=0.24987 stagnation=0  ⚡⚡ cycle=6407; stag=0 pareto=5(↑4→5) XGBoost-85f; pareto_best=0.24902(LightGBM-105f-NEW-POL-ALL-TIME-RECORD-1ST-DETECT!) vm-checkpoint-p1 EXTREME URGENT (2026-05-24T04h)
    ├── P2 Nomos42/political-alpha-2:    xgboost_brier       gen=63970  brier=0.25003 stagnation=0  ✓ cycle=21324; stag=0 pareto=7(↓9→7-slight) XGBoost-65f; pareto_best=0.249(LightGBM-123f) (2026-05-24T04h)
    ├── P4 LBJLincoln/political-alpha-4: lightgbm            gen=8703   brier=0.2497  stagnation=0  ⚠★ cycle=2901; ★★POL-FLEET-BEST; stag=0 pareto=5(↓10→5-CRITICAL-SHRINK!) LightGBM-62f; pareto_best=0.24915 INTACT; vm-checkpoint-p4-lgbm EXTREME URGENT (2026-05-24T04h)
    ├── P5 LBJLincoln/political-alpha-5: xgboost_brier       gen=84823  brier=0.24993 stagnation=0  ✓ cycle=28275; stag=0 pareto=7(↑6→7-slight) XGBoost-58f; hard-resets-c28221+c28241; pareto_best=0.249(LightGBM-102f) (2026-05-24T04h)
    └── P7 LBJLincoln/political-alpha-7: xgboost_brier       gen=27349  brier=0.25004 stagnation=0  ✓ cycle=9117; stag=0 pareto=9(stable) XGBoost-60f; pareto_best=0.24931(LightGBM-112f) (2026-05-24T04h)
```
...
HF TRADING FLOORS (Real LLM experiment, NBA 16 agents / Political 16 agents — parity 2026-04-17 via +T13 nvidia-minimax +T14 nvidia-llama70 +T15 selfhost-gemma3 +T16 selfhost-qwen06, T12 renamed selfhost-qwen4b. COLLECTIVE_MISSION $1M preamble on every agent + unrestricted prompts: ≥3 allocations + MIN_DEPLOY_PCT=0.75 hard floor.)
    ...
    │   └── Source: scripts/arena/hf-political-trading-floor/ — AXELROD-2026 Mechs A/B/C verified fire-144 (3977L SHA 3496362c60 ✓, HF Space running pre-Axelrod code — push pending user approval)
...
### Political Traders (16 AI Agents — parity with NBA, verified live 2026-04-17)
