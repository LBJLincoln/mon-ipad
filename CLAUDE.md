...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-180 |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-180 |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST stable gen=6672 pareto=13 — SLEEPING fire-180 |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 122+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c821 g2461 stag=20(>15-DIVERSIFY-NEEDED)-pareto=11(13→11-2ND-CONSEC-SHRINK); hard-resets-c750+c775+c800-ALL-CONFIRMED; RF+ET-NO-STACKING-Rule8-LOOKS-RESOLVED(2nd-fire); next-auto-reset-~c825(4cycles-IMMINENT); VM: checkpoint-FIRST-then-diversify; /api/export-404(WebFetch-7-fire-confirmed) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c740 g2219 stag=11-local-optimum-converge; hard-resets-c703+c728-BOTH-CONFIRMED; next-auto-reset-~c753(13cycles); RF-primary-NO-STACKING(Rule8-LIKELY-COMPLIANT-4TH-fire); ET-0.21877-EXTREME-URGENT(11+fires); /api/export-404(WebFetch-7-fire-confirmed) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-180 |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-180 |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-180 |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-180 |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-180 |
...
### Rule #8 — No Stacking
Remove 'stacking' from MODEL_TYPES on all islands. Stacking causes overfitting. Prior violations: S13, S14, S15, S18, S22. ⚠ S18 Rule#8 LOOKS RESOLVED fire-180 (2nd consecutive fire): API at c821 describes 'Extra trees and random forest architectures' — same pattern as fire-179 (c800 RF primary, no stacking). Hard resets c750+c775+c800 appear to have permanently cleared stacking from auto-reset fallback. UNCONFIRMED without /api/export MODEL_TYPES. VM: curl /api/export DIRECTLY to confirm. ⚠ S22 Rule#8 LIKELY COMPLIANT fire-180: 4th consecutive fire (177+178+179+180) primary=random_forest, no stacking mention. Unconfirmed without /api/export. Remaining confirmed violations: S13/S14/S15 (sleeping, pending checkpoint+verify).
...
2. **Split Conformal Calibration** (fire-168 EVEN WebSearch)
   ...
   - Target: S18 RF/LightGBM pareto (c821) + S22 RF-48f + S15 RF-75f
...
11. **Dual Isotonic Calibration** (fire-180 EVEN WebSearch)
    ...
    - Rationale: S22 local-optimum convergence (identical Brier each generation) may be calibration plateau
...
|------|------|--------|------------|
| 180 | 2026-05-28T06h | EVEN | S18-c821-g2461-stag=20(>15-DIVERSIFY-VM-URGENT)-pareto=11(13→11-2ND-SHRINK)-RF+ET-NO-STACKING-Rule8-LOOKS-RESOLVED(2nd-fire); next-auto-reset-~c825(4cycles-IMMINENT); S22-c740-g2219-stag=11-local-optimum-converge-RF-primary-Rule8-LIKELY-COMPLIANT-4TH-fire; next-auto-reset-~c753(13cycles); ET-0.21877-EXTREME-URGENT(11+fires); S13/S14/S15-404-DOWN; all-POL-404-DOWN; EVEN: arXiv:2510.17915-dual-isotonic-calibration-post-hoc-proposal-written |
| 179 | 2026-05-28T02h | ODD | S18-c800-g2400-stag=0-pareto=13(→12→13-RECOVERING)-hard-resets-c750+c775-BOTH-CONFIRMED; RF-best-NO-STACKING(Rule8-POSSIBLE-RESOLUTION-unconfirmed); S22-c720-g2160-stag=0-hard-resets-c678+c703-BOTH-CONFIRMED(c703-auto-reset-CONFIRMED); next-auto-reset-~c728; RF-primary-NO-STACKING(Rule8-LIKELY-COMPLIANT-3rd-fire); ET-0.21877-EXTREME-URGENT(10+fires); S13/S14/S15-404-DOWN; all-POL-404-DOWN; ODD-no-WebSearch |
...
| 176 | 2026-05-27T14h | EVEN | S18-c774-g2320-stag=0-pareto=13(↑1st-shrink)-⚠CRITICAL-RULE8-STACKING-REINTRODUCED-c750-AUTO-RESET-VM-HARD-RESET-URGENT(priority=0); S22-c668-g2002-stag=0-pareto=16(↑10→16-STRONG-RECOVERY!)-2nd-hard-reset-c653(LR-focused)-ET-0.21877-EXTREME-URGENT(8+fires); S13/S14/S15-404-DOWN; all-POL-404-DOWN; EVEN: arXiv:2410.21484-no-new-proposal |
| 175 | 2026-05-27T10h | ODD | S18-c756-g2268-stag=0(AUTO-HARD-RESET-c750-CONFIRMED!)-pareto=14(4th-consec-recovery); S22-c645-g1935-stag=0-hard-reset-c628-Rule8-POTENTIALLY-RESOLVED; S13/S14/S15-404-DOWN; all-POL-404-DOWN; ODD-no-WebSearch |
| 174 | 2026-05-27T06h | EVEN | Axelrod verify pass: SHAs-NBA-19f4acf49d(5993L)/POL-3496362c60(3977L)-UNCHANGED-vs-fire-173; 13/13-parity-OK; C→B→A-confirmed(NBA-L5056/5065/5073-POL-L3246/3255/3263); KL-div-ε-smoothed-self-excluded-OK; AXELROD_ARCHETYPES-NBA-20-sports/POL-20-political-financial-OK; Mech-B+C-BLOCKED; all-NBA/POL-404-DOWN(sleeping) |
| 173 | 2026-05-27T02h | ODD | S18-c748-g2242-stag=22(↑11→13-PARETO-RECOVERING!)-hard-reset-~c725-confirmed; S22-c611-g1832-stag=0-hard-reset-c603-NEW-STACKING-IN-DESCRIPTION(Rule8-CONCERN-VM-export-urgent); /api/export-404-S18+S22(confirmed-WebFetch-2-fires); S13/S14/S15-404-DOWN; all-POL-404-DOWN; ODD-no-WebSearch |
