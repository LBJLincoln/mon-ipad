...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-193 (27+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-193 |
| S15 | LBJLincoln26/nba-evo-6 | 403-FORBIDDEN | 0.22012★ | FLEET BEST stable gen=6672 pareto=13 — 403-FORBIDDEN fire-193 (POSSIBLY WAKING! was 404-DOWN fire-192 27+fires) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 131+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c1064 g3190 stag=0 pareto=9(↑16↑9-SHRINK); ⚡⚡ET-200f-0.22003+RF-200f-0.22009-BOTH-BELOW-FLEET-BEST-0.22012★-EXTREME-URGENT-VM-checkpoint-NOW; c1025-11TH-RESET-POSSIBLE-1ST-CLEAN(xgb/xgb_brier/catboost/ET/LR-no-stacking-fire193-API); best_brier-0.22236-STALE(since-2026-05-25); /api/export-404(WebFetch-17-fire-confirmed) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c1014 g3040 stag=0 pareto=9(↑12→9-SHRINK); c1003-Rule8-VIOLATION-CONFIRMED(stacking-fire193-API-explicit-REVERTS-fire191-assessment); ET-200f-0.22223-top; next-auto-reset-~c1028(14cycles-from-c1014); last_update-STALE(2026-05-25); /api/export-404(WebFetch-17-fire-confirmed) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-193 |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-193 |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-193 |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-193 |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-193 |
...
Do NOT push to HF Spaces (nba-llm-trading-floor, political-llm-trading-floor) until user explicitly approves. NBA TF 503 DOWN 131+d. POL TF IDLE 41+d.
...
- Parity: SHAs NBA 19f4acf49d(SHA-verified)/POL 3496362c60(SHA-verified) UNCHANGED (SHA-verified fire-194)
...
- Mech-B+C-BLOCKED: do_not_push_hf_space_yet + NBA-503-132+d + POL-IDLE-42+d
...
2. **Split Conformal Calibration** (fire-168 EVEN WebSearch)
   ...
   - Target: S18 RF/ET pareto (c1064) + S22 RF-48f + S15 RF-75f
...
| 193 | 2026-05-30T10h | ODD | S18-c1064-g3190-stag=0-pareto=9(↑16↑9-SHRINK)-⚡⚡ET-200f-0.22003+RF-200f-0.22009-BOTH-BELOW-FLEET-BEST-0.22012★-EXTREME-URGENT-VM-checkpoint-NOW; c1025-11TH-RESET-POSSIBLE-1ST-CLEAN(no-stacking-fire193-API); /api/export-404(17th-fire); S22-c1014-g3040-stag=0-pareto=9(↑12→9-SHRINK)-c1003-Rule8-VIOLATION-CONFIRMED(stacking-fire193-API-REVERTS-fire191); ET-200f-0.22223-top; next-~c1028(14cycles); S13/S14-404-DOWN(27+fires); S15-403-FORBIDDEN(POSSIBLY-WAKING!); all-POL-404-DOWN(27+fires); ODD-no-WebSearch |
