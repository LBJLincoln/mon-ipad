...
> Architecture v21 — "The Trading Floor Crew" (14 agents × 9 depts × 4 tracks) + TF v3 (17 LLM agents) + 21 Evolution Islands | Updated: 2026-06-01T04h
...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-203 (35+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-203 (35+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-203 (35+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 135+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c1197 g3589 stag=0 pareto=12(↑10↑12-RECOVERING!); c1175-17TH-RESET-NO-STACKING-CONFIRMED(API-consistent-fire203-LightGBM-dominant-2ND-CONSEC-NO-STACKING-Rule8-UNCONFIRMED); Venn-Abers+Beta+Sigmoid-calibration-STILL-IN-POP(5TH-consec!); next-auto-reset-~c1200-IMMINENT(3cycles!-c1175+25); best_brier=0.22236-STALE(9+days); /api/export-404(24th-fire) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c1180 g3539 stag=0 pareto=15(↑8↑15-MASSIVE-RECOVERY!); c1178-Rule8-9TH-VIOLATION-CONFIRMED(fire203-API-explicit:xgb_brier+lgbm+catboost+LR+stacking-c1153+25=c1178); c1153-Rule8-COMPLIANT(xgb_brier+lgbm+LR-no-stacking); lightgbm_brier-dominant; next-auto-reset-~c1203(c1178+25-23cycles); best_brier=0.22124-STALE(9+days); /api/export-404(24th-fire) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-203 |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-203 |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-203 |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-203 |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-203 |
...
- Mech-B+C-BLOCKED: do_not_push_hf_space_yet + NBA-503-135+d + POL-IDLE-47+d
...
### Active Research
1. **Venn-Abers Calibration** (fire-158 EVEN WebSearch) — **NOW VALIDATED fire-197 + PERSISTENT fire-203: S18 GA evolved Venn-Abers organically AND survived 5+ consecutive fires (c1100, c1125, c1150, c1175, fire-203)!**
   ...
   - fire-203: Venn-Abers + Beta + Sigmoid ALL confirmed in pop (5th consecutive fire!)
