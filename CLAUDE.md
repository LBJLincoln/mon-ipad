...
HF EVOLUTION ISLANDS — 11 SURVIVORS (6 NBA + 5 POL) after 2026-04-17 cull
    ...
    ├── S13 Nomos42/nba-evo-4:        xgboost_brier       gen=1322  brier=0.22216  stagnation=0  ✓ cycle=441; hard-reset-c429; diversify-c440 WORKED; LR in model pool; vm-remove-stacking-s13 PENDING VM (2026-05-17T04h)
    ├── S14 Nomos42/nba-evo-5:        extra_trees         gen=3630  brier=0.22336  stagnation=0  ✓ cycle=1210; vm-remove-stacking-s14 PENDING VM (2026-05-17T04h)
    ├── S15 Nomos42/nba-evo-6:        random_forest       gen=4332  best=0.22012   stagnation=0  ✓ cycle=1444; ★ FLEET BEST 0.22012; ⚡⚡⚡ ET-200f attractor 7th fire RF-75f-field-lag VM-CHECKPOINT-EXTREME-URGENT (2026-05-17T04h)
    ├── S17 LBJLincoln26/nba-evo-s17: ---                 gen=---   brier=---      🔴 503 DOWN 86+ days — VM RESTART REQUIRED (2026-05-17T04h)
    ├── S18 TESTforge42/nba-evo-s18:  xgboost_brier       gen=8028  brier=0.22315  stagnation=0  ✓ cycle=2676; pareto=22; ⚡⚡ 0.21885 CONFIRMED NEW IN-POP BEST VM-CHECKPOINT-URGENT (2026-05-17T04h)
    └── S22 TESTforge42/nba-evo-s22:  extra_trees         gen=2952  brier=0.22551  stagnation=0  ✓ cycle=985; vm-add-lightgbm-s22-s13 + vm-remove-stacking-s22 PENDING VM (2026-05-17T04h)
    Political Survivors (5, CPU tree-only):
    ├── P1 Nomos42/political-alpha:      xgboost_brier       gen=68266  brier=0.2499  stagnation=0  ✓ cycle=22756; hard-resets-22701+22741 (2026-05-17T04h)
    ├── P2 Nomos42/political-alpha-2:    xgboost_brier       gen=54837  brier=0.25003 stagnation=0  ✓ cycle=18279; LightGBM-123f-Brier=0.249 in-pop (2026-05-17T04h)
    ├── P4 LBJLincoln/political-alpha-4: xgboost_brier       gen=87455  brier=0.24992 stagnation=0  ✓ cycle=29152; ★ POL FLEET BEST alltime=0.24904; LightGBM 108f Brier=0.2490; hard-resets-29094+29114 (2026-05-17T04h)
    ├── P5 LBJLincoln/political-alpha-5: xgboost_brier       gen=74201  brier=0.24993 stagnation=0  ✓ cycle=24734; LightGBM-104f-Brier=0.249; hard-resets-24681+24701 (2026-05-17T04h)
    └── P7 LBJLincoln/political-alpha-7: xgboost_brier       gen=5026   brier=0.25004 stagnation=0  ✓ cycle=1676; pareto-LightGBM-128f-0.24967 INCONCLUSIVE fire-119 (need fire-120 confirm) (2026-05-17T04h)
```
