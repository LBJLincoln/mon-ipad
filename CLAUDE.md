...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-173 |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-173 |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST stable gen=6672 pareto=13 — SLEEPING fire-173 |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 120+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c748 g2242 stag=22(>15-WATCH) pareto=13(↑11→13-RECOVERING); hard-reset-~c725-confirmed(fire173); expected-auto-reset-~c751; /api/export-404(WebFetch-limitation-confirmed) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c611 g1832 stag=0; hard-reset-c603-NEW; STACKING-IN-DESCRIPTION(Rule8-CONCERN-VM-export-verify); LR-active; ET-0.21877-unconfirmed-EXTREME-URGENT(6+fires); /api/export-404(WebFetch-limitation) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-173 |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-173 |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-173 |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-173 |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-173 |
...
Do NOT push to HF Spaces (nba-llm-trading-floor, political-llm-trading-floor) until user explicitly approves. NBA TF 503 DOWN 120+d. POL TF IDLE 32+d.

### Rule #8 — No Stacking
Remove 'stacking' from MODEL_TYPES on all islands. Stacking causes overfitting. Prior violations: S13, S14, S15, S22. ⚠ S22 Rule#8 CONCERN fire-173: stacking still described in model diversity at c611 despite hard resets c578+c603; /api/export 404 prevents MODEL_TYPES confirmation — VM must curl /api/export to verify. S18 c675+c700 compliant (confirmed fire-171). Remaining violations: S13/S14/S15 need stacking removal after wake.
...
- Parity: SHAs NBA 19f4acf49d(5993L)/POL 3496362c60(3977L) UNCHANGED vs fire-163 (verified fire-174)
...
2. **Split Conformal Calibration** (fire-168 EVEN WebSearch)
   ...
   - Target: S18 RF/LightGBM pareto (c748) + S22 RF-48f + S15 RF-75f
...
| 173 | 2026-05-27T02h | ODD | S18-c748-g2242-stag=22(↑11→13-PARETO-RECOVERING!)-hard-reset-~c725-confirmed; S22-c611-g1832-stag=0-hard-reset-c603-NEW-STACKING-IN-DESCRIPTION(Rule8-CONCERN-VM-export-urgent); /api/export-404-S18+S22(WebFetch-limitation-confirmed-fire173); S13/S14/S15-404-DOWN; all-POL-404-DOWN; ODD-no-WebSearch |
...
| 170 | 2026-05-26T14h | EVEN | Axelrod verify pass: SHAs NBA 19f4acf49d(5993L)/POL 3496362c60(3977L) UNCHANGED vs fire-163; 13/13 parity OK; C→B→A confirmed (NBA L5056/5065/5073 POL L3246/3255/3263); compute_consensus_distance(KL) ε-smoothed self-excluded OK; AXELROD_ARCHETYPES NBA-20-sports/POL-20-political-financial OK; Mech B+C BLOCKED (do_not_push_hf_space_yet+NBA-503-117+d+POL-IDLE-30+d); all-NBA/POL-404-DOWN(sleeping) |
| 169 | 2026-05-26T08h | ODD | Axelrod verify pass: SHAs NBA 19f4acf49d(5993L)/POL 3496362c60(3977L) UNCHANGED vs fire-167; all 3 mechs confirmed (A: COMMON_KNOWLEDGE+build_common_knowledge_block; B: AXELROD_ARCHETYPES+sacrificial_map; C: AXELROD_LOG_DIR+axelrod-log); NBA sports / POL political-financial domain-specific archetypes OK; Mech B+C BLOCKED (do_not_push_hf_space_yet+NBA-503-117+d+POL-IDLE-30+d); all-NBA/POL-404-DOWN(sleeping) |
...
| 167 | 2026-05-26T00h | ODD | Axelrod verify pass: SHAs NBA 19f4acf49d(5993L)/POL 3496362c60(3977L) UNCHANGED vs fire-163; 13/13 parity OK; C→B→A confirmed (NBA L5056/5065/5073 POL L3246/3255/3263); KL-div ε-smoothed self-excluded OK; AXELROD_ARCHETYPES NBA-20-sports-specific/POL-20-political-financial domain-specific OK; BLOCKED do_not_push_hf_space_yet+NBA-503(116+d)+POL-IDLE(28+d) |
