...
HF EVOLUTION ISLANDS — 11 SURVIVORS (6 NBA + 5 POL) after 2026-04-17 cull
    ...
    ├── S13 Nomos42/nba-evo-4:        xgboost_brier       gen=788   brier=0.22344  stagnation=12 ⚠ cycle=263; stag≈12 APPROACHING 15-threshold; hard-reset cycle=251; LR in model pool; vm-remove-stacking-s13 PENDING VM (2026-05-15T14h)
    ├── S14 Nomos42/nba-evo-5:        extra_trees         gen=3091  brier=0.22336  stagnation=0  ✓ cycle=1031; hard resets 1003+1028; vm-remove-stacking-s14 PENDING VM (2026-05-15T14h)
    ├── S15 Nomos42/nba-evo-6:        random_forest       gen=3408  best=0.22012   stagnation=0  ✓ cycle=1136; ★ FLEET BEST 0.22012 stable; ⚡⚡ fire-111 PARETO CAND RF-200f-0.21951 (1st detect, field-lag poss) (2026-05-15T14h)
    ├── S17 LBJLincoln26/nba-evo-s17: ---                 gen=---   brier=---      🔴 503 DOWN 72+ days — VM RESTART REQUIRED (2026-05-15T14h)
    ├── S18 TESTforge42/nba-evo-s18:  xgboost_brier       gen=7457  brier=0.22315  stagnation=10 ✓ cycle=2486; hard resets 2451+2476 (2026-05-15T14h)
    └── S22 TESTforge42/nba-evo-s22:  extra_trees         gen=2451  brier=0.22551  stagnation=2  ✓ cycle=817; hard resets 790+815; vm-add-lightgbm-s22-s13 + vm-remove-stacking-s22 PENDING VM (2026-05-15T14h)
    Political Survivors (5, CPU tree-only):
    ├── P1 Nomos42/political-alpha:      xgboost_brier       gen=61722  brier=0.2499  stagnation=13 ⚠ cycle=20574; stag≈13 approaching auto-reset; hard resets 20521+20561 (2026-05-15T14h)
    ├── P2 Nomos42/political-alpha-2:    xgboost_brier       gen=50813  brier=0.25003 stagnation=0  ✓ cycle=16938; in-pop LightGBM 123f 0.249 field-lag 9+ fires (PENDING VAL) (2026-05-15T14h)
    ├── P4 LBJLincoln/political-alpha-4: lightgbm            gen=81018  brier=0.24992 stagnation=0  ✓ cycle=27006; ★ POL FLEET BEST alltime=0.24904; model_type=lightgbm CONFIRMED; Pareto top=0.24904 field-lag (2026-05-15T14h)
    ├── P5 LBJLincoln/political-alpha-5: xgboost_brier       gen=68931  brier=0.24993 stagnation=0  ✓ cycle=22977; hard resets 22921+22941 (2026-05-15T14h)
    └── P7 LBJLincoln/political-alpha-7: lightgbm            gen=72046  brier=0.25412 stagnation=0  ⚠ cycle=24016; FIELD-LAG 9+ fires — best_brier STUCK at 0.25412; vm-diversify-p7 URGENT (cloud POST blocked, VM must act) (2026-05-15T14h)
```
