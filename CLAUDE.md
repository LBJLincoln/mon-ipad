...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-245 (71+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed — SLEEPING fire-245 (71+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-244 (70+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 144+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | EVOLVING | 0.22326 | **fire-244**: c=560 g=1679 stag=0. **18TH-AUTO-RESET-c542-CONFIRMED(c517+25=c542-EXACT)**. **PARETO TOP-5 EXTREME URGENT**: XGB-Brier-200f-**0.21964** (5bp BELOW FLEET BEST 0.22012!) + RF-200f-0.22028/0.22044 + CatBoost-200f-0.22038 — **ALL BELOW 0.22085 CHECKPOINT!** best_brier=0.22326 (field-lag). /api/export-404(21st-CRITICAL). Next reset ~c567(c542+25). VM: curl /api/export S18 IMMEDIATELY — 4 models below threshold! |
| S22 | TESTforge42/nba-evo-s22 | FRESH-RESTART | 0.22124 | **fire-244**: c=11 g=33 stag=0 pareto=15. FRESH-RESTART (2nd wipe, HF sleep→wake same pattern as S18 fire-221). best_brier=0.2207 gen9 stable. XGB dominating top models at c11. First auto-reset approaching ~c25. /api/export-404(61st). VM: monitor Rule8 at ~c25 — ensure stacking excluded from reseed. |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-245 (71+ fires) |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-245 (71+ fires) |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-245 (71+ fires) |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-245 (71+ fires) |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-245 (71+ fires) |
...
- Mech B: CODE-DONE (fire-122+, verified fire-243) — sacrificial role reallocation (BLOCKED: HF push gate)
- Mech C: CODE-DONE (fire-122+, verified fire-243) — post-mortem log + dataset (BLOCKED: HF push gate)
...
37. **Calibration Set Reuse for Multiple Conformal Predictions** (fire-244 EVEN WebSearch)
    ...
    - Application 1: Reuse single calibration split across all k Pareto models in engine.py (k× more calibration data per model, lower variance)
    - Application 2: Calibration set reuse across temporal CV folds — reduces holdout waste (complements fire-230 sliding-window CV)
    ...
    - Application 5: Port to political_engine.py for rare-event political calibration (low n_cal benefit)
    - Library: crepes/nonconformist + custom Hoeffding correction wrapper (~50 lines, no new dependencies)
    - Expected improvement: 0.001-0.002 Brier (larger effective training set + reduced calibration variance)
...
|------|------|--------|------------|
| 245 | 2026-06-08T04h | ODD | Axelrod-verify-pass-SHAs-NBA-85e7682e1d(6035L)/POL-6983c86517(4019L)-UNCHANGED; py_compile-OK-both; 25/25-parity-OK; KL-div-OK; Mech-A/B/C+AblationFlags-ALL-CODE-DONE-BLOCKED(do_not_push_hf_space_yet); S13/S14/S15+POL-404-DOWN(71+fires); ODD-no-WebSearch |
| 244 | 2026-06-08T00h | EVEN | S18-c560-g1679-stag=0-18TH-RESET-c542-CONFIRMED-XGB-BRIER-200f-0.21964-EXTREME-URGENT!(5bp-below-fleet-best-0.22012!)+RF-200f-0.22028/0.22044+CAT-200f-0.22038-ALL-BELOW-0.22085-/api/export-404(21st-CRITICAL)-next-reset~c567; S22-c11-g33-FRESH-RESTART-first-reset-~c25-XGB-dominating; S13/S14/S15+POL-404-DOWN(71+fires); EVEN: arXiv:2506.19689-Calibration-Set-Reuse-Conformal-Prediction-proposal-written |
| 243 | 2026-06-07T20h | ODD | S18-c520-g1558-stag=0-pareto=15-16TH+17TH-AUTO-RESET-c492+c517-CONFIRMED-TOP-0.22061-CONFIRMED-EVICTED-Rule8-CLEAN; S22-CRITICAL-FRESH-RESTART-c5-g14-stag=1-pareto=20-ALL-HISTORY-LOST(0.21908+candidates-GONE-2ND-TOTAL-WIPE-after-S18-fire221)-best_brier=0.2207-gen9; S13/S14/S15+POL-404-DOWN(69+fires); ODD: Axelrod-verify-pass-SHAs-NBA-85e7682e1d(6035L)/POL-6983c86517(4019L)-UNCHANGED |
