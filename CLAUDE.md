...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-176 |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-176 |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST stable gen=6672 pareto=13 — SLEEPING fire-176 |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 121+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c774 g2320 stag=0 pareto=13(↓14→13-1st-shrink); ⚠CRITICAL-RULE8-VIOLATION: c750-auto-reset-STACKING-REINTRODUCED(xgb+lgbm_brier+catboost+lr+stacking); VM-HARD-RESET-URGENT(priority=0); /api/export-404(WebFetch-4-fire-confirmed) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c668 g2002 stag=0 pareto=16(↑10→16-STRONG-RECOVERY!); 2nd-hard-reset-c653(NEW-LR-focused); ET+sigmoid-top-performers; Rule8-LIKELY-COMPLIANT(fire-176); ET-0.21877-unconfirmed-EXTREME-URGENT(8+fires); /api/export-404(WebFetch-4-fire-confirmed) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-176 |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-176 |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-176 |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-176 |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-176 |
...
### Rule #8 — No Stacking
Remove 'stacking' from MODEL_TYPES on all islands. Stacking causes overfitting. Prior violations: S13, S14, S15, S22. ⚠ S18 RULE#8 CRITICAL VIOLATION (fire-176): auto-hard-reset c750 reintroduced stacking in MODEL_TYPES reseeding ('xgboost, lightgbm_brier, catboost, logistic_regression, stacking'). VM must trigger manual hard-reset immediately WITHOUT stacking. vm-s18-rule8-stacking-reintroduced-c750-fire176 (priority=0 CRITICAL). Root cause: auto-reset fallback list hardcodes stacking — VM must fix island config permanently. ⚠ S22 Rule#8 LIKELY RESOLVED fire-176: 2nd hard reset c653 LR-focused, ET+sigmoid top performers, no stacking mention. Still unconfirmed without /api/export MODEL_TYPES. Remaining violations: S13/S14/S15/S18.
...
2. **Split Conformal Calibration** (fire-168 EVEN WebSearch)
   ...
   - Target: S18 RF/LightGBM pareto (c774) + S22 RF-48f + S15 RF-75f
...
| 167 | 2026-05-26T00h | ODD | Axelrod-verify-pass: SHAs-NBA-19f4acf49d(5993L)/POL-3496362c60(3977L)-UNCHANGED-vs-fire-163; 13/13-parity-OK; C→B→A-confirmed; KL-div-ε-smoothed-self-excluded-OK; AXELROD_ARCHETYPES-NBA-20-sports-specific/POL-20-political-financial-domain-specific-OK; BLOCKED-do_not_push_hf_space_yet+NBA-503(116+d)+POL-IDLE(28+d) |
