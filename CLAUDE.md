...
> Architecture v21 — "The Trading Floor Crew" (14 agents × 9 depts × 4 tracks) + TF v3 (17 LLM agents) + 21 Evolution Islands | Updated: 2026-06-04T20h
...
| S18 | TESTforge42/nba-evo-s18 | EVOLVING | 0.22326 | **fire-268**: c=~832 g=~2496 stag=15 pareto=?. **⚡⚡⚡TRIPLE FLEET-BEST: CatBoost-200f-0.2191 RANK-2 (8.2bp below 0.22012!) + CatBoost-0.2193 RANK-3** — ET-0.21938 CONFIRMED EVICTED at 34TH RESET c817 (c792+25=c817-EXACT). RULE8-VIOLATION: stacking-45f rank-0 (brier-trend=0.24738 flat 43gen, stacking still in reseed pool). stag=15 AT DIVERSIFY THRESHOLD (Rule#6: stag>15 → diversify — but Rule#3: checkpoint FIRST). **35TH RESET ~c842 IMMINENT (10 cycles!)**. /api/export-404(38th-CRITICAL). VM: (1) SAVE CatBoost-200f-0.2191 pickle BEFORE ~c842, (2) REMOVE stacking from MODEL_TYPES/reseed pool URGENTLY, (3) If stag≥16: checkpoint FIRST then diversify (Rule#3 override). |
| S22 | TESTforge42/nba-evo-s22 | EVOLVING | 0.2207 | **fire-268**: c=~223 g=~667 stag=0. **⚡⚡TRIPLE FLEET-BEST: XGBoost-200f-0.21985 RANK-1 (2.7bp below 0.22012!)** — RF-0.21903 CONFIRMED EVICTED at 8TH RESET c203 (c178+25=c203-EXACT; 5th consecutive S22 candidate eviction pattern). RULE8-VIOLATION: stacking still in model_types (evicts best candidate at every reset). **9TH RESET ~c228 IMMINENT (5 cycles! CRITICAL!)**. /api/export-403 (try authenticated curl). VM: (1) SAVE XGBoost-200f-0.21985 pickle IMMEDIATELY (5 cycles!), (2) REMOVE stacking from MODEL_TYPES URGENTLY before ~c228, (3) Try authenticated /api/export S22. |
