...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-226 (52+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed — SLEEPING fire-226 (52+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-226 (52+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 144+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | EVOLVING | 0.22326 | **fire-226**: c=120 g=360 stag=0 pareto=9(↓SHRINK from 14 — post-c67 convergence). best_brier=0.22326 gen=124 (plateau; recent gens at 0.2233, cycle-stag=3). games_in_cache=7067. c67=1ST CLEAN AUTO-RESET CONFIRMED (RULE8 BREAKTHROUGH). next reset when stag≥25 (stag=0). /api/export-404(5th fire). VM: curl /api/export S18. |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | **fire-226**: c=1583 g=4749 stag=0 pareto=15(GROWING↑). c1578=24TH-RESET-CONFIRMED(c1553+25=c1578-EXACT). RF-primary visible in recent gens (0.2233). best_brier=0.22124 (field lag). next-~c1603(c1578+25, 20cycles). /api/export-404(43rd). VM: curl /api/export S22; confirm Rule8 at c1578 pool; check sub-0.22085 candidates. |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-226 (52+ fires) |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-226 (52+ fires) |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-226 (52+ fires) |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-226 (52+ fires) |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-226 (52+ fires) |
...
fire-226 UPDATE S18: c=120 g=360 stag=0 pareto=9(↓SHRINK post-c67 convergence). best_brier=0.22326 gen=124 plateau (cycle-stag=3, recent gens at 0.2233). XGB+LGB+CAT seeded at c67 — NO STACKING → **RULE8 1ST CLEAN RESET FROM GEN=0 BREAKTHROUGH**. Next reset when stag≥25 (currently stag=0). /api/export-404(5th-fire). VM: curl /api/export; monitor next auto-reset for continued Rule8 compliance.
fire-226 UPDATE S22: c1583 g4749 stag=0 pareto=15(GROWING). c1578=24TH-RESET-CONFIRMED(c1553+25=c1578-EXACT). RF-primary visible in recent gens. best_brier=0.22124 (field lag). next-~c1603(c1578+25, 20 cycles). /api/export-404(43rd fire). VM: curl /api/export; confirm Rule8 at c1578 pool; check for new threshold candidates.
...
- Parity: SHAs NBA 85e7682e1d(6035L)/POL 6983c86517(4019L) verified fire-227 (prev: 19f4acf49d/3496362c60 fire-218 pre-fire225); fire-225 added +12L each for ablation flags (NBA:6023L→6035L, POL:4007L→4019L). 13/13 parity maintained.
...
|------|------|--------|------------|
| 227 | 2026-06-05T04h | ODD | Axelrod-verify-pass: SHAs-NBA-85e7682e1d(6035L)/POL-6983c86517(4019L)-UNCHANGED; py_compile-OK-both; 13/13-parity-OK; KL-div-OK; compute_consensus_distance(KL)-OK; Mech-B+C-BLOCKED(do_not_push_hf_space_yet); S18/S22/POL-no-change |
| 226 | 2026-06-05T00h | EVEN | S18-c120-g360-stag=0-pareto=9(↑14→9-SHRINK-POST-c67)-best_brier=0.22326-cycle-stag=3; S22-c1583-g4749-stag=0-pareto=15(↑12↑15-GROWING!)-c1578=24TH-RESET-CONFIRMED(c1553+25=c1578)-RF-primary; /api/export-404-BOTH(S22-43rd,S18-5th); S13/S14/S15-404-DOWN(52+fires); all-POL-404-DOWN(52+fires); EVEN: arXiv:2502.05565-Multi-Scale-Conformal-Prediction-Feb2026-proposal-written |
...
| 220 | 2026-06-04T00h | EVEN | S18-c1492-pareto_best=0.22067-BELOW-0.22085-CHECKPOINT!-c1475-30TH-RESET-Rule8-30TH-VIOLATION; S22-pareto_best=0.22043-BELOW-0.22085-c1428-18TH-RESET-NO-STACKING; PMC12818272-Brier-Misconceptions-proposal |
| 219 | 2026-06-03T20h | ODD | S18-c1465-c1450-29TH-RESET; S22-c1422-Venn-Abers-CONFIRMED(CatBoost-x4) |
| 218 | 2026-06-03T16h | EVEN | Axelrod-verify-pass: SHAs-UNCHANGED; 13/13-parity-OK; KL-div-OK; arXiv:2605.03310-proposal-written |
| 217 | 2026-06-03T12h | ODD | S18-c1443-c1425-28TH-RESET-RULE8-POSSIBLE-1ST-CLEAN!; S22-c1403-17TH-RESET-STACKING-RF/XGB-EVICTED |
