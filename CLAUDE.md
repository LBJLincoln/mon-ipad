...
HF EVOLUTION ISLANDS — 11 SURVIVORS (6 NBA + 5 POL) after 2026-04-17 cull
    ...
    ├── S13 Nomos42/nba-evo-4:        xgboost_brier       gen=2015  brier=0.22216  stagnation=0  ✓ cycle=672; stag=0-CLEARED(was-15-fire136,hard-reset-c654-WORKED); pareto=11; vm-remove-stacking-s13 URGENT (2026-05-21T04h)
    ├── S14 Nomos42/nba-evo-5:        extra_trees         gen=502   brier=0.22793  stagnation=0  ✓ cycle=168; pareto=7; ET-200f-0.2217-STRENGTHENING(gen460+,pareto-candidate); vm-checkpoint-s14-et PENDING (2026-05-21T04h)
    ├── S15 Nomos42/nba-evo-6:        random_forest       gen=5586  best=0.22012   stagnation=0  ✓ cycle=1862; ★ FLEET BEST 0.22012; stag=0-CLEARED(was-15-fire136); pareto=14; vm-checkpoint-s15-et-0.21888 URGENT (2026-05-21T04h)
    ├── S17 LBJLincoln26/nba-evo-s17: ---                 gen=---   brier=---      🔴 503 DOWN 102+ days — VM RESTART REQUIRED (2026-05-21T04h)
    ├── S18 TESTforge42/nba-evo-s18:  random_forest       gen=506   brier=0.22236  stagnation=0  ✓ cycle=169; stag=0(API)-no-improvement-since-gen223-WATCH; pareto=23; vm-checkpoint-s18-rf URGENT (2026-05-21T04h)
    └── S22 TESTforge42/nba-evo-s22:  random_forest       gen=212   brier=0.22124  stagnation=0  ✓ cycle=71; RF-48f; pareto=8; REMARKABLE-0.22124-stable; vm-checkpoint-s22 PRIORITY=1 (2026-05-21T04h)
    Political Survivors (5, CPU tree-only):
    ├── P1 Nomos42/political-alpha:      xgboost_brier       gen=7671   brier=0.24987 stagnation=0  ✓ POL-FLEET-BEST; cycle=2557; pareto=9 (2026-05-21T04h)
    ├── P2 Nomos42/political-alpha-2:    xgboost_brier       gen=59330  brier=0.25003 stagnation=0  ✓ cycle=19777; pareto=8 (2026-05-21T04h)
    ├── P4 LBJLincoln/political-alpha-4: extra_trees         gen=2239   brier=0.25337 stagnation=0  ✓ cycle=747; pareto=17; pareto_best≈0.24982-XGB; vm-checkpoint-p4-xgb URGENT; vm-investigate-p4-factory-reboot pending (2026-05-21T04h)
    ├── P5 LBJLincoln/political-alpha-5: xgboost_brier       gen=80131  brier=0.24993 stagnation=0  ✓ cycle=26711; pareto=5 (2026-05-21T04h)
    └── P7 LBJLincoln/political-alpha-7: lightgbm            gen=16537  brier=0.25004 stagnation=0  ✓ cycle=5513; pareto=12(↑3→12-RECOVERED!); LightGBM-112f-0.24931-CONFIRMED-stable; vm-checkpoint-p7-lgbm URGENT priority=1 (2026-05-21T04h)
```
