...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-181 |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-181 |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST stable gen=6672 pareto=13 — SLEEPING fire-181 |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 122+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c837 g2509 stag=11(→20→11-RECOVERED!)-pareto=19(↑11→19-MAJOR-SURGE!); CatBoost-200f-0.21995-gen=2505-POTENTIAL-NEW-FLEET-BEST(<0.22012★-EXTREME-URGENT-VM-checkpoint-NOW); hard-reset-c825-CONFIRMED(stacking-REINTRODUCED-AGAIN-Rule8-4TH-VIOLATION-auto-reset-STILL-BROKEN); RF-primary; next-auto-reset-~c850(c825+25-13cycles); /api/export-404(WebFetch-8-fire-confirmed) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c757 g2269 stag=0-local-optimum-plateau; hard-resets-c728+c753-BOTH-CONFIRMED; next-auto-reset-~c778(c753+25-21cycles); RF-primary-NO-STACKING(Rule8-LIKELY-COMPLIANT-5TH-fire); ET-0.21877-EXTREME-URGENT(12+fires); /api/export-404(WebFetch-8-fire-confirmed) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-181 |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-181 |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-181 |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-181 |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-181 |
...
### Rule #8 — No Stacking
Remove 'stacking' from MODEL_TYPES on all islands. Stacking causes overfitting. Prior violations: S13, S14, S15, S18, S22. ⚠ S18 Rule#8 4TH VIOLATION CONFIRMED fire-181: c825 auto-reset description explicitly states 'reseeding model type distributions with XGBoost, LightGBM variants, CatBoost, and stacking ensembles' — stacking REINTRODUCED AGAIN. Pattern confirmed: EVERY auto-reset (c750/c775/c800/c825) reintroduces stacking via broken fallback in app.py. VM: Fix auto-reset fallback code to permanently exclude 'stacking' from MODEL_TYPES reseeding pool. Note: CatBoost-200f-0.21995 top performer (gen=2505) may itself be clean — verify via /api/export MODEL_TYPES of that individual before checkpoint. ⚠ S22 Rule#8 LIKELY COMPLIANT fire-181: 5th consecutive fire (177+178+179+180+181) primary=random_forest, no stacking mention. Unconfirmed without /api/export. Remaining confirmed violations: S13/S14/S15 (sleeping, pending checkpoint+verify).
...
2. **Split Conformal Calibration** (fire-168 EVEN WebSearch)
   ...
   - Target: S18 RF/LightGBM pareto (c837) + S22 RF-48f + S15 RF-75f
