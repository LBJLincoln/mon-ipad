...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-216 (45+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-216 (45+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-216 (45+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 142+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c1421 g4262 stag=0 pareto=19(STABLE-fire216); c1400-27TH-RESET-CONFIRMED(c1375+25=c1400-c1421>c1400-fire216); RF-0.22066-gen=4190-EVICTED(as-predicted-fire215!); post-reset-RF-44f-dominant-recent-gen-brier=0.2473(cliff); next-~c1425-IMMINENT(4cycles!); c1400-Rule8-27TH-VIOLATION(stacking-structural-bug); last_update-STALE-6+days(2026-05-28); best_brier=0.22236-STALE; /api/export-404(34th-fire) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c1385 g4153 stag=0 pareto=14(↑12↑14-RECOVERING!-fire216); c1378-16TH-RESET-CONFIRMED(c1353+25=c1378-c1385>c1378-fire216); Rule8-16TH-VIOLATION(stacking-gen=4141-Brier=0.2474); RF-0.22047+XGB-0.22069-gen=4094-POSSIBLY-SURVIVING(stacking-0.2474-much-worse-/api/export-unconfirmed); next-~c1403(c1378+25-~18cycles-from-c1385); best_brier=0.22124-STALE; last_update-STALE-6+days(2026-05-28); /api/export-404(34th-fire) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-216 (45+ fires) |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-216 (45+ fires) |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-216 (45+ fires) |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-216 (45+ fires) |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-216 (45+ fires) |
...
### Rule #8 — No Stacking
Remove 'stacking' from MODEL_TYPES on all islands. Stacking causes overfitting. Prior violations: S13, S14, S15, S18, S22. ⚠ S18 STRUCTURAL BUG ABSOLUTE: ALL 27 auto-resets have seeded stacking in the population. c1400=27TH RESET CONFIRMED (fire-216). RF-200f-0.22066-gen=4190 EVICTED by c1400 as predicted. Next reset ~c1425 IMMINENT (4 cycles from c1421). fire-216 UPDATE S18: c1421 g4262 stag=0 pareto=19 (STABLE). Post-reset RF-44f dominant, recent-gen brier=0.2473 (cliff). No threshold candidates visible. VM: /api/export to verify state at c1400. fire-216 UPDATE S22: c1385 g4153 stag=0 pareto=14 (RECOVERING). c1378=16TH RESET CONFIRMED (c1353+25=c1378). Rule8-16TH VIOLATION: stacking seeded at c1378, gen=4141 stacking-breakthrough Brier=0.2474. RF-0.22047+XGB-0.22069 gen=4094 POSSIBLY SURVIVING (stacking breakthrough 0.2474 much worse than thresholds — unlikely to dominate pareto). Next reset ~c1403 (c1378+25, 18 cycles from c1385). VM: /api/export S22 URGENT to confirm candidates + active_models.
...
1. **Venn-Abers Calibration** (fire-158 EVEN WebSearch) — **NOW VALIDATED fire-197 + PERSISTENT: S18 GA evolved Venn-Abers organically AND survived 3RD CONSECUTIVE FIRE (fire-211+212+213). fire-211 UPDATE: S22 ALSO shows Venn-Abers in RF top performer (c1282) — 2ND INDEPENDENT VALIDATION on both active islands!**
   ...
   - fire-216 UPDATE: S18 top5 post-c1400 reset unknown (RF-44f dominant, Venn-Abers status unclear). S22 RF-0.22047+XGB-0.22069 gen=4094 possibly surviving c1378. VM: /api/export BOTH to verify.
...
| 207 | 2026-06-01T20h | ODD | S18-c1297-g3891-stag=0-pareto=11-c1275-21ST-RESET-STACKING-ABSOLUTE; S22-c1221-g3663-stag=17(DIVERSIFY-SENT!)-⚡⚡ET-200f-0.21904-EXTREME-URGENT; /api/export-404-BOTH(27th-fire); S13/S14/S15-404-DOWN(38+fires); all-POL-404-DOWN(38+fires); ODD-no-WebSearch |
