...
HF EVOLUTION ISLANDS — 11 SURVIVORS (6 NBA + 5 POL) after 2026-04-17 cull
    ...
    ├── S13 Nomos42/nba-evo-4:        xgboost_brier       gen=684   brier=0.22344  stagnation=0  ✓ cycle=229; ⚡ LR already in model pool (gen=684 uses logistic_regression 48f); vm-remove-stacking-s13 PENDING VM (2026-05-15T10h)
    ├── S14 Nomos42/nba-evo-5:        extra_trees         gen=3024  brier=0.22336  stagnation=0  ✓ cycle=1009; hard reset cycle=978 (25-stag); ⚠ stacking in MODEL_TYPES vm-remove-stacking-s14 (2026-05-15T10h)
    ├── S15 Nomos42/nba-evo-6:        random_forest       gen=3323  best=0.22012   stagnation=0  ✓ cycle=1108; ★ FLEET BEST 0.22012 stable; CatBoost 200f 0.21932 DROPPED 3rd fire unconfirmed (2026-05-15T10h)
    ├── S17 LBJLincoln26/nba-evo-s17: ---                 gen=---   brier=---      🔴 503 DOWN 72+ days — VM RESTART REQUIRED (2026-05-15T10h)
    ├── S18 TESTforge42/nba-evo-s18:  xgboost_brier       gen=7375  brier=0.22315  stagnation=0  ✓ cycle=2459; stag RECOVERED; resets 2201+2226+2351 (2026-05-15T10h)
    └── S22 TESTforge42/nba-evo-s22:  extra_trees         gen=2375  brier=0.22551  stagnation=0  ✓ cycle=792; hard resets 690+715+740; vm-add-lightgbm-s22-s13 + vm-remove-stacking-s22 PENDING VM (2026-05-15T10h)
    Political Survivors (5, CPU tree-only):
    ├── P1 Nomos42/political-alpha:      xgboost_brier       gen=60853  brier=0.2499  stagnation=0  ✓ cycle=20285 stable; hard resets 20241+20261 (2026-05-15T10h)
    ├── P2 Nomos42/political-alpha-2:    xgboost_brier       gen=50305  brier=0.25003 stagnation=0  ✓ cycle=16769; ⚡ in-pop LightGBM 123f 0.249 field-lag 8+ fires (PENDING VAL) (2026-05-15T10h)
    ├── P4 LBJLincoln/political-alpha-4: lightgbm            gen=80327  brier=0.24992 stagnation=0  ✓ cycle=26776; ★ POL FLEET BEST alltime=0.24904; model_type=lightgbm CONFIRMED (changed from xgboost); hard resets 26734+26754 (2026-05-15T10h)
    ├── P5 LBJLincoln/political-alpha-5: xgboost_brier       gen=68374  brier=0.24993 stagnation=0  ✓ cycle=22792; LightGBM persistent 6+ fires; hard resets 22741+22761 (2026-05-15T10h)
    └── P7 LBJLincoln/political-alpha-7: lightgbm            gen=71620  brier=0.25412 stagnation=0  ⚠ cycle=23874; FIELD-LAG 7+ fires — best_brier STUCK at 0.25412; vm-diversify-p7 URGENT (cloud POST blocked, VM must act) (2026-05-15T10h)
```
