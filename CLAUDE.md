...
HF EVOLUTION ISLANDS — 11 SURVIVORS (6 NBA + 5 POL) after 2026-04-17 cull
    ...
    ├── S13 Nomos42/nba-evo-4:        xgboost_brier       gen=1654  brier=0.22216  stagnation=0  ✓ cycle=552; hard-reset-c529; ⚠ ET-200f-0.21914 PARETO DROPPED (hard-reset-c529 evicted); vm-checkpoint-s13-ET CLOSED-DROPPED (2026-05-18T06h)
    ├── S14 Nomos42/nba-evo-5:        ---                 gen=0     brier=1.0      🚨 FRESH RESTART cycle=0 (was c1273 g3819) — Space crashed fire-123→fire-124; S14-fresh-restart-fire124 ADDED work-queue priority=3 (2026-05-18T06h)
    ├── S15 Nomos42/nba-evo-6:        random_forest       gen=4800  best=0.22012   stagnation=24 ✓ cycle=1600; ★ FLEET BEST 0.22012; stag=24 DIVERSIFY-SENT; ⚡⚡⚡⚡ ET-200f-0.2185 NEW PARETO RECORD gen=4799 (<0.22085 threshold) VM-CHECKPOINT-EXTREME-URGENT (2026-05-18T06h)
    ├── S17 LBJLincoln26/nba-evo-s17: ---                 gen=---   brier=---      🔴 503 DOWN 94+ days — VM RESTART REQUIRED (2026-05-18T06h)
    ├── S18 TESTforge42/nba-evo-s18:  extra_trees         gen=8347  brier=0.22315  stagnation=0  ✓ cycle=2783; pareto ET-200f-0.2198 (front=16); stag=0 ok; vm-checkpoint-s18 URGENT priority=1 (2026-05-18T06h)
    └── S22 TESTforge42/nba-evo-s22:  extra_trees         gen=3203  brier=0.22551  stagnation=2  ✓ cycle=1068; hard-resets-c1040+c1065; stag=2 ok; vm-add-lightgbm-s22-s13 + vm-remove-stacking-s22 PENDING VM (2026-05-18T06h)
    Political Survivors (5, CPU tree-only):
    ├── P1 Nomos42/political-alpha:      xgboost_brier       gen=1895   brier=0.24987 stagnation=0  🚨 FRESH RESTART cycle=632 (was 23017) RECOVERING — stag-warnings-c582+c602; add LR+elastic_net now (fresh restart = ideal config moment) (2026-05-18T06h)
    ├── P2 Nomos42/political-alpha-2:    xgboost_brier       gen=56587  brier=0.25003 stagnation=0  ✓ cycle=18863; LightGBM-123f-Brier=0.249 in-pop; hard-resets-18821+18841 survived (2026-05-18T06h)
    ├── P4 LBJLincoln/political-alpha-4: lightgbm            gen=89803  brier=0.24992 stagnation=0  ✓ cycle=29935; ★ POL FLEET BEST alltime=0.24904; LightGBM-108f Brier=0.2490 Sharpe=1.01; hard-resets-29894+29914 survived (2026-05-18T06h)
    ├── P5 LBJLincoln/political-alpha-5: xgboost_brier       gen=76905  brier=0.24993 stagnation=0  ✓ cycle=25635; LightGBM-102f-composite=0.45423 top model; hard-resets-25581+25601 survived (2026-05-18T06h)
    └── P7 LBJLincoln/political-alpha-7: xgboost_brier       gen=9121   brier=0.25004 stagnation=0  ✓ cycle=3041; hard-resets-c3001+c3021; ⚠ LightGBM-116f-0.24937 UNCERTAIN (may evicted by resets); vm-checkpoint-p7 VERIFY priority=2 (2026-05-18T06h)
```
