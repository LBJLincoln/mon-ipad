...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-187 (22+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-187 |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST stable gen=6672 pareto=13 — SLEEPING fire-187 |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 126+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c963 g2889 stag=13(↑0→13-post-c950) pareto=8(12→8-1ST-SHRINK); ⚡⚡ET-200f-0.21845-gen=2885-EXTREME-URGENT(<0.22012★-POTENTIAL-NEW-FLEET-BEST!-<0.22085-THRESHOLD-MET); c950-auto-reset-CONFIRMED(6TH-RESET-stag-triggered-model-types-unclear); c942+c955-REMOTE-DIVERSIFY-confirmed; next-auto-reset-~c975(stag=13-12cycles); c925-POSSIBLE-1ST-CLEAN-RESET(fire-185-unconfirmed); /api/export-404(WebFetch-12-fire-confirmed) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c872 g2616 stag=0; ET-200f-~0.219-0.220-pareto-POSSIBLE-BELOW-THRESHOLD; LR-43f-Brier=0.22256-in-pareto; c853-RULE8-VIOLATION-CONFIRMED(stacking-reintroduced-c853=c828+25-8-clean-streak-BROKEN); c828-clean-reset-confirmed; next-auto-reset-~c878-IMMINENT(6cycles-FIX-URGENT-before-c878); /api/export-404(12-fire-confirmed) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-187 |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-187 |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-187 |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-187 |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-187 |
...
- Mech-B+C-BLOCKED: do_not_push_hf_space_yet + NBA-503-126+d + POL-IDLE-38+d
...
2. **Split Conformal Calibration** (fire-168 EVEN WebSearch)
   ...
   - Target: S18 RF/ET pareto (c963) + S22 RF-48f + S15 RF-75f
...
10. **Calibration vs Accuracy Model Selection** (fire-172 EVEN WebSearch)
    ...
    - fire-187 VALIDATION (9th+ fire): S22 LR 43f Brier=0.22256 CONFIRMED IN PARETO (fire-187 API) — calibration-focused linear model persists through c853 reset and stacking reintroduction
