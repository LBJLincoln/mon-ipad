...
> Architecture v21 — "The Trading Floor Crew" (14 agents × 9 depts × 4 tracks) + TF v3 (17 LLM agents) + 21 Evolution Islands | Updated: 2026-06-07T08h
...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-240 (66+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed — SLEEPING fire-240 (66+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-240 (66+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 144+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | EVOLVING | 0.22326 | **fire-240**: c=430 g=1289 stag=12(BUILDING↑0→12,div-threshold=15) pareto=10(↓15→10-POST-13TH-RESET). 13TH-AUTO-RESET-c417-CONFIRMED(c392+25=c417-EXACT). **TOP-PERFORMER-0.22061-BELOW-0.22085-CHECKPOINT-URGENT!**(field-lag:best_brier=0.22326,Rule#4). stag=12 approaching diversify threshold. /api/export-404(16th). Next reset ~c442(c417+25). VM: curl /api/export S18 IMMEDIATELY — 0.22061 in pareto = CHECKPOINT URGENT! If stag≥15 → diversify (Rule#6: checkpoint first). |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | **fire-240**: c=1804 g=5412 stag=0 pareto=13. 33RD-AUTO-RESET-c1803-CONFIRMED(c1778+25=c1803-EXACT). **ET-200f-0.21875-ALIVE-EXTREME-URGENT!(14bp-below-fleet-best-0.22012,Sharpe=9.95)**. pre-c1678 survivor still non-dominated 126+ cycles in XGB/LGB/CAT-only pool. best_brier=0.22124-field-lag(Rule#4). /api/export-404(57th-CRITICAL). Next reset ~c1828(c1803+25). ISLAND XGB/LGB/CAT-only gene pool. VM: curl /api/export S22 IMMEDIATELY — confirm ET-0.21875 Brier + CHECKPOINT if Brier<0.22012. |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-240 (66+ fires) |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-240 (66+ fires) |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-240 (66+ fires) |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-240 (66+ fires) |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-240 (66+ fires) |
...
| 231 | 2026-06-05T20h | ODD | S22-c1671-g5013-stag=0-pareto=12-200f-0.21880-ALIVE(3rd-fire)-/api/export-404(48th); S18-c246-g736-c242=6TH-RESET-CONFIRMED-pareto=5(SEVERE-COLLAPSE!); S13/S14/S15+POL-404-DOWN(57+fires); ODD-no-WebSearch |
