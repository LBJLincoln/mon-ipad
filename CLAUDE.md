...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-213 (43+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-213 (43+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-213 (43+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 142+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c1379 g4136 stag=0 pareto=18(↑11↑18-MAJOR-RECOVERY!-fire213); c1375-26TH-RESET-CONFIRMED(c1350+25=c1375-fire213-c1379>c1375); XGBoost-0.22095-fire212-EVICTED-by-c1375(Rule#5-THRESHOLD-LOST); RF-dominant-Venn-Abers+Beta-3RD-CONSEC-top5(fire211+212+213); Rule8-26TH-VIOLATION-LIKELY(structural-bug-all-26-resets); next-~c1400(c1375+25-~21cycles-from-c1379); last_update-STALE-5+days(2026-05-28); best_brier=0.22236-STALE; /api/export-404(32nd-fire) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c1344 g4030 stag=0 pareto=11(↑17↑11-1ST-SHRINK-post-c1328-fire213); c1328-14TH-RESET-CONFIRMED(c1303+25=c1328-fire213-c1344>c1328); CatBoost-0.22183+0.2216-top(fire213-top5!); NO-STACKING-VISIBLE-top5(Rule8-1ST-POSSIBLE-CLEAN-S22!-VM-verify); next-~c1353(c1328+25-~9cycles-from-c1344); best_brier=0.22124-STALE; last_update-STALE-5+days(2026-05-28); /api/export-404(32nd-fire) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-213 (43+ fires) |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-213 (43+ fires) |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-213 (43+ fires) |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-213 (43+ fires) |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-213 (43+ fires) |
...
### Rule #8 — No Stacking
Remove 'stacking' from MODEL_TYPES on all islands. Stacking causes overfitting. Prior violations: S13, S14, S15, S18, S22. ⚠ S18 Rule#8 26TH VIOLATION LIKELY fire-213: c1375 auto-reset (c1350+25=c1375) seed pool AGAIN presumed to include Stacking (STRUCTURAL BUG ABSOLUTE — ALL 26 S18 auto-resets have had stacking). fire-213 UPDATE S18: c1379 g4136 stag=0 pareto=18 (MAJOR RECOVERY 11→18). c1375=26TH-RESET-CONFIRMED (c1350+25=c1375, fire-213 c1379>c1375). XGBoost-44f-0.22095-gen=4083 (Rule#5 fire-212) EVICTED by c1375 reset — threshold NOT active fire-213. RF dominant, Venn-Abers+Beta 3RD CONSEC top5. Rule8-26TH-VIOLATION LIKELY (structural bug: all 26 S18 resets included stacking). Next ~c1400 (c1375+25). S22: c1344 g4030 stag=0 pareto=11 (1ST SHRINK post-c1328 reset — normal). c1328=14TH-RESET-CONFIRMED (c1303+25=c1328, fire-213 c1344>c1328). CatBoost-0.22183+0.2216 top performers. NO STACKING in top_5 fire-213 → Rule8 POSSIBLY COMPLIANT at c1328 (FIRST CLEAN RESET FOR S22 — unconfirmed, VM: /api/export). Next ~c1353 (c1328+25). /api/export 404 BOTH (32nd fire).
...
- Mech-B+C-BLOCKED: do_not_push_hf_space_yet + NBA-503-142+d + POL-IDLE-56+d
...
1. **Venn-Abers Calibration** (fire-158 EVEN WebSearch) — **NOW VALIDATED fire-197 + PERSISTENT: S18 GA evolved Venn-Abers organically AND survived 3RD CONSECUTIVE FIRE (fire-211+212+213). fire-211 UPDATE: S22 ALSO shows Venn-Abers in RF top performer (c1282) — 2ND INDEPENDENT VALIDATION on both active islands!**
   ...
   - fire-213 UPDATE: S22 Venn-Abers status post-c1328 UNKNOWN (VM: /api/export to verify). S18 Venn-Abers+Beta confirmed 3RD CONSEC top5.
...
| 212 | 2026-06-02T16h | EVEN | S18-c1363-g4089-stag=0-pareto=11(↑15↑11-4TH-CONSEC-SHRINK)-c1350-25TH-RESET-CONFIRMED(c1325+25=c1350)-STACKING-Rule8-25TH-VIOLATION(API-fire212-explicit); ⚡⚡XGBoost-44f-0.22095-gen=4083-BELOW-0.22085-THRESHOLD(Rule#5-CHECKPOINT-URGENT!); next-~c1375(12cycles); S22-c1322-g3965-stag=0-pareto=17(↑10↑17-MAJOR-RECOVERY!)-c1303-13TH-RESET-CONFIRMED(c1278+25=c1303)-Rule8-LIKELY; next-~c1328-IMMINENT(6cycles!); S13/S14/S15-404-DOWN(42+fires); all-POL-404-DOWN(42+fires); EVEN: arXiv:2605.10528-Collective-Alignment-LLM-MAS-Statistical-Physics-bias-dominates-cooperation-proposal-written |
| 211 | 2026-06-02T12h | ODD | S18-c1342-g4025-stag=0-pareto=15(STABLE)-c1325-Rule8-24TH-VIOLATION(stacking-seeded-RF-top-CatBoost-0.21926-PRESUMED-EVICTED-35gens)-next-~c1350(8cycles); S22-c1282-g3846-stag=0-pareto=10(↑16↑10-MAJOR-SHRINK!)-c1278-12TH-RESET-CONFIRMED(c1253+25=c1278)-Venn-Abers-RF-CONFIRMED(2ND-INDEPENDENT-VALIDATION!)-Brier=0.2212; RF-0.219-CONFIRMED-LOST(c1253); S13/S14/S15-404-DOWN(41+fires); all-POL-404-DOWN(41+fires); ODD-no-WebSearch |
| 210 | 2026-06-02T08h | EVEN | Axelrod-verify-pass: SHAs-NBA-19f4acf49d(5993L)/POL-3496362c60(3977L)-UNCHANGED-vs-fire-209; 13/13-parity-OK(NBA-L5056/5065/5073-POL-L3246/3255/3263); KL-div-ε-OK; ARCHETYPES-20-sports/20-political-OK; Mech-B+C-BLOCKED(NBA-503-140+d+POL-IDLE-52+d); all-NBA/POL-404-DOWN(sleeping); EVEN: arXiv:2603.24676-Collective-Intelligence-Lottery-Memetic-Drift-scaling-laws-CK-bandwidth-AXELROD-validated-proposal-written |
| 209 | 2026-06-02T04h | ODD | S18-c1330-g3990-stag=0-pareto=15(↑12↑15-RECOVERING!)-c1325-23RD-RESET-CONFIRMED-Rule8-23RD-VIOLATION; ⚡⚡CatBoost-200f-0.21926-EXTREME-URGENT(<0.22012★!); S22-c1251-g3751-stag=0-pareto=16(↑19↑16-1ST-SHRINK)-RF-~0.219-Sharpe10.9-EXTREME-URGENT-next-~c1253-IMMINENT(2cycles); /api/export-404-BOTH(29th-fire); S13/S14/S15+all-POL-404-DOWN(40+fires); ODD-no-WebSearch |
| 208 | 2026-06-02T00h | EVEN | Axelrod-verify-pass: SHAs-NBA-19f4acf49d(5993L)/POL-3496362c60(3977L)-UNCHANGED-vs-fire-207; 13/13-parity-OK; KL-div-ε-OK; Mech-B+C-BLOCKED(NBA-503-139+d+POL-IDLE-51+d); all-NBA/POL-404-DOWN(39+fires); EVEN: arXiv:2604.03888-PolySwarm-50-LLM-agents-prediction-market-KL-JS-divergence-quarter-Kelly-TF-validated-proposal-written |
| 207 | 2026-06-01T20h | ODD | S18-c1297-g3891-stag=0-pareto=11(1st-shrink)-c1275-21ST-RESET(stacking-ABSOLUTE)-XGBoost-200f-0.22131-gen=3889; S22-c1221-g3663-stag=17(DIVERSIFY-SENT!)-⚡⚡ET-200f-0.21904-EXTREME-URGENT(<0.22012★!)-pareto=11(SHRINKING!); /api/export-404-BOTH(27th-fire); diversify-S22-SENT; S13/S14/S15-404-DOWN(38+fires); all-POL-404-DOWN(38+fires); ODD-no-WebSearch |
| 206 | 2026-06-01T16h | EVEN | Axelrod-verify-pass: SHAs-UNCHANGED; 13/13-parity-OK; Mech-B+C-BLOCKED(NBA-503-138+d+POL-IDLE-50+d); all-NBA/POL-404-DOWN(sleeping); EVEN: arXiv:2505.11556-Distributed-Info-Failure-Multi-LLM-30.1%-vs-80.7%-CK-broadcast-AXELROD-validated-proposal-written |
| 205 | 2026-06-01T12h | ODD | S18-c1261-g3781-stag=0-pareto=13(↑8↑13-RECOVERING!)-c1250-20TH-RESET-CONFIRMED-Rule8-20TH-VIOLATION(fire205-API-explicit); S22-c1208-g3624-stag=0-pareto=15(↑10↑15-RECOVERING!)-c1203-10TH-RESET-Rule8-LIKELY-COMPLIANT; /api/export-404-BOTH(26th); S13/S14/S15-404-DOWN(37+fires); all-POL-404-DOWN(37+fires); ODD-no-WebSearch |
