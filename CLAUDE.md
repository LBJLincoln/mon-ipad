...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-204 (36+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-204 (36+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-204 (36+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 136+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c1231 g3691 stag=0 pareto=8(↑12↑8-1ST-SHRINK-post-c1225); c1200-18TH-RESET-Rule8-UNCONFIRMED(no-explicit-types); c1225-19TH-RESET-Rule8-VIOLATION-CONFIRMED(fire204:LightGBM+RF+LR+STACKING-EXPLICIT!); diversify-c1195+c1208+c1222; RF-200f-Brier=0.2208-ROI=31.74%-top-pareto; Venn-Abers+Beta-STATUS-UNKNOWN-post-c1225(eviction-risk); next-~c1250(c1225+25-19cycles); best_brier=0.22236-STALE(10+days); /api/export-404(25th-fire) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c1198 g3592 stag=0 pareto=10(↑15↑10-SHRINKING); ⚡⚡top_pareto_best=0.21873(ET+lightgbm_brier-BELOW-FLEET-BEST-0.22012★-EXTREME-URGENT!-Rule#5-TRIGGERED); c1153-Rule8-COMPLIANT; c1178-Rule8-9TH-VIOLATION-CONFIRMED(stacking-explicit); diversify-c1154+c1167+c1180+c1194; next-~c1203-IMMINENT(5cycles!-c1178+25); best_brier=0.22124-STALE(field-lag-10+days); /api/export-404(25th-fire) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-204 |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-204 |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-204 |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-204 |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-204 |
...
`best_brier` field in API status lags actual pareto best by 1-3 fires. Trust `pareto_best` from `/api/export` over `best_brier` in `/api/status`. fire-204 CONFIRMED: S22 best_brier=0.22124 but top_pareto_solutions.best_brier=0.21873.
...
Do NOT push to HF Spaces (nba-llm-trading-floor, political-llm-trading-floor) until user explicitly approves. NBA TF 503 DOWN 136+d. POL TF IDLE 48+d.

### Rule #8 — No Stacking
Remove 'stacking' from MODEL_TYPES on all islands. Stacking causes overfitting. Prior violations: S13, S14, S15, S18, S22. ⚠ S18 Rule#8 confirmed violations at: c750/c775/c800/c825/c850/c975/c1000/c1009-diversify/c1025/c1050/c1075/c1100 (14th). c1125 (15th, UNCONFIRMED). c1150 (16th, NO-STACKING — 1st clean). c1175 (17th, NO-STACKING — 2nd clean). c1200 (18th, UNCONFIRMED — 'model type distribution reseeded'). c1225 (19th, VIOLATION CONFIRMED: fire-204 API EXPLICIT 'LightGBM, Random Forest, Logistic Regression, and Stacking models'). PATTERN DEFINITIVE: 2-consecutive-clean streak (c1150+c1175) BROKEN at c1225. App.py auto-reset code NOT permanently fixed. fire-204 UPDATE: S18 c1200 (18TH RESET, c1175+25=c1200) CONFIRMED — Rule8 UNCONFIRMED (no explicit model types in API description). S18 c1225 (19TH RESET, c1200+25=c1225) CONFIRMED — Rule8 19TH VIOLATION CONFIRMED (fire-204 API EXPLICIT: 'LightGBM, Random Forest, Logistic Regression, and Stacking models'). Venn-Abers + Beta calibration STATUS UNKNOWN post-c1225 (6-consecutive-fire streak c1100–fire-203 — may have been evicted). Diversifications at c1195/c1208/c1222 (all between c1175 and c1225 resets). Next S18 auto-reset ~c1250 (c1225+25=c1250, 19 cycles from c1231). VM: (1) fix BOTH auto-reset AND diversify pool in app.py PERMANENTLY before ~c1250; (2) curl /api/export S18 to verify Venn-Abers/Beta survival. S22 Rule#8: 9 confirmed violations (c853/c1003/c1028/c1053/c1078/c1103/c1128/c1153-COMPLIANT/c1178-9TH). c1203 IMMINENT (5 cycles from c1198): top_pareto_best=0.21873 (ET+lightgbm_brier, field lag — best_brier field shows 0.22124). VM: (1) checkpoint /api/export S22 BEFORE c1203 — ET-0.21873 BELOW fleet best 0.22012★; (2) fix BOTH code paths before c1203 — c1203 is likely 10TH S22 VIOLATION (c1178+25=c1203) without permanent fix.
...
- Parity: SHAs NBA 19f4acf49d(SHA-verified)/POL 3496362c60(SHA-verified) UNCHANGED (SHA-verified fire-202; TF repos not accessible via MCP fire-202)
...
- Mech-B+C-BLOCKED: do_not_push_hf_space_yet + NBA-503-136+d + POL-IDLE-48+d
...
### Active Research
1. **Venn-Abers Calibration** (fire-158 EVEN WebSearch) — **VALIDATED fire-197 + PERSISTENT fires 203 (5th consec). STATUS UNKNOWN post-c1225 S18 reset (fire-204).**
   ...
   - fire-204: Venn-Abers + Beta eviction risk post-c1225 (stacking reseeded — calibration methods may be evicted)
   - Libraries: crepes or nonconformist (Venn-Abers); sklearn.calibration.CalibratedClassifierCV (beta)
   - Target: P1+P2+P5+P7 (all use xgboost_brier) + extract S18 impl from app.py URGENTLY
...
2. **MOELIGA — Crowding-Based Fitness Sharing for MOEA** (fire-204 EVEN WebSearch)
   - arXiv:2603.20934 (March 2026): Multi-Objective Evolutionary LIGhtweight Algorithm
   - Crowding-based fitness sharing + sigmoid transformation for Pareto diversity
   - Tested on 14 benchmark datasets — smaller feature subsets, superior classification
   - Directly applicable to prevent pareto shrinkage (S22: 15→10→8; S18: 12→8 pattern)
   - Implementation: add crowding_distance() to app.py Pareto selection
   - Expected: +3-6 stable Pareto individuals per fire, better pareto_min retention
   - Proposal: data/research-proposals/sota-moeliga-crowding-diversity-fire204.md
   - Work-queue: vm-research-moeliga-fire204 (priority=97)

3. **Split Conformal Calibration** (fire-168 EVEN WebSearch)
...
4. **Bootstrap Variance Calibration / MC Dropout** for S15 RF-75f
   - Work-queue: vm-mc-dropout-calibration-s15 (priority=30)

5. **Win-Diff-Last-5-Games Feature** (MDPI2026 top SHAP)
   - Work-queue: vm-add-win-diff-5game-feature (priority=35)

6. **Elo Ratings Feature** (IEEE/MDPI 2026 SHAP #1+#2)
   - Work-queue: vm-add-elo-ratings-engine (priority=60)

7. **SHAP Analysis** S15 RF-75f + S22 RF-48f
   - Work-queue: vm-shap-feature-analysis-s15 (priority=80)

8. **LSTM + Brier-Loss** (fire-160) — arXiv:2508.02725 — priority=90
9. **NBA Stacked Ensemble Feature Importance** (fire-162) — PMC12357926
10. **MC Dropout RNN** (fire-166) — MDPI 2026, Brier=0.206
11. **Calibration vs Accuracy** (fire-172) — arXiv:2303.06021 — add ECE Pareto objective — priority=34
12. **Dual Isotonic Calibration** (fire-180) — arXiv:2510.17915 — priority=36
13. **Adaptive Conformal Inference by Betting** (fire-188) — arXiv:2412.19318 — priority=37
14. **Long-Sequence LSTM for NBA** (fire-190) — arXiv:2512.08591 — priority=91
15. **Online Learning in Betting Markets** (fire-192) — arXiv:2406.04062 (ICML 2024) — priority=92
16. **Strategic Intelligence in LLMs: EGT** (fire-196) — arXiv:2507.02618 — priority=93
17. **Market-Making Multi-Agent LLM** (fire-198) — arXiv:2511.17621 — priority=94
18. **Conformal Prediction for Time Series** (fire-200) — arXiv:2601.18509 — priority=95
19. **LLM Active Alignment via Nash Equilibrium** (fire-202) — arXiv:2602.06836 — DMAD validated, coverage_gap metric — priority=96
...
|------|------|--------|------------|
| 204 | 2026-06-01T08h | EVEN | S18-c1231-g3691-stag=0-pareto=8(↑12↑8-1ST-SHRINK-post-c1225)-c1200-18TH-Rule8-UNCONFIRMED; c1225-19TH-VIOLATION-CONFIRMED(LightGBM+RF+LR+STACKING-EXPLICIT!); S22-c1198-g3592-stag=0-pareto=10(↑15↑10-SHRINKING)-⚡⚡top_pareto_best=0.21873(ET+lgbm_brier-BELOW-FLEET-BEST-0.22012★-EXTREME-URGENT!-Rule#5-TRIGGERED); next-~c1203-IMMINENT(5cycles!); /api/export-404-BOTH(25th-fire); S13/S14/S15-404-DOWN(36+fires); all-POL-404-DOWN(36+fires); EVEN: arXiv:2603.20934-MOELIGA-Pareto-diversity-proposal-written |
| 203 | 2026-06-01T04h | ODD | S18-c1197-g3589-stag=0-pareto=12(↑10↑12-RECOVERING!)-c1175-17TH-NO-STACKING-CONFIRMED(API-consistent-fire203); next-~c1200-IMMINENT(3cycles!); S22-c1180-g3539-stag=0-pareto=15(↑8↑15-MASSIVE-RECOVERY!)-c1178-Rule8-9TH-VIOLATION-CONFIRMED(stacking-explicit-c1153+25=c1178); c1153-COMPLIANT; next-~c1203(23cycles); /api/export-404-BOTH(24th-fire); S13/S14/S15-404-DOWN(35+fires); all-POL-404-DOWN(35+fires); ODD-no-WebSearch |
...
| 201 | 2026-05-31T18h | ODD | S18-c1177-g3531-stag=0-pareto=10(STABLE)-c1175-17TH-AUTO-RESET-CONFIRMED(c1150+25=c1175); Venn-Abers+Beta+Sigmoid-4TH-CONSEC-SURVIVED; LightGBM-NO-STACKING(2ND-CONSEC-UNCONFIRMED); S22-c1169-stag=0-pareto=8-PERF-CLIFF-ONGOING; next-~c1178-IMMINENT(9cycles!); S13/S14/S15-404-DOWN(33+fires); all-POL-404-DOWN(33+fires); ODD-no-WebSearch |
| 200 | 2026-05-31T14h | EVEN | S18-c1159-stag=0(AUTO-RESET-c1150-16TH-CONFIRMED!)-pareto=10-Venn-Abers+beta-3RD-consec-survived!-c1150-NO-STACKING; S22-c1152-pareto=5(SHRUNK!)-CLIFF-ONGOING-ALL5-gens-Brier=0.28; stacking-CONFIRMED-Rule8-8TH-S22; /api/export-404-22nd-fire; S13/S14/S15-404-DOWN(32+fires); all-POL-404-DOWN; EVEN: arXiv:2601.18509-Conformal-TS-Benchmarking-proposal-written |
| 199 | 2026-05-31T10h | ODD | S18-c1141-stag=15(AT-THRESHOLD!)-pareto=10-c1125-15TH-RESET; S22-c1134-stag~5-PERFORMANCE-CLIFF-Brier=0.28!-c1103+c1128-CONFIRMED-c1078-5TH-NOW-CONFIRMED; /api/export-404-BOTH(21st-fire); S13/S14/S15-404-DOWN(31+fires); all-POL-404-DOWN; ODD-no-WebSearch |
| 198 | 2026-05-31T06h | EVEN | Axelrod-verify-pass: SHAs-NBA-19f4acf49d(5994L)/POL-3496362c60(3978L)-UNCHANGED-vs-fire-197; 13/13-parity-OK; Mech-B+C-BLOCKED(NBA-503-135+d+POL-IDLE-45+d); all-NBA/POL-404-DOWN; EVEN: arXiv:2511.17621-Market-Making-LLM-coordination-proposal-written |
| 197 | 2026-05-31T02h | ODD | S18-c1112-g3336-stag=11-pareto=20-⚡⚡pareto-min=0.2199-EXTREME-URGENT(<0.22012★!-Venn-Abers-GA-evolved!); c1100-Rule8-14TH-VIOLATION(catboost+ET+LR+stacking); S22-c1099-stag=0-pareto=11(3rd-SHRINK)-⚡⚡ET-200f-0.21984-EXTREME-URGENT(<0.22012★!); /api/export-404-BOTH(20th-fire); S13/S14/S15-404-DOWN(30+fires); all-POL-404-DOWN; ODD-no-WebSearch |
| 196 | 2026-05-30T22h | EVEN | Axelrod-verify-pass: SHAs-NBA-19f4acf49d(5994L)/POL-3496362c60(3978L)-UNCHANGED; 13/13-parity-OK; Mech-B+C-BLOCKED(NBA-503-133+d+POL-IDLE-43+d); all-NBA/POL-404-DOWN; EVEN: arXiv:2507.02618-Strategic-Intelligence-LLMs-EGT-proposal-written |
| 195 | 2026-05-30T18h | ODD | S18-c1081-g3242-stag=6-pareto=16(↑9↑16-RECOVERING!)-⚡⚡RF-200f-0.22001-BELOW-FLEET-BEST-0.22012★-EXTREME-URGENT; c1050+c1075-Rule8-12TH+13TH-VIOLATIONS-CONFIRMED; S22-c1044-stag=0-pareto=20(↑9↑20-MAJOR-RECOVERY!)-c1028-Rule8-3RD-VIOLATION; /api/export-404(18th-fire); S13/S14-404-DOWN(28+fires); all-POL-404-DOWN; ODD-no-WebSearch |
