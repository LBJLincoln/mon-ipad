...
HF EVOLUTION ISLANDS — 11 SURVIVORS (6 NBA + 5 POL) after 2026-04-17 cull
    ...
    ├── S13 Nomos42/nba-evo-4:        xgboost_brier       gen=1392  brier=0.22216  stagnation=0  ✓ cycle=464; hard-reset-c454; ⚡ ET-200f-0.21914 PARETO 1ST-DETECT (below fleet best!); monitor-S13-pareto-ET-fire121 ADDED (2026-05-17T16h)
    ├── S14 Nomos42/nba-evo-5:        extra_trees         gen=3707  brier=0.22336  stagnation=0  ✓ cycle=1236; hard-reset-c1228; ⚡ RF-200f-0.2189 PARETO 1ST-DETECT (NEW NBA PARETO CANDIDATE!); monitor-S14-pareto-RF-fire121 ADDED (2026-05-17T16h)
    ├── S15 Nomos42/nba-evo-6:        random_forest       gen=4463  best=0.22012   stagnation=0  ✓ cycle=1488; hard-reset-c1476; ★ FLEET BEST 0.22012; ⚡⚡⚡ ET-200f attractor 8th fire VM-CHECKPOINT-EXTREME-URGENT (2026-05-17T16h)
    ├── S17 LBJLincoln26/nba-evo-s17: ---                 gen=---   brier=---      🔴 503 DOWN 90+ days — VM RESTART REQUIRED (2026-05-17T16h)
    ├── S18 TESTforge42/nba-evo-s18:  xgboost_brier       gen=8093  brier=0.22315  stagnation=0  ✓ cycle=2698; pareto ET-200f-0.2191 (0.21885 fire-118 may be superseded post-reset); vm-checkpoint-s18 URGENT priority=1 (2026-05-17T16h)
    └── S22 TESTforge42/nba-evo-s22:  catboost            gen=3020  brier=0.22551  stagnation=0  ✓ cycle=1007; hard-reset-c965; vm-add-lightgbm-s22-s13 + vm-remove-stacking-s22 PENDING VM (2026-05-17T16h)
    Political Survivors (5, CPU tree-only):
    ├── P1 Nomos42/political-alpha:      xgboost_brier       gen=69051  brier=0.2499  stagnation=0  ✓ cycle=23017; hard-resets-22961+23001 (2026-05-17T16h)
    ├── P2 Nomos42/political-alpha-2:    xgboost_brier       gen=55278  brier=0.25003 stagnation=0  ✓ cycle=18426; LightGBM-123f-Brier=0.249 in-pop (2026-05-17T16h)
    ├── P4 LBJLincoln/political-alpha-4: lightgbm            gen=88236  brier=0.24992 stagnation=0  ✓ cycle=29412; ★ POL FLEET BEST alltime=0.24904; LightGBM 108f Brier=0.2490; hard-resets-29354+29374 (2026-05-17T16h)
    ├── P5 LBJLincoln/political-alpha-5: xgboost_brier       gen=74857  brier=0.24993 stagnation=0  ✓ cycle=24953; LightGBM-104f-Brier=0.249; hard-resets-24901+24921 (2026-05-17T16h)
    └── P7 LBJLincoln/political-alpha-7: xgboost_brier       gen=5995   brier=0.25004 stagnation=0  ✓ cycle=1999; ⚡ LightGBM-116f-0.24937 CONFIRMED 2nd-fire vm-checkpoint-p7 ADDED priority=2 (2026-05-17T16h)
```
