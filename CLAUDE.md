...
> Architecture v21 — "The Trading Floor Crew" (14 agents × 9 depts × 4 tracks) + TF v3 (17 LLM agents) + 21 Evolution Islands | Updated: 2026-05-19T18h
...
HF EVOLUTION ISLANDS — 11 SURVIVORS (6 NBA + 5 POL) after 2026-04-17 cull
    ...
    ├── S13 Nomos42/nba-evo-4:        xgboost_brier       gen=1866  brier=0.22216  stagnation=0  ✓ cycle=622; hard-reset-c604(stag=25); LR+stacking in pool (Rule#8 violation pending vm-remove-stacking-s13); pareto=15 (2026-05-19T18h)
    ├── S14 Nomos42/nba-evo-5:        extra_trees         gen=256   brier=0.22793  stagnation=0  ✓ cycle=86; hard-reset-c53; ET-dominant; pareto=11; xgb-0.22006-fire127-MONITORING-INCONCLUSIVE(pareto-api-404) (2026-05-19T18h)
    ├── S15 Nomos42/nba-evo-6:        random_forest       gen=5290  best=0.22012   stagnation=0  ✓ cycle=1764; ★ FLEET BEST 0.22012; hard-reset-c1726; pareto=10; ET-0.21908-fire127 status-uncertain-post-reset (2026-05-19T18h)
    ├── S17 LBJLincoln26/nba-evo-s17: ---                 gen=---   brier=---      🔴 503 DOWN 100+ days — VM RESTART REQUIRED (2026-05-19T18h)
    ├── S18 TESTforge42/nba-evo-s18:  random_forest       gen=259   brier=0.22236  stagnation=11 ⚠ WATCH-stag=11(threshold=15); cycle=87; pareto=17; recovering-reboot; rapid-recovery(0.24723→0.22236 in +15c) (2026-05-19T18h)
    └── S22 TESTforge42/nba-evo-s22:  random_forest       gen=93    brier=0.22124  stagnation=0  ✓ cycle=31; recovering-factory-reboot; RF-44f; pareto=13; REMARKABLE-0.22124-stable; vm-checkpoint-s22 PRIORITY=1 (2026-05-19T18h)
    Political Survivors (5, CPU tree-only):
    ├── P1 Nomos42/political-alpha:      xgboost_brier       gen=4231   brier=0.24987 stagnation=0  ✓ POL-FLEET-BEST; cycle=1411; pareto=6; feature_candidates=272-EXPECT-FIX(engine-restored-fire132) (2026-05-19T18h)
    ├── P2 Nomos42/political-alpha-2:    xgboost_brier       gen=58195  brier=0.25003 stagnation=0  ✓ cycle=19399; LightGBM-123f-0.249 in-pareto; pareto=6 (2026-05-19T18h)
    ├── P4 LBJLincoln/political-alpha-4: extra_trees         gen=659    brier=0.25337 stagnation=0  ⚠ FACTORY-REBOOT-fire130; cycle=220; pareto=18; XGBoost-0.24998-MONITOR-INCONCLUSIVE(pareto-api-404); vm-investigate-p4-factory-reboot pending (2026-05-19T18h)
    ├── P5 LBJLincoln/political-alpha-5: xgboost_brier       gen=78939  brier=0.24993 stagnation=0  ✓ cycle=26313; pareto=5 (2026-05-19T18h)
    └── P7 LBJLincoln/political-alpha-7: xgboost_brier       gen=12543  brier=0.25004 stagnation=0  ✓ cycle=4181; pareto=3(SHRINKING-was-4); LightGBM-0.24931 MONITOR(pareto-drop-WATCH); vm-checkpoint-p7-lgbm-0.24931 URGENT priority=1 (2026-05-19T18h)
```
