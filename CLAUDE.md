...
HF EVOLUTION ISLANDS — 11 SURVIVORS (6 NBA + 5 POL) after 2026-04-17 cull
    ...
    ├── S13 Nomos42/nba-evo-4:        xgboost_brier       gen=2519  brier=0.22216  stagnation=0  ✓ cycle=840; stag=0 pareto=11(↓13→11); hard-reset-c829-stacking-excluded-from-reseed ⚡ET-0.2209-gen2488-FIELD-LAG-CAND(3-gen-transient); vm-remove-stacking-s13 URGENT (2026-05-23T10h)
    ├── S14 Nomos42/nba-evo-5:        extra_trees         gen=1152  brier=0.22793  stagnation=0  ✓ cycle=384; stag=0 hard-resets-c353+c378-auto-recovery (2026-05-23T10h)
    ├── S15 Nomos42/nba-evo-6:        random_forest       gen=6416  best=0.22012   stagnation=0  ✓ cycle=2139; ★ FLEET BEST 0.22012; stag=0-CLEARED(post-diversify-fire150-CONFIRMED) (2026-05-23T10h)
    ├── S17 LBJLincoln26/nba-evo-s17: ---                 gen=---   brier=---      🔴 503 DOWN 109+ days — VM RESTART REQUIRED (2026-05-23T10h)
    ├── S18 TESTforge42/nba-evo-s18:  random_forest       gen=938   brier=0.22236  stagnation=0  ✅ cycle=313; stag=0 RF-44f hard-resets-c275+c300-auto-recovery (2026-05-23T10h)
    └── S22 TESTforge42/nba-evo-s22:  random_forest       gen=769   brier=0.22124  stagnation=0  ✓ cycle=257; stag=0 pareto=17(↑15→17-STRONG) RF-48f; vm-checkpoint-s22 PENDING (2026-05-23T10h)
    Political Survivors (5, CPU tree-only):
    ├── P1 Nomos42/political-alpha:      xgboost_brier       gen=16536  brier=0.24987 stagnation=0  ✓ cycle=5512; stag=0 pareto=10(↑9→10) XGBoost-85f (2026-05-23T10h)
    ├── P2 Nomos42/political-alpha-2:    xgboost_brier       gen=63009  brier=0.25003 stagnation=0  ✓ cycle=21003; stag=0 pareto=10(↑6→10-STRONG-RECOVERY) XGBoost-65f (2026-05-23T10h)
    ├── P4 LBJLincoln/political-alpha-4: lightgbm            gen=7564   brier=0.2497  stagnation=0  ✓★ cycle=2522; ★★POL-FLEET-BEST; stag=0 pareto=8(↓9→8-slight) LightGBM-62f-5TH-OBSERVE; vm-checkpoint-p4-lgbm EXTREME URGENT (2026-05-23T10h)
    ├── P5 LBJLincoln/political-alpha-5: xgboost_brier       gen=83578  brier=0.24993 stagnation=0  ✓ cycle=27860; stag=0 pareto=11(↓14→11-consolidating) XGBoost-58f (2026-05-23T10h)
    └── P7 LBJLincoln/political-alpha-7: xgboost_brier       gen=24819  brier=0.25004 stagnation=0  ✓ cycle=8273; stag=0 pareto=6(↓7→6-slight) XGBoost-60f (2026-05-23T10h)
```
