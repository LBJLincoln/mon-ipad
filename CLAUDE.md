...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-183 |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-183 |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST stable gen=6672 pareto=13 — SLEEPING fire-183 |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 122+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c859 g2575 stag=0(c850-auto-reset-cleared)-pareto=15(↓19→15-1st-shrink); c850-hard-reset-CONFIRMED(stacking-REINTRODUCED-Rule8-5TH-VIOLATION-pattern:ALL-5-auto-resets-broken); CatBoost-0.21995-gen=2505-POSSIBLY-LOST-in-c850-reset(top-now-LightGBM-38f-0.24729-ROI+RF/ET-200f-~0.2206-0.2207); LightGBM-dominant; next-auto-reset-~c875(c850+25-16cycles); /api/export-404(WebFetch-9-fire-confirmed) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c776 g2328 stag=0-RECOVERING-pareto=13(↑7→13!); hard-resets-c728+c753-CONFIRMED(NO-stacking-in-either-reset); next-auto-reset-~c778-IMMINENT(c753+25-2cycles-from-c776!); LR-dominating-recent-gens(NEW-fire183); ET-strong-Pareto-performers(Brier-unconfirmed-13+fires); RF-primary-best_brier=0.22124; Rule8-LIKELY-COMPLIANT-6TH-fire; /api/export-404(WebFetch-9-fire-confirmed) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-183 |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-183 |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-183 |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-183 |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-183 |
...
### Rule #8 — No Stacking
Remove 'stacking' from MODEL_TYPES on all islands. Stacking causes overfitting. Prior violations: S13, S14, S15, S18, S22. ⚠ S18 Rule#8 5TH VIOLATION CONFIRMED fire-183: c850 auto-reset description explicitly includes 'stacking variants'. Pattern confirmed: ALL 5 auto-resets (c750/c775/c800/c825/c850) reintroduce stacking via broken fallback in app.py. VM: Fix permanently — remove 'stacking' from the reseeding pool in app.py auto-reset code. Note: CatBoost-0.21995 top performer (gen=2505, fire-181) POSSIBLY LOST in c850 reset — verify via /api/export. ⚠ S22 Rule#8 LIKELY COMPLIANT fire-183: 6th consecutive fire (177+178+179+180+181+183) primary=random_forest; no stacking in c728/c753 reset descriptions. Unconfirmed without /api/export. Remaining confirmed violations: S13/S14/S15 (sleeping, pending checkpoint+verify).
...
- Parity: SHAs NBA 19f4acf49d(5993L)/POL 3496362c60(3977L) UNCHANGED vs fire-183 (verified fire-184)
...
2. **Split Conformal Calibration** (fire-168 EVEN WebSearch)
   ...
   - Target: S18 RF/LightGBM pareto (c859) + S22 RF-48f + S15 RF-75f
...
10. **Calibration vs Accuracy Model Selection** (fire-172 EVEN WebSearch)
    ...
    - Fire-183 confirmation: S22 LR now DOMINATING recent generations (new fire-183 finding)
...
|------|------|--------|------------|
| 184 | 2026-05-28T22h | EVEN | Axelrod-verify-pass: SHAs-NBA-19f4acf49d(5993L)/POL-3496362c60(3977L)-UNCHANGED-vs-fire-183; 13/13-parity-OK; C→B→A-confirmed(NBA-L5056/5065/5073-POL-L3246/3255/3263); KL-div-ε-smoothed-self-excluded-OK; AXELROD_ARCHETYPES-NBA-20-sports/POL-20-political-financial-OK; Mech-B+C-BLOCKED(do_not_push_hf_space_yet+NBA-503-123+d+POL-IDLE-35+d); all-NBA/POL-404-DOWN(sleeping) |
