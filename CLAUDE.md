...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-229 (55+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed — SLEEPING fire-229 (55+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-229 (55+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 144+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | EVOLVING | 0.22326 | **fire-229**: c=~205 g=~615 stag=0 (est). best_brier=0.22326 (plateau). c167=3RD AUTO-RESET CONFIRMED. 4TH auto-reset approaching (~c192+25=~c217). Rule8 CLEAN (RF+ET). VM: curl /api/export S18. |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | **fire-229** ⚡⚡⚡ALL-TIME CANDIDATE: c=~1628 26TH-RESET-PREDICTED(c1603+25=c1628-EXACT). ET-200f-0.21875-STATUS-UNKNOWN-AT-c1628-EVICTION-WINDOW. Rule8-CLEAN(RF+ET fire-228). best_brier=0.22124(field-lag). /api/export-404(46th). VM: curl /api/export S22 IMMEDIATELY — confirm ET-200f-0.21875 survival at c1628! EXTREME URGENT! |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-229 (55+ fires) |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-229 (55+ fires) |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-229 (55+ fires) |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-229 (55+ fires) |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-229 (55+ fires) |
...
fire-229 UPDATE S18: c=~205 g=~615 stag=0 (est). c67=1ST CLEAN + c142=2ND CLEAN + c167=3RD CLEAN (all pareto-growing). 4TH auto-reset approaching (~c217). best_brier=0.22326 plateau. /api/export-404(8th est). VM: curl /api/export S18 to confirm c192+ pool Rule8.
fire-229 UPDATE S22: c=~1628 26TH-RESET-PREDICTED(c1603+25=c1628-EXACT!). ET-200f-0.21875-ALL-TIME-CANDIDATE status UNKNOWN at c1628 — may be EVICTED. /api/export-404(46th fire). Rule8-CLEAN(RF+ET confirmed fire-228). VM: curl /api/export S22 IMMEDIATELY — confirm if ET-200f-0.21875 survived c1628 or was evicted! EXTREME URGENT!
...
|------|------|--------|------------|
| 229 | 2026-06-05T12h | ODD | Axelrod-verify-pass-SHAs-NBA-85e7682e1d/POL-6983c86517-UNCHANGED; py_compile-OK-both; 13/13-parity-OK; S22-c~1628-26TH-RESET-PREDICTED(c1603+25=c1628-EXACT!)-ET-200f-0.21875-STATUS-UNKNOWN(/api/export-404-46th); S18-c~205-stag=0-4TH-RESET-APPROACHING(~c217); S13/S14/S15-404-DOWN(55+fires); all-POL-404-DOWN(55+fires); ODD-no-WebSearch |
