...
> Architecture v21 — "The Trading Floor Crew" (14 agents × 9 depts × 4 tracks) + TF v3 (17 LLM agents) + 21 Evolution Islands | Updated: 2026-06-08T08h
...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-246 (72+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed — SLEEPING fire-246 (72+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-246 (72+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 144+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | EVOLVING | 0.22326 | **fire-246**: c=600 g=1798 stag=0 pareto=19(GROWING!). **19TH-AUTO-RESET-c567-CONFIRMED(c542+25=c567-EXACT)+20TH-AUTO-RESET-c592-CONFIRMED(c567+25=c592-EXACT)**. **RF-200f-0.21949 EXTREME URGENT!** (6bp BELOW FLEET BEST 0.22012!) last_improvement=c593(post-20TH-RESET!). best_brier=0.22326 (field-lag). /api/export-404(22nd-CRITICAL). Next reset ~c617(c592+25). VM: curl /api/export S18 IMMEDIATELY — RF-200f-0.21949 EXTREME URGENT! |
| S22 | TESTforge42/nba-evo-s22 | FRESH-RESTART | 0.22124 | **fire-246**: c=22 g=66 stag=0 pareto=14. FRESH-RESTART continuing. **ET-0.2193 EXTREME URGENT!** (8bp BELOW FLEET BEST 0.22012!) at only g=66 — EXTRAORDINARY early signal. First auto-reset ~c25 **IMMINENT (3 cycles!)**. best_brier=0.2207 gen9 (field-lag). /api/export-404(2nd new run). VM: curl /api/export S22 IMMEDIATELY — ensure ET NOT evicted at ~c25 reset! Gene pool 70x faster convergence vs prior wipes. |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-246 (72+ fires) |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-246 (72+ fires) |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-246 (72+ fires) |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-246 (72+ fires) |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-246 (72+ fires) |
...
- Mech B: CODE-DONE (fire-122+, verified fire-245) — sacrificial role reallocation (BLOCKED: HF push gate)
- Mech C: CODE-DONE (fire-122+, verified fire-245) — post-mortem log + dataset (BLOCKED: HF push gate)
...
- Parity: SHAs NBA 85e7682e1d(6035L)/POL 6983c86517(4019L) verified fire-245(ODD); fire-225 added +12L each for ablation flags (NBA:6023L→6035L, POL:4007L→4019L). 25/25 parity maintained. KL-div fields OK.
