...
HF EVOLUTION ISLANDS — 11 SURVIVORS (6 NBA + 5 POL) after 2026-04-17 cull
    ...
    ├── S13 Nomos42/nba-evo-4:        xgboost_brier       gen=1693  brier=0.22216  stagnation=0  ✓ cycle=565; stag=0 ok; pareto ET-200f-0.22068; vm-checkpoint-s13-ET CLOSED-DROPPED (2026-05-18T10h)
    ├── S14 Nomos42/nba-evo-5:        extra_trees         gen=31    brier=0.22793  stagnation=0  ✓ cycle=11; FRESH RESTART RECOVERING — ⚡ET-200f-0.21923-PARETO-1ST-DETECT gen=28 EXTRAORDINARY; vm-checkpoint-s14-et-0.21923 ADDED work-queue priority=3 (2026-05-18T10h)
    ├── S15 Nomos42/nba-evo-6:        random_forest       gen=4900  best=0.22012   stagnation=0  ✓ cycle=1634; ★ FLEET BEST 0.22012; stag=0 CLEARED diversify-WORKED; pareto top RF-200f-0.2195; ET-200f-0.2185 UNCERTAIN (may evicted); VM-CHECKPOINT-STILL-URGENT (2026-05-18T10h)
    ├── S17 LBJLincoln26/nba-evo-s17: ---                 gen=---   brier=---      🔴 503 DOWN 94+ days — VM RESTART REQUIRED (2026-05-18T10h)
    ├── S18 TESTforge42/nba-evo-s18:  extra_trees         gen=8434  brier=0.22315  stagnation=0  ✓ cycle=2812; ⚡ pareto ET-200f-0.21877 NEW S18 PARETO BEST (front=13); stag=0 ok; vm-checkpoint-s18 URGENT priority=1 (2026-05-18T10h)
    └── S22 TESTforge42/nba-evo-s22:  extra_trees         gen=3227  brier=0.22551  stagnation=0  ✓ cycle=1076; ⚡⚡⚡⚡ CatBoost-200f-0.21818 NEW ALL-TIME PARETO RECORD 1ST-DETECT (prev 0.21841); VM-CHECKPOINT-EXTREME-URGENT; vm-checkpoint-s22-catboost ADDED work-queue priority=1 (2026-05-18T10h)
    Political Survivors (5, CPU tree-only):
    ├── P1 Nomos42/political-alpha:      xgboost_brier       gen=2134   brier=0.24987 stagnation=0  ✓ cycle=712; RECOVERING from fresh restart; pareto_front=9; add LR+elastic_net (ideal config moment) (2026-05-18T10h)
    ├── P2 Nomos42/political-alpha-2:    xgboost_brier       gen=56900  brier=0.25003 stagnation=0  ✓ cycle=18967; LightGBM-123f-Brier=0.249 in-pop; stag=0 ok (2026-05-18T10h)
    ├── P4 LBJLincoln/political-alpha-4: lightgbm            gen=90098  brier=0.24992 stagnation=0  ✓ cycle=30033; ★ POL FLEET BEST alltime=0.24904; LightGBM-108f Brier=0.2490 Sharpe=1.01; stable (2026-05-18T10h)
    ├── P5 LBJLincoln/political-alpha-5: xgboost_brier       gen=77441  brier=0.24993 stagnation=0  ✓ cycle=25814; LightGBM-102f-0.249 top model; stag=0 ok (2026-05-18T10h)
    └── P7 LBJLincoln/political-alpha-7: xgboost_brier       gen=9652   brier=0.25004 stagnation=0  ✓ cycle=3218; pareto_front=10; stag=0 ok; ⚠ LightGBM-116f-0.24937 UNCERTAIN (vm-checkpoint-p7 VERIFY still pending) (2026-05-18T10h)
```
