...
HF EVOLUTION ISLANDS — 11 SURVIVORS (6 NBA + 5 POL) after 2026-04-17 cull
    ...
    ├── S13 Nomos42/nba-evo-4:        xgboost_brier       gen=2255  brier=0.22216  stagnation=0  ✓ cycle=752; stag=0 pareto=12(↑7→12-RECOVERING); ⚡⚡CATBOOST-200f-0.22076-PARETO-2ND-FIRE-MONITORING(gen=2201,BELOW-0.22085-THRESHOLD-VM-CHECKPOINT-EXTREME-URGENT); vm-remove-stacking-s13 URGENT (2026-05-22T06h)
    ├── S14 Nomos42/nba-evo-5:        extra_trees         gen=739   brier=0.22793  stagnation=0  ✓ cycle=247; stag=0-CLEARED(hard-reset-c228); pareto=17(↑7→17-STRONG-RECOVERY) ET-200f-pareto_best=0.22170-stable; vm-checkpoint-s14-et PENDING (2026-05-22T06h)
    ├── S15 Nomos42/nba-evo-6:        random_forest       gen=5984  best=0.22012   stagnation=0  ✓ cycle=1995; ★ FLEET BEST 0.22012; pareto=10(↓11→10) ET-200f-in-pareto pareto_best=0.22023-VM-CHECKPOINT-URGENT; hard-reset-c1976 (2026-05-22T06h)
    ├── S17 LBJLincoln26/nba-evo-s17: ---                 gen=---   brier=---      🔴 503 DOWN 103+ days — VM RESTART REQUIRED (2026-05-22T06h)
    ├── S18 TESTforge42/nba-evo-s18:  random_forest       gen=692   brier=0.22236  stagnation=0  ✅ cycle=231; SSL-CERT-RESOLVED; stag=0 pareto=12 RF-44f; hard-resets-c200+c225; vm-s18-ssl-cert-error RESOLVED (2026-05-22T06h)
    └── S22 TESTforge42/nba-evo-s22:  random_forest       gen=358   brier=0.22124  stagnation=0  ✓ cycle=120; stag=0-CLEARED(hard-reset-c109); pareto=8(↓11→8-WATCH); vm-checkpoint-s22 PENDING (2026-05-22T06h)
    Political Survivors (5, CPU tree-only):
    ├── P1 Nomos42/political-alpha:      xgboost_brier       gen=11330  brier=0.24987 stagnation=0  ✓ cycle=3777; pareto=11(↑6→11-MAJOR-RECOVERY); pareto_best=0.24927-VM-CHECKPOINT-URGENT (2026-05-22T06h)
    ├── P2 Nomos42/political-alpha-2:    xgboost_brier       gen=60693  brier=0.25003 stagnation=0  ✓ cycle=20232; pareto=7(↑6→7) gen-milestone-60k+ (2026-05-22T06h)
    ├── P4 LBJLincoln/political-alpha-4: lightgbm            gen=4427   brier=0.2497  stagnation=0  ✓★ cycle=1476; ★★POL-FLEET-BEST; pareto=8(↓11→8) ⭐pareto_best=0.24915-NEW-POL-ALL-TIME-PARETO-RECORD-CONFIRMED-2ND-FIRE; vm-checkpoint-p4-lgbm-EXTREME-URGENT (2026-05-22T06h)
    ├── P5 LBJLincoln/political-alpha-5: xgboost_brier       gen=81160  brier=0.24993 stagnation=0  ✓ cycle=27054; pareto=5(↓6→5) LightGBM-102f-0.249-stable (2026-05-22T06h)
    └── P7 LBJLincoln/political-alpha-7: xgboost_brier       gen=19460  brier=0.25004 stagnation=0  ✓ cycle=6487; ⚠pareto=5(↓10→5-MAJOR-SHRINK-EVICTION-RISK); LightGBM-112f-0.24931-pareto_best=0.24931; vm-checkpoint-p7-lgbm EXTREME-URGENT priority=1 (2026-05-22T06h)
```
