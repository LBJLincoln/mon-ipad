...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-234 (60+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed — SLEEPING fire-234 (60+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-234 (60+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 144+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | EVOLVING | 0.22326 | **fire-234**: c=300 g=898 stag=0 pareto=12. 8TH-AUTO-RESET-PASSED(~c292=c267+25). Rule8 UNKNOWN(/api/export-404(12th)). best_brier=0.22326 plateau. Next reset ~c317(c292+25). VM: curl /api/export S18 to confirm Rule8 at c292. |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | **fire-234**: c=1706 g=5117 stag=0 pareto=8(post-c1703-29TH-RESET). 28TH-RESET-c1678(CLEAN:xgb/lgb/cat)+29TH-RESET-c1703(CLEAN:xgb/lgb/cat)-BOTH-NO-STACKING. 200f-0.21880 CONFIRMED-EVICTED-c1678(RF/ET-not-reseeded). cycle-stag=2. /api/export-404(51st-CRITICAL). Next reset ~c1728(c1703+25). ISLAND XGB/LGB/CAT-ONLY GENE POOL. VM: curl /api/export S22 urgently. |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-234 (60+ fires) |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-234 (60+ fires) |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-234 (60+ fires) |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-234 (60+ fires) |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-234 (60+ fires) |
...
- Parity: SHAs NBA 85e7682e1d(6035L)/POL 6983c86517(4019L) verified fire-233(ODD); fire-225 added +12L each for ablation flags (NBA:6023L→6035L, POL:4007L→4019L). 13/13 parity maintained. KL-div fields OK.
...
| 232 | 2026-06-06T00h | EVEN | S18-c268-g803-stag=0-pareto=12(↑5→12-RECOVERY!)-c267=7TH-AUTO-RESET-CONFIRMED-Rule8-LIKELY-CLEAN-/api/export-404(11th)-next-reset~c292; S22-c1689-g5065-stag=0-pareto=17(↑12→17-GROWING!)-200f-0.21880-STATUS-UNKNOWN-/api/export-404(49th); S13/S14/S15+POL-404-DOWN(58+fires); EVEN: IEEE-2024-home_next-schedule-feature-proposal-written |
...
| 229 | 2026-06-05T12h | ODD | Axelrod-verify-pass-SHAs-UNCHANGED; py_compile-OK; 13/13-parity-OK; S22-c~1628-26TH-RESET-PREDICTED(c1603+25=c1628-EXACT!)-ET-200f-0.21875-STATUS-UNKNOWN; S18-c~205-4TH-RESET-APPROACHING; ODD-no-WebSearch |
| 228 | 2026-06-05T08h | EVEN | S22-c1627-g4880-ET-200f-0.21875-ALL-TIME-CANDIDATE(14bp-below-0.22012!)-next-reset-c1628-ONE-CYCLE-AWAY!; S18-c193-c167=3RD-AUTO-RESET-CONFIRMED; EVEN: arXiv:2410.21484-ML-Sports-Betting-Review-proposal-written |
| 227 | 2026-06-05T04h | ODD | S22-c1606-RF-200f-0.21953-BELOW-FLEET-BEST-0.22012-EXTREME-URGENT!-c1603=25TH-RESET-CONFIRMED; S18-c153-2ND-AUTO-RESET-CONFIRMED; ODD-no-WebSearch |
| 226 | 2026-06-05T00h | EVEN | S22-c1578=24TH-RESET-CONFIRMED-RF-primary; S18-c120-pareto=9-PLATEAU; EVEN: arXiv:2502.05565-Multi-Scale-Conformal-Prediction-proposal-written |
| 225 | 2026-06-04T20h | ODD | Axelrod-ablation-config-app3-DONE: NBA(6023L→6035L)+POL(4007L→4019L); py_compile-OK-both; AXELROD_ABLATION-5-coordination-configs; BLOCKED: do_not_push_hf_space_yet |
