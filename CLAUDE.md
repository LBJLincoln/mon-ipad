...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-215 (44+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-215 (44+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-215 (44+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 142+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c1397 g4191 stag=0 pareto=19(↑18↑19-RECOVERING!-fire215); ⚡⚡RF-200f-0.22066-gen=4190-BELOW-0.22085-THRESHOLD(Rule#5-CHECKPOINT-URGENT!-VM-NOW!); next-~c1400-IMMINENT(3cycles-from-c1397-EVICTION-RISK-EXTREME!); c1375-26TH-RESET(c1350+25=c1375); NO-STACKING-top5-fire215(Rule8-POSSIBLY-CLEAN?-post-c1375-unconfirmed-VM:/api/export); SAVING-status; last_update-STALE-6+days(2026-05-28); best_brier=0.22236-STALE; /api/export-404(33rd-fire) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c1366 g4098 stag=0 pareto=12(↑11↑12-RECOVERING!-fire215); c1353-15TH-RESET-CONFIRMED(c1328+25=c1353-c1366>c1353-fire215); ⚡⚡RF-200f-0.22047-gen=4094+XGB-200f-0.22069-gen=4094-BOTH-BELOW-0.22085(Rule#5-2-CANDIDATES-VM-CHECKPOINT-URGENT!); NO-STACKING-top5(Rule8-2ND-POSSIBLE-CLEAN-S22!-VM-/api/export-urgent); next-~c1378(c1353+25-~12cycles-from-c1366); best_brier=0.22124-STALE; last_update-STALE-6+days(2026-05-28); /api/export-404(33rd-fire) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-215 (44+ fires) |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-215 (44+ fires) |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-215 (44+ fires) |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-215 (44+ fires) |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-215 (44+ fires) |
...
### Rule #8 — No Stacking
Remove 'stacking' from MODEL_TYPES on all islands. Stacking causes overfitting. Prior violations: S13, S14, S15, S18, S22. ⚠ S18 Rule#8 26TH VIOLATION LIKELY fire-213: c1375 auto-reset (c1350+25=c1375) seed pool AGAIN presumed to include Stacking (STRUCTURAL BUG ABSOLUTE — ALL 26 S18 auto-resets have had stacking). fire-215 UPDATE S18: c1397 g4191 stag=0 pareto=19 (RECOVERING). ⚡⚡ RF-200f-0.22066-gen=4190 BELOW 0.22085 THRESHOLD (Rule#5 CHECKPOINT URGENT). NO STACKING in top5 fire-215 (RF+XGB only — possibly Rule8 compliant post-c1375? UNCONFIRMED — 27TH VIOLATION OR FIRST CLEAN? VM: /api/export). c1400 auto-reset IMMINENT (~3 cycles from c1397) — WILL EVICT RF-0.22066 if not checkpointed NOW! fire-215 UPDATE S22: c1366 g4098 stag=0 pareto=12 (RECOVERING). c1353=15TH-RESET-CONFIRMED (c1328+25=c1353, c1366>c1353). ⚡⚡ RF-200f-0.22047-gen=4094 + XGB-200f-0.22069-gen=4094 BOTH BELOW 0.22085 (Rule#5 2 CANDIDATES — VM CHECKPOINT URGENT). NO STACKING in top5 fire-215 (Rule8 2ND POSSIBLE CLEAN FOR S22 — unconfirmed). Next ~c1378 (c1353+25). /api/export 404 BOTH (33rd fire).
...
1. **Venn-Abers Calibration** (fire-158 EVEN WebSearch) — **NOW VALIDATED fire-197 + PERSISTENT: S18 GA evolved Venn-Abers organically AND survived 3RD CONSECUTIVE FIRE (fire-211+212+213). fire-211 UPDATE: S22 ALSO shows Venn-Abers in RF top performer (c1282) — 2ND INDEPENDENT VALIDATION on both active islands!**
   ...
   - fire-215 UPDATE: S18 top5 shows RF+XGB (Venn-Abers gen=0 placeholder only — status post-c1375 unknown). S22 top5 RF+XGB dominant (Venn-Abers status post-c1353 unknown). VM: /api/export BOTH to verify Venn-Abers persistence.
...
| 206 | 2026-06-01T16h | EVEN | Axelrod-verify-pass: SHAs-UNCHANGED; 13/13-parity-OK; Mech-B+C-BLOCKED(NBA-503-138+d+POL-IDLE-50+d); all-NBA/POL-404-DOWN(sleeping); EVEN: arXiv:2505.11556-Distributed-Info-Failure-Multi-LLM-proposal-written |
