...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-236 (62+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed — SLEEPING fire-236 (62+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-236 (62+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 144+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | EVOLVING | 0.22326 | **fire-236**: c=336 g=1006 stag=0 pareto=12. 9TH-AUTO-RESET-c317-CONFIRMED(c292+25=c317-EXACT). Rule8-CLEAN: top_model_types=[RF,CatBoost,XGB,LGB,LR]-NO-STACKING confirmed from /api/status. best_brier=0.22326 plateau. /api/export-404(13th). Next reset ~c342(c317+25). VM: curl /api/export S18. |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | **fire-236**: c=1738 g=5214 stag=0 pareto=6(↓8→6). 30TH-RESET-c1728-CONFIRMED(c1703+25=c1728-EXACT). gen5210-200f-0.21952-BELOW-FLEET-BEST-0.22012(6bp!)-EXTREME-URGENT! best_brier=0.22124-field-lag. /api/export-404(53rd-CRITICAL). Next reset ~c1753(c1728+25). ISLAND XGB/LGB/CAT-ONLY GENE POOL. VM: curl /api/export S22 IMMEDIATELY — checkpoint gen5210-0.21952! |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-236 (63+ fires) |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-236 (63+ fires) |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-236 (63+ fires) |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-236 (63+ fires) |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-236 (63+ fires) |
