...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-242 (68+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed — SLEEPING fire-242 (68+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-242 (68+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 144+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | EVOLVING | 0.22326 | **fire-242**: c=473 g=1419 stag=0 pareto=16(↑10→16-GROWING!). 14TH-AUTO-RESET-c442-CONFIRMED(c417+25=c442-EXACT)+15TH-AUTO-RESET-c467-CONFIRMED(c442+25=c467-EXACT). TOP-0.22061 fate UNKNOWN (possible eviction at c442/c467). best_brier=0.22326 field-lag. /api/export-404(18th). Next reset ~c492(c467+25). Rule8-CLEAN presumed (pareto=16 growth). VM: curl /api/export S18. |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | **fire-242**: c=1829 g=5485 stag=0 pareto=15. 34TH-AUTO-RESET-c1828-CONFIRMED(c1803+25=c1828-EXACT). **PARETO-TOP-0.21908-EXTREME-URGENT!(10bp-below-fleet-best-0.22012!)** + 0.21936/0.21960/0.21989 gen5483 ALL-BELOW-0.22012. best_brier=0.22124 field-lag(Rule#4). /api/export-404(59th-CRITICAL). Next reset ~c1853(c1828+25). VM: curl /api/export S22 IMMEDIATELY — confirm model types + CHECKPOINT! |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-242 (68+ fires) |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-242 (68+ fires) |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-242 (68+ fires) |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-242 (68+ fires) |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-242 (68+ fires) |
...
fire-240 UPDATE S18: c=430 g=1289 stag=12(↑0→12-BUILDING,div-threshold=15). 13TH-AUTO-RESET-c417-CONFIRMED(c392+25=c417-EXACT). pareto=10(→15→10-post-reset-mild-shrink). TOP-5-PERFORMERS range: 0.22061~0.22355 — **0.22061 BELOW-0.22085-CHECKPOINT-URGENT!** best_brier=0.22326(field-lag-Rule#4). /api/export-404(16th). Next reset ~c442(c417+25). VM: curl /api/export S18 IMMEDIATELY — 0.22061 candidate = CHECKPOINT URGENT! If stag reaches 15 → DIVERSIFY (Rule#6: checkpoint first).
fire-241 UPDATE S18: Status carry-forward from fire-240. Verify-pass-fire(ODD). TOP-0.22061-CHECKPOINT-URGENT! Next reset ~c442. VM: curl /api/export S18 IMMEDIATELY.
fire-242 UPDATE S18: c=473 g=1419 stag=0 pareto=16(↑10→16-GROWING!). 14TH-AUTO-RESET-c442-CONFIRMED(c417+25=c442-EXACT)+15TH-AUTO-RESET-c467-CONFIRMED(c442+25=c467-EXACT). pareto=16 GROWING post-c467 = CLEAN-RESET pattern confirmed (matches c67/c142/c317). TOP-0.22061 fate UNKNOWN (may be evicted at c442/c467 resets). best_brier=0.22326 plateau. /api/export-404(18th). Next reset ~c492(c467+25). VM: curl /api/export S18 — confirm TOP-0.22061 fate.
...
fire-240 UPDATE S22: c=1804 g=5412 stag=0 pareto=13. 33RD-AUTO-RESET-c1803-CONFIRMED(c1778+25=c1803-EXACT). ET-200f-0.21875 ALIVE in pareto (Sharpe=9.95, 200 features, Extra Trees) — **pre-c1678 survivor still non-dominated 126+ cycles post gene-pool-change = remarkable persistence**. EXTREME URGENT (14bp below fleet best 0.22012). best_brier=0.22124(field-lag-Rule#4). /api/export-404(57th-CRITICAL). Next reset ~c1828(c1803+25). VM: curl /api/export S22 IMMEDIATELY — confirm ET-0.21875 Brier + CHECKPOINT if Brier<0.22012.
fire-241 UPDATE S22: Status carry-forward from fire-240. Verify-pass-fire(ODD). ET-200f-0.21875 fate UNKNOWN. /api/export-404(58th-CRITICAL). Next reset ~c1828. VM: curl /api/export S22 IMMEDIATELY.
fire-242 UPDATE S22: c=1829 g=5485 stag=0 pareto=15. 34TH-AUTO-RESET-c1828-CONFIRMED(c1803+25=c1828-EXACT). **PARETO TOP: 0.21908 gen5480 (10bp below fleet best 0.22012!) + 0.21936/0.21960/0.21989 gen5483 ALL BELOW FLEET BEST — EXTREME URGENT!** XGB/LGB/CAT gene pool candidates (GENE POOL BREAKTHROUGH?) or pre-c1678 ET survivor (130+ cycles non-dominated)? best_brier=0.22124(field-lag-Rule#4). /api/export-404(59th-CRITICAL). Next reset ~c1853(c1828+25). VM: curl /api/export S22 IMMEDIATELY — confirm model type of 0.21908 + CHECKPOINT if Brier<0.22012.
...
- Parity: SHAs NBA 85e7682e1d(6035L)/POL 6983c86517(4019L) verified fire-243(ODD); fire-225 added +12L each for ablation flags (NBA:6023L→6035L, POL:4007L→4019L). 13/13 parity maintained. KL-div fields OK.
...
35. **Multicalibration Gradient Boosting Convergence** (fire-240 EVEN WebSearch)
    ...
    - Key finding: Multicalibration GB produces approximately multicalibrated predictors with O(1/√T) convergence rate; deployed at web scale. Ensures calibration holds across many overlapping subgroups simultaneously — stronger guarantee than isotonic/Venn-Abers.
    - Application 1: Replace post-hoc isotonic calibration with multicalibration GB on pareto models (two-stage with Venn-Abers)
    ...
    - Application 3: NBA subgroup calibration audit on S15 RF-75f (fleet best) — identify worst-calibrated subgroups
    ...
    - Expected improvement: 0.001-0.003 Brier (subgroup corrections compound via Jensen's inequality)
...
36. **Distributional Regression Trees for Calibrated Non-Parametric Probabilistic Forecasts** (fire-242 EVEN WebSearch)
    ...
    - Key finding: DRT outputs full predictive distributions natively with O(n log n) efficiency and distribution-free coverage guarantee. Outperforms standard QRF on probabilistic calibration benchmarks. No labeled calibration set needed. Direct distributional generalization of RF/ET — natural successor to S22 ET-0.21908 candidate.
    ...
    - Application 3: Add `distribution_calibration_error` as new Pareto objective (ECE-equivalent for full predictive distribution)
    - Application 4: Brier-loss native training — DRT with proper scoring rule split criterion (replaces post-hoc calibration)
    - Application 5: Port to political_engine.py for calibrated state-level predictions (rare event coverage)
    - Library: quantile-forest (ExtraTreesQuantileRegressor)
    - Expected improvement: 0.001-0.003 Brier (calibration-native vs post-hoc)
...
|------|------|--------|------------|
| 243 | 2026-06-07T20h | ODD | Axelrod-verify-pass-SHAs-NBA-85e7682e1d(6035L)/POL-6983c86517(4019L)-UNCHANGED; py_compile-OK-both; 13/13-parity-OK; KL-div-OK; Mech-A/B/C+AblationFlags-ALL-CODE-DONE-BLOCKED(do_not_push_hf_space_yet); S13/S14/S15+POL-404-DOWN(69+fires); ODD-no-WebSearch |
| 242 | 2026-06-07T16h | EVEN | S18-c473-g1419-stag=0-pareto=16(↑10→16-GROWING)-14TH+15TH-RESET-c442+c467-CONFIRMED-TOP-0.22061-FATE-UNKNOWN; S22-c1829-g5485-34TH-RESET-c1828-CONFIRMED-PARETO-TOP-0.21908-EXTREME-URGENT!(10bp-below-fleet-best!)+0.21936/0.21960/0.21989-ALL-BELOW-0.22012-/api/export-404(59th-CRITICAL); S13/S14/S15+POL-404-DOWN(68+fires); EVEN: arXiv:2502.05157-Distributional-Regression-Trees-Calibrated-Probabilistic-Forecasts-proposal-written |
| 241 | 2026-06-07T12h | ODD | Axelrod-verify-pass-SHAs-NBA-85e7682e1d(6035L)/POL-6983c86517(4019L)-UNCHANGED; py_compile-OK-both; 13/13-parity-OK; KL-div-OK; Mech-A/B/C+AblationFlags-BLOCKED(do_not_push_hf_space_yet); S13/S14/S15+POL-404-DOWN(67+fires); ODD-no-WebSearch |
| 240 | 2026-06-07T08h | EVEN | S18-c430-g1289-stag=12(BUILDING)-pareto=10-13TH-RESET-c417-CONFIRMED-TOP-0.22061-CHECKPOINT-URGENT!; S22-c1804-g5412-33RD-RESET-c1803-CONFIRMED-ET-200f-0.21875-ALIVE-EXTREME-URGENT!-/api/export-404(57th); S13/S14/S15+POL-404-DOWN(66+fires); EVEN: arXiv:2602.06773-Multicalibration-GB-O(1/sqrtT)-proposal-written |
...
| 234 | 2026-06-06T08h | EVEN | S18-c300-g898-stag=0-pareto=12-8TH-RESET-PASSED-~c292; S22-c1706-g5117-28TH+29TH-RESET-CLEAN-200f-0.21880-EVICTED-cycle-stag=2-/api/export-404(51st); S13/S14/S15+POL-404-DOWN(60+fires); EVEN: MDPI-2026-NBA+WNBA-multitask-transfer-proposal-written |
