...
HF EVOLUTION ISLANDS — 11 SURVIVORS (6 NBA + 5 POL) after 2026-04-17 cull
    ...
    ├── S13 Nomos42/nba-evo-4:        xgboost_brier       gen=2154  brier=0.22216  stagnation=0  ✓ cycle=719; stag=0 pareto=13(↓17→13); ROI=30.1% Sharpe=7.58 47f; vm-remove-stacking-s13 URGENT (2026-05-21T16h)
    ├── S14 Nomos42/nba-evo-5:        extra_trees         gen=591   brier=0.22793  stagnation=19 ⚠ DIVERSIFY-VM-NEEDED cycle=198; pareto=10 ET-200f-pareto_best=0.22171-STRENGTHENING; vm-checkpoint-s14-et PENDING (2026-05-21T16h)
    ├── S15 Nomos42/nba-evo-6:        lightgbm/rf         gen=5770  best=0.22012   stagnation=0  ✓ cycle=1924; ★ FLEET BEST 0.22012; pareto=14 LightGBM-56f-in-pareto(fire142-1st) pareto_best=0.22023-VM-CHECKPOINT-URGENT; vm-checkpoint-s15-et-0.21888 URGENT (2026-05-21T16h)
    ├── S17 LBJLincoln26/nba-evo-s17: ---                 gen=---   brier=---      🔴 503 DOWN 102+ days — VM RESTART REQUIRED (2026-05-21T16h)
    ├── S18 TESTforge42/nba-evo-s18:  random_forest       gen=619   brier=0.22236  stagnation=0  ✓ cycle=207; pareto=13(↑9→13-PARETO-RECOVERING); brier-stuck-396-gens(gen223→gen619); vm-checkpoint-s18-rf URGENT (2026-05-21T16h)
    └── S22 TESTforge42/nba-evo-s22:  random_forest       gen=283   brier=0.22124  stagnation=16 ⚠ DIVERSIFY-VM-NEEDED cycle=95; pareto=7(↓12→7); RF-48f; vm-checkpoint-s22 PRIORITY=1 (2026-05-21T16h)
    Political Survivors (5, CPU tree-only):
    ├── P1 Nomos42/political-alpha:      xgboost_brier       gen=9451   brier=0.24987 stagnation=0  ✓ POL-FLEET-BEST; cycle=3151; pareto=7(↓14→7) pareto_best=0.24927-NEW-P1-PARETO-BEST vm-checkpoint-p1-ADDED (2026-05-21T16h)
    ├── P2 Nomos42/political-alpha-2:    xgboost_brier       gen=60010  brier=0.25003 stagnation=0  ✓ cycle=20004; pareto=13(↑6→13-STRONG-GROWTH) gen-milestone-60k (2026-05-21T16h)
    ├── P4 LBJLincoln/political-alpha-4: extra_trees         gen=3341   brier=0.25337 stagnation=0  ✓ cycle=1114; pareto=10(↑8→10); pareto_best=0.25337(XGB-0.24982-POSSIBLY-EVICTED); vm-investigate-p4-xgb-evicted ADDED (2026-05-21T16h)
    ├── P5 LBJLincoln/political-alpha-5: xgboost_brier       gen=80609  brier=0.24993 stagnation=0  ✓ cycle=26870; pareto=5(↑4→5) LightGBM-102f-0.249-Sharpe=1.01-stable (2026-05-21T16h)
    └── P7 LBJLincoln/political-alpha-7: lightgbm            gen=17940  brier=0.25004 stagnation=0  ✓ cycle=5980; pareto=12(↑7→12-STRONG-RECOVERY); LightGBM-112f-0.24931-CONFIRMED-stable; vm-checkpoint-p7-lgbm EXTREME-URGENT priority=1 (2026-05-21T16h)
```
