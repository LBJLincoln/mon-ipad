...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-248 (74+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed — SLEEPING fire-248 (74+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-248 (74+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 144+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | EVOLVING | 0.22326 | **fire-248**: c=674 g=2021 stag=0 pareto=12(↓15→12). 22ND-RESET-c667-CONFIRMED(c642+25=c667-EXACT). **RULE8-VIOLATION: stacking-37f-0.24738 rank-1 in pareto!** ET-200f-0.22029+ET-200f-0.22069 BOTH BELOW 0.22085 — CHECKPOINT-URGENT! /api/export-404(25th-CRITICAL). Next reset ~c692(c667+25). VM: REMOVE stacking from MODEL_TYPES before ~c692. |
| S22 | TESTforge42/nba-evo-s22 | EVOLVING | 0.22027 | **fire-248**: c=56 g=166 stag=0 pareto=15(↑12→15-GROWING). 2ND-RESET-c53-CONFIRMED(c28+25=c53-EXACT). ET-0.2193 CONFIRMED EVICTED (3RD CONSECUTIVE RUN LOSS). **RULE8-VIOLATION: stacking-47f-0.24738 rank-1 in pareto!** ET-200f-0.22027 BELOW 0.22085 — CHECKPOINT-URGENT! /api/export-404(4th-new-run). Next reset ~c78(c53+25). VM: REMOVE stacking before ~c78. |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-248 (74+ fires) |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-248 (74+ fires) |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-248 (74+ fires) |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-248 (74+ fires) |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-248 (74+ fires) |
...
- Mech B: CODE-DONE (fire-122+, verified fire-247) — sacrificial role reallocation (BLOCKED: HF push gate)
- Mech C: CODE-DONE (fire-122+, verified fire-247) — post-mortem log + dataset (BLOCKED: HF push gate)
...
- Parity: SHAs NBA 85e7682e1d(6035L)/POL 6983c86517(4019L) verified fire-247(ODD); fire-225 added +12L each for ablation flags (NBA:6023L→6035L, POL:4007L→4019L). 25/25 parity maintained. KL-div fields OK.
...
|------|------|--------|------------|
| 248 | 2026-06-08T16h | EVEN | S18-c674-g2021-stag=0-pareto=12(↓15→12)-22ND-RESET-c667-CONFIRMED(c642+25=c667-EXACT)-RULE8-VIOLATION:stacking-37f-0.24738-rank1-ET-200f-0.22029+0.22069-BOTH-BELOW-0.22085-/api/export-404(25th-CRITICAL)-next-reset~c692; S22-c56-g166-stag=0-pareto=15(↑12→15-GROWING)-2ND-RESET-c53-CONFIRMED-ET-0.2193-EVICTED(3RD-RUN-LOSS)-RULE8-VIOLATION:stacking-47f-0.24738-rank1-ET-200f-0.22027-BELOW-0.22085-/api/export-404(4th-CRITICAL)-next-reset~c78; S13/S14/S15+POL-404-DOWN(74+fires); EVEN: WebSearch-no-new-arXiv-RULE8-VIOLATION-both-islands |
| 247 | 2026-06-08T12h | ODD | Axelrod-verify-pass-SHAs-NBA-85e7682e1d(6035L)/POL-6983c86517(4019L)-UNCHANGED; py_compile-OK-both; 25/25-parity-OK; KL-div-OK(compute_consensus_distance-present-both); Mech-A/B/C+AblationFlags-ALL-CODE-DONE-BLOCKED(do_not_push_hf_space_yet); S13/S14/S15+POL-404-DOWN(73+fires); S18-carry-forward-RF-200f-0.21949-EXTREME-URGENT-next-reset~c617; S22-carry-forward-ET-0.2193-EXTREME-URGENT-first-reset~c25-IMMINENT/OCCURRING; ODD-no-WebSearch |
| 246 | 2026-06-08T08h | EVEN | S18-c600-g1798-stag=0-pareto=19(GROWING!)-19TH+20TH-RESET-c567+c592-CONFIRMED-RF-200f-0.21949-EXTREME-URGENT!(6bp-below-fleet-best-0.22012!)-last_improvement=c593; S22-c22-g66-ET-0.2193-EXTREME-URGENT!(8bp-below-fleet-best!)-first-reset~c25(IMMINENT!); S13/S14/S15+POL-404-DOWN(72+fires); EVEN: arXiv:2603.26611-TabFM-Conditional-Density-6-metrics-proposal-written |
| 245 | 2026-06-08T04h | ODD | Axelrod-verify-pass-SHAs-NBA-85e7682e1d(6035L)/POL-6983c86517(4019L)-UNCHANGED; py_compile-OK-both; 25/25-parity-OK; KL-div-OK(compute_consensus_distance-present-both); Mech-A/B/C+AblationFlags-ALL-CODE-DONE-BLOCKED(do_not_push_hf_space_yet); S13/S14/S15+POL-404-DOWN(71+fires); ODD-no-WebSearch |
...
| 240 | 2026-06-07T08h | EVEN | S18-c430-g1289-stag=12(BUILDING)-pareto=10-13TH-RESET-c417-CONFIRMED-TOP-0.22061-CHECKPOINT-URGENT!; S22-c1804-g5412-33RD-RESET-c1803-ET-200f-0.21875-ALIVE-EXTREME-URGENT!-/api/export-404(57th); S13/S14/S15+POL-404-DOWN(66+fires); EVEN: arXiv:2602.06773-Multicalibration-GB-O(1/sqrtT)-proposal-written |
| 239 | 2026-06-07T04h | ODD | S18-c395-stag=0-pareto=15(STABLE)-11TH+12TH-RESET-c367+c392-CONFIRMED-Rule8-CLEAN-presumed; S22-c1778-32ND-RESET-200f-Sharpe=11.42-ALIVE-EXTREME-URGENT!-/api/export-404(56th); S13/S14/S15+POL-404-DOWN(65+fires); ODD: Axelrod-verify-pass-SHAs-UNCHANGED-13/13-parity-OK |
