...
HF EVOLUTION ISLANDS — 11 SURVIVORS (6 NBA + 5 POL) after 2026-04-17 cull
    ...
    ├── S13 Nomos42/nba-evo-4:        xgboost_brier       gen=1748  brier=0.22216  stagnation=0  ✓ cycle=583; stag CLEARED(was-18-fire126); top pareto: xgb-200f-0.22244(g1744), LightGBM-200f-0.22432(g1619) (front=7); stacking rank-1 pareto (Rule#8 violation, vm-remove-stacking-s13 pending) (2026-05-18T20h)
    ├── S14 Nomos42/nba-evo-5:        extra_trees         gen=116   brier=0.22793  stagnation=0  ✓ cycle=39; ⚡xgboost_brier-200f-0.22006-PARETO-1ST-DETECT(gen=113,BELOW-FLEET-BEST-by-0.00006!); ET-200f-0.2215 gen=113 in pareto; CatBoost-0.21888-fire126 DROPPED(superseded); vm-checkpoint-s14-xgb-0.22006-fire127 ADDED priority=2 (2026-05-18T20h)
    ├── S15 Nomos42/nba-evo-6:        random_forest       gen=5015  best=0.22012   stagnation=0  ✓ cycle=1672; ★ FLEET BEST 0.22012; stag=0 stable; ⚡ET-200f-0.21908-PARETO-1ST-DETECT(gen=5012,below-fleet-best!); pareto front=15; VM-CHECKPOINT-EXTREME-URGENT (2026-05-18T20h)
    ├── S17 LBJLincoln26/nba-evo-s17: ---                 gen=---   brier=---      🔴 503 DOWN 96+ days — VM RESTART REQUIRED (2026-05-18T20h)
    ├── S18 TESTforge42/nba-evo-s18:  xgboost             gen=14    brier=0.24576  stagnation=0  ⚠⚠⚠ FACTORY-REBOOT-DETECTED cycle=5(was-c2842-g8526)! ALL-CHECKPOINTS-LOST; ⚡CatBoost-200f-0.21956-1ST-DETECT(gen=11,EXTRAORDINARY); ET-200f-0.22041 gen=9; vm-checkpoint-s18-catboost-0.21956-fire127 ADDED (2026-05-18T20h)
    └── S22 TESTforge42/nba-evo-s22:  random_forest       gen=31    brier=0.22124  stagnation=0  ✓ cycle=11; ⚡RF-200f-0.21987-PARETO-1ST-DETECT(gen=29,below-fleet-best!); LightGBM-200f-0.22267 gen=28; CatBoost-0.21818-ALLTIME-LOST-fire126; vm-checkpoint-s22-rf-0.21987-fire127 ADDED priority=1 (2026-05-18T20h)
    Political Survivors (5, CPU tree-only):
    ├── P1 Nomos42/political-alpha:      xgboost_brier       gen=2710   brier=0.24987 stagnation=0  ✓ RECOVERED! cycle=904; was-403-DOWN-fire126; pareto=8 top: xgb-74f-0.25319, lgbm-83f-0.25162; stag=0 ok (2026-05-18T20h)
    ├── P2 Nomos42/political-alpha-2:    xgboost_brier       gen=57457  brier=0.25003 stagnation=0  ✓ cycle=19153; LightGBM-123f-Brier=0.249 in-pop; stag=0 ok (2026-05-18T20h)
    ├── P4 LBJLincoln/political-alpha-4: xgboost_brier       gen=90469  brier=0.24992 stagnation=0  ✓ cycle=30157; ★ POL FLEET BEST alltime=0.24904; LightGBM-108f Brier=0.2490 Sharpe=1.00; stable (2026-05-18T20h)
    ├── P5 LBJLincoln/political-alpha-5: xgboost_brier       gen=78094  brier=0.24993 stagnation=0  ✓ cycle=26032; stag=0 ok; pareto=4; ⚠ feature_candidates=272 (vs 3377 NBA — investigate data issue) (2026-05-18T20h)
    └── P7 LBJLincoln/political-alpha-7: xgboost_brier       gen=10411  brier=0.25004 stagnation=0  ✓ cycle=3471; pareto=5; stag=0 ok; ⚡LightGBM-112f-0.24931-BETTER-THAN-0.24937; logistic_regression-102f in pareto (1st LR in POL pareto!); vm-checkpoint-p7-lgbm-0.24931-fire127 ADDED priority=2 (2026-05-18T20h)
```
