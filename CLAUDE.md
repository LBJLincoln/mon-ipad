...
> Architecture v21 — "The Trading Floor Crew" (14 agents × 9 depts × 4 tracks) + TF v3 (17 LLM agents) + 21 Evolution Islands | Updated: 2026-06-09T04h
...
| S15 | Nomos42/nba-evo-6 | EVOLVING (WOKE fire-251) | 0.22012★ (checkpointed) | FLEET BEST RF-75f checkpointed nba-oracle-model. WOKE fire-251: c=890 g=2670 best_brier=0.22342 stag=0 RF-62f fresh run. |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 144+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | EVOLVING | 0.22326 | **fire-251**: c=696 g=2086 stag=0(post-23rd-reset-c692). 23RD-RESET-c692-CONFIRMED. **RULE8-VIOLATION: stacking x2 in top5** (pos4-5: stacking-37f-0.24738, stacking-200f-0.249). XGB-200f-0.22343 best-in-pareto. No ET below 0.22085 in current pareto. Next reset ~c717(c692+25). VM: REMOVE stacking from MODEL_TYPES IMMEDIATELY before ~c717. |
| S22 | TESTforge42/nba-evo-s22 | EVOLVING | 0.21983 | **fire-251**: c=65 g=194 stag=0 pareto=9(↓18→9). **ET-0.21983 CONFIRMED LOST — 4th consecutive S22 run ET eviction!** PATTERN: stacking contamination in reset reseed pool. XGB-200f-0.22343 best-in-pareto. **RULE8-VIOLATION: stacking x2 in top5** (pos4-5: stacking-47f-0.24738, stacking-200f-0.249). Next reset ~c78(c53+25, 13 cycles from c65). VM: (1) REMOVE stacking IMMEDIATELY before ~c78, (2) Monitor for new ET candidates below 0.22085. |
