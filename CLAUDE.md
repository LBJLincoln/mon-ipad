...
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | pareto=10(↓12→10 3rd-consecutive-shrink fire-165) stag=0 c582 g1745; CatBoost-0.22197-EVICTION-RISK |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | stag=0 c465 g1395; pareto=20(↑16→20-GROWING! fire-165); hard-resets=3(c403+c428+c453); ⚠RULE8-VIOLATION stacking-reintroduced-hard-reset-c453; cycle-stag=~12 |
...
### Rule #8 — No Stacking
Remove 'stacking' from MODEL_TYPES on all islands. Stacking causes overfitting. Violations: S13, S14, S15, S22. ⚠ S22 hard-reset at c453 REINTRODUCED stacking in reseed pool — VM must fix config permanently before ~c478.
...
- Parity: SHAs NBA 19f4acf49d49(5993L)/POL 3496362c60(3977L) UNCHANGED vs fire-161 (verified fire-163)
...
|------|------|--------|------------|
| 165 | 2026-05-25T16h | ODD | S13/S14/S15-404-DOWN(sleeping); S18-c582-g1745-stag=0-pareto=10(↓12→10-3rd-consecutive-shrink-CATBOOST-0.22197-EVICTION-RISK); S22-c465-g1395-stag=0-pareto=20(↑16→20-GROWING!)-RULE8-VIOLATION(stacking-reintroduced-hard-reset-c453-VM-FIX-URGENT-before-~c478); all-POL-404-DOWN; ODD-no-WebSearch |
