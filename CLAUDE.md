...
> Architecture v21 — "The Trading Floor Crew" (14 agents × 9 depts × 4 tracks) + TF v3 (17 LLM agents) + 21 Evolution Islands | Updated: 2026-06-06T00h
...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-232 (58+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed — SLEEPING fire-232 (58+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-232 (58+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 144+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | EVOLVING | 0.22326 | **fire-232**: c=268 g=803 stag=0 pareto=12(↑5→12-RECOVERY!). c267=7TH-AUTO-RESET-CONFIRMED(c242+25=c267-EXACT). Rule8-LIKELY-CLEAN(pareto-recovery 5→12 matches clean-reset pattern c67/c142/c167). best_brier=0.22326 plateau. /api/export-404(11th). Next reset ~c292(c267+25). VM: curl /api/export S18 to confirm Rule8 compliance at c267. |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | **fire-232**: c=1689 g=5065 stag=0 pareto=17(↑12→17-GROWING!). c~1680=27TH-RESET-POSSIBLE(c1655+25=c1680). 200f-0.21880 gen=4960 STATUS-UNKNOWN(possibly-evicted-at-c~1680). /api/export-404(49th-CRITICAL-approaching-50th!). Next reset ~c1705. VM: curl /api/export S22 IMMEDIATELY — candidate fate unknown! EXTREME URGENT! |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-232 (58+ fires) |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-232 (58+ fires) |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-232 (58+ fires) |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-232 (58+ fires) |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-232 (58+ fires) |
