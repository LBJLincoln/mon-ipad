...
HF EVOLUTION ISLANDS — 11 SURVIVORS (6 NBA + 5 POL) after 2026-04-17 cull
    ...
    ├── S13 Nomos42/nba-evo-4:        xgboost_brier       gen=1834  brier=0.22216  stagnation=0  ✓ cycle=612; hard-reset-c604(stag=25); LR+stacking in pool (Rule#8 violation pending vm-remove-stacking-s13); pareto=13 (2026-05-19T08h)
    ├── S14 Nomos42/nba-evo-5:        extra_trees         gen=227   brier=0.22793  stagnation=0  ✓ cycle=76; hard-reset-c53; ET-dominant; pareto=13; xgb-0.22006-fire127-1st-detect MONITORING fire-131 (2026-05-19T08h)
    ├── S15 Nomos42/nba-evo-6:        random_forest       gen=5221  best=0.22012   stagnation=0  ✓ cycle=1741; ★ FLEET BEST 0.22012; hard-reset-c1726-CONFIRMED(predicted-fire129); pareto=12; ET-0.21908-fire127-1st-detect status-uncertain-post-reset (2026-05-19T08h)
    ├── S17 LBJLincoln26/nba-evo-s17: ---                 gen=---   brier=---      🔴 503 DOWN 100+ days — VM RESTART REQUIRED (2026-05-19T08h)
    ├── S18 TESTforge42/nba-evo-s18:  lightgbm            gen=214   brier=0.24723  stagnation=0  ⚠ recovering-factory-reboot(was-c2842); cycle=72; pareto=10; vm-checkpoint-s18-0.21885 STALE(checkpoint-lost-to-reboot-CLOSED) (2026-05-19T08h)
    └── S22 TESTforge42/nba-evo-s22:  random_forest       gen=80    brier=0.22124  stagnation=0  ✓ cycle=27; recovering-factory-reboot; RF-48f; pareto=9; REMARKABLE-0.22124-at-gen=80; vm-checkpoint-s22 PRIORITY=1 (2026-05-19T08h)
    Political Survivors (5, CPU tree-only):
    ├── P1 Nomos42/political-alpha:      xgboost_brier       gen=3720   brier=0.24987 stagnation=0  ✓ POL-LIVE-FLEET-BEST(P4-rebooted); cycle=1240; pareto=12; hard-resets-c1182+c1222; feature_candidates=272 (2026-05-19T08h)
    ├── P2 Nomos42/political-alpha-2:    xgboost_brier       gen=58038  brier=0.25003 stagnation=0  ✓ cycle=19346; LightGBM-123f-0.249 in-pareto; pareto=4; stag=0 ok (2026-05-19T08h)
    ├── P4 LBJLincoln/political-alpha-4: extra_trees         gen=327    brier=0.25337 stagnation=0  ⚠⚠⚠ FACTORY-REBOOT-DETECTED-fire130(c30157→c109)! POL-FLEET-BEST-0.2490-LOST(historical-checkpoint-preserved); ⚡XGBoost-0.24998-PARETO-1ST-DETECT(gen=327); vm-investigate-p4-factory-reboot ADDED (2026-05-19T08h)
    ├── P5 LBJLincoln/political-alpha-5: xgboost_brier       gen=78706  brier=0.24993 stagnation=0  ✓ cycle=26236; pareto=6; stag=0 ok (2026-05-19T08h)
    └── P7 LBJLincoln/political-alpha-7: xgboost_brier       gen=11689  brier=0.25004 stagnation=0  ✓ cycle=3897; pareto=4; LightGBM-112f-0.24931 CONFIRMED-2nd-fire(fire129); logistic_regression-102f in pareto; vm-checkpoint-p7-lgbm-0.24931 URGENT priority=1 (2026-05-19T08h)
```
