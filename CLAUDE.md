...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-195 (28+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-195 |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-195 (waking FAILED: 403-FORBIDDEN fire-193 was transient; 28+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 133+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c1081 g3242 stag=6 pareto=16(↑9↑16-RECOVERING!); ⚡⚡RF-200f-0.22001-gen3239-BELOW-FLEET-BEST-0.22012★-EXTREME-URGENT-VM-checkpoint-NOW; c1050+c1075-Rule8-12TH+13TH-VIOLATIONS-CONFIRMED(stacking-BOTH-API-explicit); c1025-'clean'-NOT-PERMANENT-fix; next-~c1100(stag=6); best_brier-0.22236-STALE(since-2026-05-25); /api/export-404(WebFetch-18-fire-confirmed) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c1044 g3130 stag=0 pareto=20(↑9↑20-MAJOR-RECOVERY!); c1028-Rule8-3RD-VIOLATION-CONFIRMED(stacking-expanded-diversity-fire195-API); 3-violations-total(c853/c1003/c1028); LightGBM_brier-dominating; stag=0-no-imminent-reset; last_update-STALE(2026-05-25); /api/export-404(WebFetch-18-fire-confirmed) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-195 |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-195 |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-195 |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-195 |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-195 |
...
- Parity: SHAs NBA 19f4acf49d(SHA-verified)/POL 3496362c60(SHA-verified) UNCHANGED (SHA-verified fire-196; TF repos not accessible via MCP fire-196)
- 13/13 parity symbols OK (verified fire-196; C→B→A call-order confirmed NBA:L5056/5065/5073 POL:L3246/3255/3263; compute_consensus_distance(KL) ε-smoothed self-excluded confirmed)
...
2. **Split Conformal Calibration** (fire-168 EVEN WebSearch)
   ...
   - Target: S18 RF/ET pareto (c1081) + S22 RF-48f + S15 RF-75f
...
15. **Strategic Intelligence in LLMs: Evidence from Evolutionary Game Theory** (fire-196 EVEN WebSearch)
    - arXiv:2507.02618 (Payne & Alloui-Cros, King's College London + Oxford, Jul 2025): First evolutionary IPD tournament with frontier LLMs vs canonical strategies (Tit-for-Tat, Grim Trigger)
    - Key finding: LLMs exhibit distinctive "strategic fingerprints" — Gemini models are strategically ruthless (dominant defection + retaliation), OpenAI models more cooperative
    - Varied "shadow of the future" (termination probability 10%/25%/75%) to prevent memorization; persistent mutation regime also tested
    - Relevance to TF Axelrod: (1) Provider-specific cooperation profiles should inform Mech B archetype assignment — Gemini agents are natural candidates for adversarial archetypes; (2) "shadow of the future" mechanism maps directly to our multi-day Axelrod tournament (longer horizon → more cooperation); (3) validates LLM society architecture where agent behavior depends on provider identity as much as prompt
    - Near-term: add `provider_strategic_profile` field to agent metadata; bias Mech B archetype assignment toward defection archetypes for Gemini agents
    - Long-term: run provider-stratified Axelrod tournament analysis (per-provider bankroll trajectory, consensus distance by provider)
...
| 193 | 2026-05-30T10h | ODD | S18-c1064-g3190-stag=0-pareto=9(↑16↑9-SHRINK)-⚡⚡ET-200f-0.22003+RF-200f-0.22009-BOTH-BELOW-FLEET-BEST-0.22012★-EXTREME-URGENT-VM-checkpoint-NOW; c1025-11TH-RESET-POSSIBLE-1ST-CLEAN(no-stacking-fire193-API); /api/export-404(17th-fire); S22-c1014-g3040-stag=0-pareto=9-c1003-Rule8-VIOLATION-CONFIRMED(stacking-fire193-API-REVERTS-fire191); ET-200f-0.22223-top; next-~c1028(14cycles); S13/S14-404-DOWN(27+fires); S15-403-FORBIDDEN(POSSIBLY-WAKING!); all-POL-404-DOWN(27+fires); ODD-no-WebSearch |
| 192 | 2026-05-30T06h | EVEN | S18-c1046-g3136-carry-fire191(next-~c1050-IMMINENT-Rule8-10TH-VIOLATION-stacking-ACTIVE); S22-c1003-g3007-stag=0-pareto=12(STABLE-carry-fire191)-Rule8-COMPLIANT-next-~c1028(25cycles); S13/S14/S15-404-DOWN(26+fires); all-POL-404-DOWN(26+fires); EVEN: arXiv:2406.04062-Online-Learning-Betting-Markets-Profit-vs-Prediction(ICML2024)-profit≠accuracy-KL-div-consensus-validated; Axelrod-verify-pass(SHAs-NBA-19f4acf49d/POL-3496362c60-UNCHANGED); Mech-B+C-BLOCKED(do_not_push_hf_space_yet+NBA-503-130+d+POL-IDLE-40+d) |
| 191 | 2026-05-30T02h | ODD | S18-c1046-g3136-pareto=16(↑11↑16-MAJOR-RECOVERING!)-Rule8-10TH-VIOLATION(c1000+c1025-CONFIRMED-stacking-ACTIVE-LightGBM-dominant)-next-~c1050(4cycles); S22-c1003-g3007-stag=0-pareto=12(STABLE)-c978+c1003-CONFIRMED(Rule8-COMPLIANT-no-stacking)-next-~c1028(25cycles); S13/S14/S15-404-DOWN(25+fires); all-POL-404-DOWN(25+fires); ODD-no-WebSearch; Axelrod-pass(SHAs-UNCHANGED-by-size); NEW: vm-s18-vs-s22-rule8-diagnostic(diff-app.py-for-fix-reference) |
...
| 189 | 2026-05-29T18h | ODD | Axelrod-verify-pass: SHAs-NBA-19f4acf49d(5994L)/POL-3496362c60(3978L)-UNCHANGED-vs-fire-188; 13/13-parity-OK; C→B→A-confirmed(NBA-L5056/5065/5073-POL-L3246/3255/3263); KL-div-ε-smoothed-self-excluded-OK; Mech-B+C-BLOCKED(do_not_push_hf_space_yet+NBA-503-127+d+POL-IDLE-38+d); all-NBA/POL-404-DOWN(sleeping) |
...
| 187 | 2026-05-29T10h | ODD | S18-c963-g2889-stag=13-pareto=8(12→8-1ST-SHRINK-post-c950)-⚡⚡ET-200f-0.21845-gen=2885-EXTREME-URGENT(<0.22012★!-<0.22085!); c950-6TH-RESET-CONFIRMED-model-types-unclear; S22-c872-g2616-stag=0-ET-200f-~0.219-0.220-POSSIBLE-BELOW-THRESHOLD-LR-43f-Brier=0.22256-in-pareto; c853-RULE8-VIOLATION-CONFIRMED; S13/S14/S15-404-DOWN; all-POL-404-DOWN(22+fires); ODD-no-WebSearch |
