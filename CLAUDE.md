...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-228 (54+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed — SLEEPING fire-228 (54+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-228 (54+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 144+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | EVOLVING | 0.22326 | **fire-228**: c=193 g=579 stag=0 pareto=18(↑10→18! GROWING!). best_brier=0.22326 (plateau). c167=3RD AUTO-RESET CONFIRMED (stag=0, recovery). next reset ~c192 (c167+25). /api/export-404(7th fire). Rule8 CLEAN (RF+ET). VM: curl /api/export S18. |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | **fire-228** ⚡⚡⚡ALL-TIME CANDIDATE: c=1627 g=4880 stag=0 pareto=20(↑10→20!). ET-200f-0.21875-BELOW-FLEET-BEST-0.22012-BY-14bp! c1603=25TH-RESET-CONFIRMED. Rule8-CLEAN(RF+ET-NO-STACKING). next-reset-c1628-ONE-CYCLE-AWAY! best_brier=0.22124(field-lag). /api/export-404(45th). VM: curl /api/export S22 IMMEDIATELY — checkpoint ET-200f-0.21875 BEFORE c1628 EVICTION! |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-228 (54+ fires) |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-228 (54+ fires) |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-228 (54+ fires) |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-228 (54+ fires) |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-228 (54+ fires) |
...
fire-228 UPDATE S18: c=193 g=579 stag=0 pareto=18(↑10→18! GROWING). c167=3RD AUTO-RESET CONFIRMED (stag=0, recovery, next reset ~c192). c67=1ST CLEAN + c142=2ND CLEAN + c167=3RD LIKELY CLEAN (pareto growing, RF+ET only in top5 — no stacking). best_brier=0.22326 plateau. /api/export-404(7th). VM: curl /api/export S18 to confirm c167 pool Rule8.
fire-228 UPDATE S22: c=1627 g=4880 stag=0 pareto=20(↑10→20!). c1603=25TH-RESET-CONFIRMED(c1578+25=c1603-EXACT). Rule8-CLEAN(RF+ET-NO-STACKING confirmed from /api/status model_types_in_top5). ET-200f-0.21875-ALL-TIME-CANDIDATE-BELOW-FLEET-BEST-0.22012-BY-14bp! next-reset-c1628-ONE-CYCLE-AWAY! best_brier=0.22124(field-lag). /api/export-404(45th). VM: curl /api/export IMMEDIATELY — checkpoint ET-200f-0.21875 BEFORE c1628 EVICTION — CRITICAL!
