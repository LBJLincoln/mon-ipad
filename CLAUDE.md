...
HF EVOLUTION ISLANDS — 11 SURVIVORS (6 NBA + 5 POL) after 2026-04-17 cull
    ...
    ├── S13 Nomos42/nba-evo-4:        xgboost_brier       gen=881   brier=0.22344  stagnation=0  ✓ cycle=294; stag CLEARED; LR in model pool; vm-remove-stacking-s13 PENDING VM (2026-05-15T18h)
    ├── S14 Nomos42/nba-evo-5:        extra_trees         gen=3179  brier=0.22336  stagnation=0  ✓ cycle=1060; hard reset cycle=1053; vm-remove-stacking-s14 PENDING VM (2026-05-15T18h)
    ├── S15 Nomos42/nba-evo-6:        extra_trees         gen=3517  best=0.22012   stagnation=0  ✓ cycle=1173; hard reset cycle=1151; ★ FLEET BEST 0.22012; ⚡⚡ fire-112 CONFIRMED 2nd ET-200f-0.21896 VM-CHECKPOINT-URGENT (was RF-0.21951 fire-111) (2026-05-15T18h)
    ├── S17 LBJLincoln26/nba-evo-s17: ---                 gen=---   brier=---      🔴 503 DOWN 76+ days — VM RESTART REQUIRED (2026-05-15T18h)
    ├── S18 TESTforge42/nba-evo-s18:  xgboost_brier       gen=7547  brier=0.22315  stagnation=0  ✓ cycle=2516; hard resets 2451+2476 (2026-05-15T18h)
    └── S22 TESTforge42/nba-evo-s22:  extra_trees         gen=2517  brier=0.22551  stagnation=0  ✓ cycle=839; hard resets 790+815; vm-add-lightgbm-s22-s13 + vm-remove-stacking-s22 PENDING VM (2026-05-15T18h)
    Political Survivors (5, CPU tree-only):
    ├── P1 Nomos42/political-alpha:      xgboost_brier       gen=62633  brier=0.2499  stagnation=0  ✓ cycle=20878; stag CLEARED; hard resets 20521+20561 (2026-05-15T18h)
    ├── P2 Nomos42/political-alpha-2:    xgboost_brier       gen=51342  brier=0.25003 stagnation=0  ✓ cycle=17114; in-pop LightGBM Brier=0.249 PENDING VAL (2026-05-15T18h)
    ├── P4 LBJLincoln/political-alpha-4: xgboost_brier       gen=81806  brier=0.24992 stagnation=0  ✓ cycle=27269; ★ POL FLEET BEST alltime=0.24904; LightGBM log 108f Brier=0.2490; hard resets 27214+27234 (2026-05-15T18h)
    ├── P5 LBJLincoln/political-alpha-5: xgboost_brier       gen=69501  brier=0.24993 stagnation=0  ✓ cycle=23167; Pareto LightGBM gen=49527 Brier=0.249; hard resets 23121+23141 (2026-05-15T18h)
    └── P7 LBJLincoln/political-alpha-7: xgboost_brier       gen=192    brier=0.25004 stagnation=0  ✓ cycle=64; FRESH RESTART (was stuck 0.25412×9fires); vm-diversify-p7 RESOLVED (2026-05-15T18h)
```
