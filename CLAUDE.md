...
HF EVOLUTION ISLANDS — 11 SURVIVORS (6 NBA + 5 POL) after 2026-04-17 cull
    ...
    ├── S13 Nomos42/nba-evo-4:        xgboost_brier       gen=2585  brier=0.22216  stagnation=0  ✓ cycle=862; stag=0 pareto=9(↓11→9-slight) XGB-47f; vm-remove-stacking-s13 URGENT (2026-05-23T14h)
    ├── S14 Nomos42/nba-evo-5:        extra_trees         gen=1218  brier=0.22793  stagnation=0  ✓ cycle=406; stag=0 pareto=12(↑10→12-GOOD) ET-37f (2026-05-23T14h)
    ├── S15 Nomos42/nba-evo-6:        random_forest       gen=6468  best=0.22012   stagnation=0  ✓ cycle=2156; ★ FLEET BEST 0.22012; stag=0 pareto=10(stable) RF-75f (2026-05-23T14h)
    ├── S17 LBJLincoln26/nba-evo-s17: ---                 gen=---   brier=---      🔴 503 DOWN 109+ days — VM RESTART REQUIRED (2026-05-23T14h)
    ├── S18 TESTforge42/nba-evo-s18:  random_forest       gen=989   brier=0.22236  stagnation=0  ✅ cycle=330; stag=0 pareto=10(↓13→10-slight) RF-44f hard-resets-c300+c325 (2026-05-23T14h)
    └── S22 TESTforge42/nba-evo-s22:  random_forest       gen=839   brier=0.22124  stagnation=0  ⚠ cycle=280; stag=0 pareto=10(↓17→10-WATCH) RF-48f; vm-checkpoint-s22 EXTREME URGENT (2026-05-23T14h)
    Political Survivors (5, CPU tree-only):
    ├── P1 Nomos42/political-alpha:      xgboost_brier       gen=17239  brier=0.24987 stagnation=0  ✓ cycle=5747; stag=0 pareto=8(↓10→8-slight) XGBoost-85f (2026-05-23T14h)
    ├── P2 Nomos42/political-alpha-2:    xgboost_brier       gen=63241  brier=0.25003 stagnation=0  ⚠ cycle=21081; stag=0 pareto=6(↓10→6-shrink-WATCH) XGBoost-65f (2026-05-23T14h)
    ├── P4 LBJLincoln/political-alpha-4: lightgbm            gen=7787   brier=0.2497  stagnation=0  ✓★ cycle=2596; ★★POL-FLEET-BEST; stag=0 pareto=9(↑8→9-RECOVERING) LightGBM-62f-6TH-OBSERVE; vm-checkpoint-p4-lgbm EXTREME URGENT (2026-05-23T14h)
    ├── P5 LBJLincoln/political-alpha-5: xgboost_brier       gen=83919  brier=0.24993 stagnation=0  ⚠⚠ cycle=27973; stag=0 pareto=4(↓11→4-CRITICAL-SHRINK-2ND-EPISODE) XGBoost-58f; vm-checkpoint-p5 URGENT (2026-05-23T14h)
    └── P7 LBJLincoln/political-alpha-7: xgboost_brier       gen=25664  brier=0.25004 stagnation=0  ⚡ cycle=8555; stag=0 pareto=10(↑6→10-MAJOR-RECOVERY) XGBoost-60f (2026-05-23T14h)
```
