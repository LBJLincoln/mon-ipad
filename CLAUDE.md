...
> Architecture v21 — "The Trading Floor Crew" (14 agents × 9 depts × 4 tracks) + TF v3 (17 LLM agents) + 21 Evolution Islands | Updated: 2026-06-08T12h
...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-247 (73+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed — SLEEPING fire-247 (73+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-247 (73+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 144+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | EVOLVING | 0.22326 | **fire-247 carry-forward**: RF-200f-0.21949 EXTREME URGENT! (6bp BELOW FLEET BEST 0.22012!). pareto=19(GROWING!) post-20TH-RESET-c592. Next reset ~c617(c592+25). /api/export-404(22nd+). VM: curl /api/export S18 IMMEDIATELY. |
| S22 | TESTforge42/nba-evo-s22 | FRESH-RESTART | 0.22124 | **fire-247 carry-forward**: ET-0.2193 EXTREME URGENT! (8bp BELOW FLEET BEST 0.22012!). First auto-reset ~c25 IMMINENT/OCCURRING (was 3 cycles away at fire-246). VM: curl /api/export S22 — monitor Rule8 at ~c25 reset; DO NOT evict ET. |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-247 (73+ fires) |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-247 (73+ fires) |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-247 (73+ fires) |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-247 (73+ fires) |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-247 (73+ fires) |
...
fire-247 UPDATE S18: Status carry-forward from fire-246. RF-200f-0.21949 EXTREME URGENT! (6bp below fleet best 0.22012!). Next reset ~c617(c592+25). VM: curl /api/export S18 IMMEDIATELY.
