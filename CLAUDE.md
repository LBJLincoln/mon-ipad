...
HF EVOLUTION ISLANDS — 11 SURVIVORS (6 NBA + 5 POL) after 2026-04-17 cull
    ...
    ├── S13 Nomos42/nba-evo-4:        xgboost_brier       gen=2654  brier=0.22216  stagnation=0  ✓ cycle=885; stag=0 pareto=16(↑9→16-MAJOR-RECOVERY) XGB-47f; vm-remove-stacking-s13 URGENT (2026-05-23T18h)
    ├── S14 Nomos42/nba-evo-5:        extra_trees         gen=1279  brier=0.22793  stagnation=23 ⚠ cycle=427; stag=23-DIVERSIFY-SENT pareto=7(↓12→7) ET-37f (2026-05-23T18h)
    ├── S15 Nomos42/nba-evo-6:        random_forest       gen=6514  best=0.22012   stagnation=0  ✓ cycle=2172; ★ FLEET BEST 0.22012; stag=0 pareto=11(↑10→11) RF-75f (2026-05-23T18h)
    ├── S17 LBJLincoln26/nba-evo-s17: ---                 gen=---   brier=---      🔴 503 DOWN 110+ days — VM RESTART REQUIRED (2026-05-23T18h)
    ├── S18 TESTforge42/nba-evo-s18:  random_forest       gen=1073  brier=0.22236  stagnation=0  ✅ cycle=358; stag=0 pareto=16(↑10→16-MAJOR-RECOVERY) RF-44f (2026-05-23T18h)
    └── S22 TESTforge42/nba-evo-s22:  random_forest       gen=902   brier=0.22124  stagnation=0  ✓ cycle=301; stag=0 pareto=14(↑10→14-RECOVERY) RF-48f; vm-checkpoint-s22 EXTREME URGENT (2026-05-23T18h)
    Political Survivors (5, CPU tree-only):
    ├── P1 Nomos42/political-alpha:      xgboost_brier       gen=18135  brier=0.24987 stagnation=0  ⚠⚠ cycle=6045; stag=0 pareto=4(↓8→4-CRITICAL-SHRINK) XGBoost-85f; vm-checkpoint-p1 EXTREME URGENT (2026-05-23T18h)
    ├── P2 Nomos42/political-alpha-2:    xgboost_brier       gen=63546  brier=0.25003 stagnation=0  ✓ cycle=21183; stag=0 pareto=9(↑6→9-RECOVERING) XGBoost-65f (2026-05-23T18h)
    ├── P4 LBJLincoln/political-alpha-4: lightgbm            gen=8130   brier=0.2497  stagnation=0  ✓★ cycle=2710; ★★POL-FLEET-BEST; stag=0 pareto=10(↑9→10-stable) LightGBM-62f-7TH-OBSERVE; vm-checkpoint-p4-lgbm EXTREME URGENT (2026-05-23T18h)
    ├── P5 LBJLincoln/political-alpha-5: xgboost_brier       gen=84358  brier=0.24993 stagnation=0  ✓ cycle=28120; stag=0 pareto=6(↑4→6-RECOVERING) XGBoost-58f (2026-05-23T18h)
    └── P7 LBJLincoln/political-alpha-7: xgboost_brier       gen=26487  brier=0.25004 stagnation=0  ✓ cycle=8829; stag=0 pareto=9(↓10→9-slight) XGBoost-60f (2026-05-23T18h)
```
