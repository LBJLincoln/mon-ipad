...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-172 |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-172 |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST stable gen=6672 pareto=13 — SLEEPING fire-172 |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 119+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c730 g2189 stag=0 cycle_stag~29(>15-WATCH) pareto=11(↓17→11-5th-consec-shrink); hard-resets-c675+c700(NO-STACKING-Rule8-COMPLIANT); /api/export-404(WebFetch-limitation-VM-curl-verify); last-update-3.5d-stale |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c581 g1742 stag=0; hard-reset-c553(xgb/lgbm/catboost-NO-STACKING); Rule8-SELF-RESOLVED; LR-active-confirmed-fire172; ET-0.21877-unconfirmed-EXTREME-URGENT; /api/export-404(WebFetch-limitation-VM-curl-verify) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-172 |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-172 |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-172 |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-172 |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-172 |
...
Do NOT push to HF Spaces (nba-llm-trading-floor, political-llm-trading-floor) until user explicitly approves. NBA TF 503 DOWN 119+d. POL TF IDLE 31+d.
...
2. **Split Conformal Calibration** (fire-168 EVEN WebSearch)
   ...
   - Target: S18 RF/LightGBM pareto (c730) + S22 RF-48f + S15 RF-75f
