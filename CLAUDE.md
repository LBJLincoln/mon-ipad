...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-184 (20+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-184 |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST stable gen=6672 pareto=13 — SLEEPING fire-184 |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 123+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c892 g2674 stag=16(>15-DIVERSIFY-NEEDED-Rule#6!-VM-URGENT)-pareto=12(↗15→12-3RD-CONSEC-SHRINK-post-c850); LightGBM-38f-dominating-pop(ROI-focus); RF-44f-best_brier=0.22236; CatBoost-0.21995-POSSIBLY-LOST(c850-reset); c850-Rule8-5TH-VIOLATION; auto-reset-CORRECTED(stag-triggered-at-stag=25-NOT-cycle-count)-next-~c901(9cycles); /api/export-404(WebFetch-10-fire-confirmed) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c807 g2421 stag=0-pareto=13(STABLE); hard-resets-c778+c803-BOTH-CONFIRMED(fire184); LR-43f-CONFIRMED-dominating(fire184-API-explicit); RF-48f-best_brier=0.22124; ET-unconfirmed(14+fires); next-auto-reset-~c828(c803+25-21cycles); Rule8-LIKELY-COMPLIANT-7TH-fire; /api/export-404(WebFetch-10-fire-confirmed) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-184 |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-184 |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-184 |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-184 |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-184 |
...
2. **Split Conformal Calibration** (fire-168 EVEN WebSearch)
   ...
   - Target: S18 RF/LightGBM pareto (c892) + S22 RF-48f + S15 RF-75f
...
10. **Calibration vs Accuracy Model Selection** (fire-172 EVEN WebSearch)
    ...
    - fire-184 STRONG VALIDATION: S22 LR 43f CONFIRMED dominating in API (explicit: '43-feature logistic regression dominating recent evolution despite initial random forest leadership') — calibration-focused linear model wins in evolved population
