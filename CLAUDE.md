...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-200 (32+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-200 (32+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-200 (32+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 135+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c1159 g3475 stag=0(AUTO-RESET-c1150-16TH-CONFIRMED-stag-cleared); pareto=10(STABLE-post-c1150); c1150-post-reset-NO-STACKING(xgb/lgbm_brier/catboost/ET/LR-POSSIBLE-1ST-CLEAN-AUTO-RESET-CODE!); Venn-Abers+beta-calibration-BOTH-in-top5(3rd-consec-reset-survived!); diversify-SUPERSEDED(c1150-auto-reset-beat-stag-trigger); next-auto-reset-~c1184(stag=0-from-c1159+25); best_brier=0.22236-STALE(7+days); /api/export-404(22nd-fire) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c1152 g3456 stag=0 pareto=5(↗9↑5-SHRUNK!); PERFORMANCE-CLIFF-ONGOING(ALL-5-last-gens-Brier=0.28-450+-gens-no-improvement-gen3010-CRITICAL!); stacking-CONFIRMED-in-recent-resets(Rule8-8TH-S22-CONFIRMED-fire200-API-explicit); ET-200f-0.21984-STATUS-UNKNOWN; 8-confirmed-resets: c853/c1003/c1028/c1053/c1078/c1103/c1128/post-c1128(8TH); next-auto-reset-~c1177(stag=0+25); best_brier=0.22124-STALE(7+days); /api/export-404(22nd-fire) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-200 |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-200 |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-200 |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-200 |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-200 |
...
- Mech-B+C-BLOCKED: do_not_push_hf_space_yet + NBA-503-135+d + POL-IDLE-46+d
...
### Active Research
1. **Venn-Abers Calibration** (fire-158 EVEN WebSearch) — **NOW VALIDATED fire-197 + PERSISTENT fire-200: S18 GA evolved Venn-Abers organically AND survived 3 consecutive resets (c1100, c1125, c1150)!**
   ...
   - fire-200 NEW: beta calibration ALSO organically evolved alongside Venn-Abers ('Top-5: beta calibration, Venn-Abers calibration, and logistic regression meta-calibration')
...
17. **Conformal Prediction for Time Series** (fire-200 EVEN WebSearch)
    ...
    - Target: S18 RF/ET (post-c1150 clean reset) + S22 RF/ET + S15 RF-75f fleet best
...
|------|------|--------|------------|
| 200 | 2026-05-31T14h | EVEN | S18-c1159-g3475-stag=0(AUTO-RESET-c1150-16TH-CONFIRMED!)-pareto=10-STABLE-Venn-Abers+beta-calib-STILL-top5(3RD-consec-survived!)-c1150-NO-STACKING(POSSIBLE-1ST-CLEAN-CODE!); S22-c1152-g3456-stag=0-pareto=5(SHRUNK!)-PERFORMANCE-CLIFF-ONGOING-ALL5-last-gens-Brier=0.28-450+-gens-no-improvement; stacking-CONFIRMED-Rule8-8TH-S22; /api/export-404-22nd-fire; S13/S14/S15-404-DOWN(32+fires); all-POL-404-DOWN(32+fires); EVEN: arXiv:2601.18509-Conformal-TS-Benchmarking-proposal-written |
| 199 | 2026-05-31T10h | ODD | S18-c1141-g3422-stag=15(AT-THRESHOLD!-DIVERSIFY-NEXT-FIRE-Rule#6-IMMINENT)-pareto=10(↑20↑10-post-c1125-reset)-c1125-15TH-RESET-CONFIRMED(Rule8-UNCONFIRMED)-Venn-Abers-STILL-IN-PARETO; S22-c1134-g3400-stag~5-PERFORMANCE-CLIFF-recent-gens-Brier=0.28!-c1103+c1128-BOTH-CONFIRMED(Rule8-UNCONFIRMED)-c1078-5TH-NOW-CONFIRMED; /api/export-404-BOTH(21st-fire); S13/S14/S15-404-DOWN(31+fires); all-POL-404-DOWN(31+fires); ODD-no-WebSearch |
...
| 194 | 2026-05-30T14h | EVEN | Axelrod-verify-pass: SHAs-NBA-19f4acf49d(5993L)/POL-3496362c60(3977L)-UNCHANGED; 13/13-parity-OK; Mech-B+C-BLOCKED(NBA-503-132+d+POL-IDLE-42+d); all-NBA/POL-404-DOWN(sleeping) |
...
| 192 | 2026-05-30T06h | EVEN | S18-c1046-g3136-carry-fire191(next-~c1050-IMMINENT-Rule8-10TH-VIOLATION-stacking-ACTIVE); S22-c1003-g3007-stag=0-pareto=12(STABLE-carry-fire191)-Rule8-COMPLIANT-next-~c1028(25cycles); S13/S14/S15-404-DOWN(26+fires); all-POL-404-DOWN(26+fires); EVEN: arXiv:2406.04062-Online-Learning-Betting-Markets-profit≠accuracy; Axelrod-verify-pass(SHAs-UNCHANGED); Mech-B+C-BLOCKED |
