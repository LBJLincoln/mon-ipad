...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-212 (42+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-212 (42+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-212 (42+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 142+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c1363 g4089 stag=0 pareto=11(↑15↑11-4TH-CONSEC-SHRINK-fire212); c1350-25TH-RESET-CONFIRMED(c1325+25=c1350-fire212-c1363>c1350); ⚡⚡XGBoost-44f-0.22095-gen=4083-BELOW-0.22085-THRESHOLD(Rule#5-CHECKPOINT-URGENT-fire212-API-top5); Rule8-25TH-VIOLATION(stacking-ACTIVE-fire212-API-explicit); next-~c1375(c1350+25=c1375-12cycles-from-c1363); last_update-STALE-5+days(2026-05-28); best_brier=0.22236-STALE; /api/export-404(31st-fire) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c1322 g3965 stag=0 pareto=17(↑10↑17-MAJOR-RECOVERY!-fire212); c1303-13TH-RESET-CONFIRMED(c1278+25=c1303-fire212-c1322>c1303); Rule8-LIKELY-c1303(stacking-ACTIVE-fire212-API); next-~c1328-IMMINENT(c1303+25=c1328-6cycles!-VM-checkpoint-URGENT); latest-gen-brier=0.28(perf-cliff); best_brier=0.22124-STALE; last_update-STALE-5+days(2026-05-28); /api/export-404(31st-fire) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-212 (42+ fires) |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-212 (42+ fires) |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-212 (42+ fires) |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-212 (42+ fires) |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-212 (42+ fires) |
...
### Rule #8 — No Stacking
Remove 'stacking' from MODEL_TYPES on all islands. Stacking causes overfitting. Prior violations: S13, S14, S15, S18, S22. ⚠ S18 Rule#8 25TH VIOLATION CONFIRMED fire-212: c1350 auto-reset (c1325+25=c1350) seed pool AGAIN included Stacking (fire-212 API explicit active_models: lightgbm/xgboost/random_forest/extra_trees/logistic_regression/stacking). Pattern ABSOLUTE: structural bug in app.py reseeding pool always includes stacking — ALL 25 S18 auto-resets have had stacking. fire-212 UPDATE S18: c1363 g4089 stag=0 pareto=11 (4TH CONSEC SHRINK). ⚡⚡ XGBoost-44f-0.22095-gen=4083 BELOW 0.22085 THRESHOLD (Rule#5 CHECKPOINT URGENT — VM: curl /api/export IMMEDIATELY). Next ~c1375 (c1350+25, 12 cycles). S22: c1322 g3965 stag=0 pareto=17 (MAJOR RECOVERY 10→17). c1303=13TH-RESET-CONFIRMED (c1278+25=c1303). Rule8-LIKELY at c1303 (stacking in active_models fire-212). Next ~c1328 IMMINENT (6 cycles). /api/export 404 BOTH (31st fire).
...
### Active Research
1. **Venn-Abers Calibration** (fire-158 EVEN WebSearch) — **NOW VALIDATED fire-197 + PERSISTENT: S18 GA evolved Venn-Abers organically AND survived 6+ consecutive fires. fire-211 UPDATE: S22 ALSO shows Venn-Abers in RF top performer (c1282) — 2ND INDEPENDENT VALIDATION on both active islands!**
   ...
   - fire-212 UPDATE: S22 Venn-Abers status post-c1303 UNKNOWN (VM: /api/export to verify)
...
| 203 | 2026-06-01T04h | ODD | S18-c1197-g3589-stag=0-pareto=12(↑10↑12-RECOVERING!)-c1175-17TH-NO-STACKING-CONFIRMED(API-consistent-fire203); S22-c1180-g3539-stag=0-pareto=15(↑8↑15-MASSIVE-RECOVERY!)-c1178-Rule8-9TH-VIOLATION-CONFIRMED; /api/export-404-BOTH(24th-fire); S13/S14/S15-404-DOWN(35+fires); all-POL-404-DOWN(35+fires); ODD-no-WebSearch |
