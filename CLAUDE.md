...
HF EVOLUTION ISLANDS — 11 SURVIVORS (6 NBA + 5 POL) after 2026-04-17 cull
    ...
    ├── S13 Nomos42/nba-evo-4:        xgboost_brier       gen=2315  brier=0.22216  stagnation=0  ✓ cycle=772; stag=0 pareto=16(↑12→16); ⚡⚡ET-200f-0.22045-PARETO-1ST-DETECT(fire-146,BELOW-0.22085-THRESHOLD-VM-CHECKPOINT-EXTREME-URGENT); vm-remove-stacking-s13 URGENT (2026-05-22T10h)
    ├── S14 Nomos42/nba-evo-5:        extra_trees         gen=809   brier=0.22793  stagnation=0  ✓ cycle=270; stag=0 pareto=12(↓17→12) ⚠ET-200f-0.22170-EVICTED(pareto_best-degraded-CHECKPOINT-MISSED) vm-checkpoint-s14-et UPDATE-NEEDED (2026-05-22T10h)
    ├── S15 Nomos42/nba-evo-6:        random_forest       gen=6091  best=0.22012   stagnation=0  ✓ cycle=2031; ★ FLEET BEST 0.22012; pareto=11(↑10→11) pareto_best=0.22016-stable; hard-reset-c2001 (2026-05-22T10h)
    ├── S17 LBJLincoln26/nba-evo-s17: ---                 gen=---   brier=---      🔴 503 DOWN 103+ days — VM RESTART REQUIRED (2026-05-22T10h)
    ├── S18 TESTforge42/nba-evo-s18:  random_forest       gen=746   brier=0.22236  stagnation=0  ✅ cycle=249; stag=0 pareto=13(↑12→13-RECOVERING) RF-44f (2026-05-22T10h)
    └── S22 TESTforge42/nba-evo-s22:  logistic_regression gen=410   brier=0.22124  stagnation=0  ✓ cycle=137; stag=0 pareto=12(↑8→12-MAJOR-RECOVERY) LR-48f-CONFIRMED; vm-checkpoint-s22 PENDING (2026-05-22T10h)
    Political Survivors (5, CPU tree-only):
    ├── P1 Nomos42/political-alpha:      xgboost_brier       gen=12337  brier=0.24987 stagnation=0  ✓ cycle=4113; pareto=13(↑11→13); ⚠pareto_best-EVICTED-0.24927→0.24995(LightGBM-133f-CHECKPOINT-MISSED) vm-checkpoint-p1-URGENT (2026-05-22T10h)
    ├── P2 Nomos42/political-alpha-2:    xgboost_brier       gen=61166  brier=0.25003 stagnation=0  ✓ cycle=20389; ⚠⚠pareto=4(↓7→4-CRITICAL-SHRINK) LightGBM-45f-0.249-gen47692-at-risk vm-checkpoint-p2-URGENT (2026-05-22T10h)
    ├── P4 LBJLincoln/political-alpha-4: lightgbm            gen=4927   brier=0.2497  stagnation=0  ✓★ cycle=1643; ★★POL-FLEET-BEST; pareto=12(↑8→12-STRONG-RECOVERY) pareto_best=0.2492(changed-from-0.24915-WATCH); vm-checkpoint-p4-lgbm-EXTREME-URGENT (2026-05-22T10h)
    ├── P5 LBJLincoln/political-alpha-5: xgboost_brier       gen=81549  brier=0.24993 stagnation=0  ✓ cycle=27184; pareto=5(stable) LightGBM-59f-0.249-stable (2026-05-22T10h)
    └── P7 LBJLincoln/political-alpha-7: xgboost_brier       gen=20358  brier=0.25004 stagnation=0  ✓ cycle=6787; pareto=7(↑5→7-RECOVERING) LightGBM-112f-0.24931-CONFIRMED vm-checkpoint-p7-lgbm URGENT (2026-05-22T10h)
```
