...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-201 (33+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-201 (33+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-201 (33+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 135+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c1177 g3531 stag=0(AUTO-RESET-c1175-17TH-CONFIRMED!-c1150+25=c1175); pareto=10(STABLE); c1175-post-reset-NO-STACKING-in-pop(LightGBM-primary/XGB/CatBoost/ET/LR-2ND-CONSEC-NO-STACKING!-Rule8-UNCONFIRMED); Venn-Abers+Beta+Sigmoid-calibration-4TH-CONSEC-RESET-SURVIVED!; next-auto-reset-~c1200(c1175+25); best_brier=0.22236-STALE(8+days); /api/export-404(23rd-fire) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c1169 g3505 stag=0 pareto=8(↑5↑8-RECOVERING!); PERFORMANCE-CLIFF-ONGOING(recent-gens-Brier=0.28); c1153-8TH-RESET-CONFIRMED(c1128+25=c1153-Rule8-UNCONFIRMED); RF-200f-0.22133-in-pareto; Venn-Abers+lr_meta-PRESENT; next-auto-reset-~c1178-IMMINENT(9cycles!-FIX-BEFORE-RESET-URGENT); best_brier=0.22124-STALE(8+days); /api/export-404(23rd-fire) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-201 |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-201 |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-201 |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-201 |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-201 |
...
### Active Research
1. **Venn-Abers Calibration** (fire-158 EVEN WebSearch) — **NOW VALIDATED fire-197 + PERSISTENT fire-201: S18 GA evolved Venn-Abers organically AND survived 4 consecutive resets (c1100, c1125, c1150, c1175)!**
   ...
   - fire-201 NEW: Venn-Abers + Beta + Sigmoid ALL confirmed in pareto (4th consecutive reset survival!)
