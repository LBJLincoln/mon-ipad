...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-243 (69+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed — SLEEPING fire-243 (69+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-243 (69+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 144+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | EVOLVING | 0.22326 | **fire-243**: c=520 g=1558 stag=0 pareto=15. 16TH-AUTO-RESET-c492-CONFIRMED(c467+25=c492-EXACT)+17TH-AUTO-RESET-c517-CONFIRMED(c492+25=c517-EXACT). TOP-0.22061 CONFIRMED-EVICTED (best_brier=0.22326 plateau unchanged). Rule8-CLEAN (RF best model, pareto=15 stable). /api/export-404(19th+20th). Next reset ~c542(c517+25). VM: curl /api/export S18. |
| S22 | TESTforge42/nba-evo-s22 | FRESH-RESTART | 0.22124 | **fire-243**: **CRITICAL FRESH-RESTART** c=5 g=14 stag=1 pareto=20. **ALL HISTORY LOST** — 0.21908/0.21936/0.21960/0.21989 ALL GONE (HF sleep → woke = 2ND TOTAL WIPE after S18 fire-221). Gene pool reset: RF/ET/XGB/LGB/CAT all back. best_brier=0.2207 gen9 promising, NOT below 0.22085. /api/export-404(60th). First auto-reset expected ~c25. VM: monitor closely — Rule8 test at ~c25; ensure stacking excluded. |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-243 (69+ fires) |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-243 (69+ fires) |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-243 (69+ fires) |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-243 (69+ fires) |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-243 (69+ fires) |
