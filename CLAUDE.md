...
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c1297 g3891 stag=0 pareto=11(↑13↑11-1st-shrink); c1275-21ST-RESET-CONFIRMED(c1250+25=c1275-stacking-ABSOLUTE); XGBoost-200f-0.22131-gen=3889-in-pareto; c1250+c1225-stacking(20th+19th-violations); last_update-STALE-5+days(2026-05-27); best_brier=0.22236-STALE; next-~c1300(c1275+25); /api/export-404(27th-fire) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c1221 g3663 stag=17(>15-DIVERSIFY-SENT-fire207!)-pareto=11(↑15↑11-SHRINKING!); ⚡⚡ET-200f-0.21904-gen=3659-EXTREME-URGENT(<0.22012★!-NEW-FLEET-BEST-CANDIDATE); c1203-10TH-RESET-COMPLIANT; diversify-SENT-fire207; next-auto-reset-~c1228-IMMINENT(7cycles!); best_brier=0.22124-STALE; last_update-STALE-5+days(2026-05-27); /api/export-404(27th-fire) |
...
- Parity: SHAs NBA 19f4acf49d(SHA-verified)/POL 3496362c60(SHA-verified) UNCHANGED (SHA-verified fire-206; TF repos not accessible via MCP fire-206)
- 13/13 parity symbols OK (verified fire-206; C→B→A call-order confirmed NBA:L5056/5065/5073 POL:L3246/3255/3263; compute_consensus_distance(KL) ε-smoothed self-excluded confirmed)
- Mech-B+C-BLOCKED: do_not_push_hf_space_yet + NBA-503-139+d + POL-IDLE-51+d
