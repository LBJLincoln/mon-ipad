...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-175 |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-175 |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST stable gen=6672 pareto=13 — SLEEPING fire-175 |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 121+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c756 g2268 stag=0(AUTO-HARD-RESET-c750-CONFIRMED!); pareto=14(↑13→14-4th-consec-recovery); hard-resets-c725+c750-Rule8-COMPLIANT; /api/export-404(WebFetch-3-fire-confirmed) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c645 g1935 stag=0; hard-reset-c628-NEW; Rule8-POTENTIALLY-RESOLVED(no-stacking-description-fire175); ET-0.21877-unconfirmed-EXTREME-URGENT(7+fires); /api/export-404(WebFetch-3-fire-confirmed) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-175 |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-175 |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-175 |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-175 |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-175 |
...
### Rule #8 — No Stacking
Remove 'stacking' from MODEL_TYPES on all islands. Stacking causes overfitting. Prior violations: S13, S14, S15, S22. ⚠ S22 Rule#8 POTENTIALLY RESOLVED fire-175: description no longer mentions 'stacking approaches' (was present fire-173 at c611); hard reset c628 NEW. Still unconfirmed without /api/export MODEL_TYPES — VM must curl to verify. S18 c725+c750 compliant (confirmed fire-175 description). Remaining violations: S13/S14/S15 need stacking removal after wake.
...
- Parity: SHAs NBA 19f4acf49d(5993L)/POL 3496362c60(3977L) UNCHANGED vs fire-175 (verified fire-176)
- 13/13 parity symbols OK (verified fire-176; C→B→A call-order confirmed NBA:L5056/5065/5073 POL:L3246/3255/3263; compute_consensus_distance(KL) ε-smoothed self-excluded confirmed)
...
2. **Split Conformal Calibration** (fire-168 EVEN WebSearch)
   ...
   - Target: S18 RF/LightGBM pareto (c756) + S22 RF-48f + S15 RF-75f
...
|------|------|--------|------------|
| 176 | 2026-05-27T14h | EVEN | Axelrod-verify-pass: SHAs-NBA-19f4acf49d(5993L)/POL-3496362c60(3977L)-UNCHANGED-vs-fire-175; 13/13-parity-OK; C→B→A-confirmed(NBA-L5056/5065/5073-POL-L3246/3255/3263); KL-div-ε-smoothed-self-excluded-OK; AXELROD_ARCHETYPES-NBA-20-sports/POL-20-political-financial-OK; Mech-B+C-BLOCKED(do_not_push_hf_space_yet+NBA-503-121+d+POL-IDLE-32+d); all-NBA/POL-404-DOWN(sleeping); py_compile-NBA+POL-PASS |
...
| 172 | 2026-05-26T22h | EVEN | S18-c730-g2189-stag=0-pareto=11(↑17→11-5th-consec-shrink)-cycle_stag~29(>15-WATCH); S22-c581-g1742-stag=0-LR-stable-summary; /api/export-404-BOTH-S18+S22(WebFetch-limitation-VM-must-curl-verify); S13/S14/S15-404-DOWN; all-POL-404-DOWN; EVEN: arXiv:2303.06021-calibration-vs-accuracy-ECE-pareto-objective-proposal-written |
...
| 170 | 2026-05-26T14h | EVEN | Axelrod-verify-pass: SHAs-NBA-19f4acf49d(5993L)/POL-3496362c60(3977L)-UNCHANGED-vs-fire-163; 13/13-parity-OK; C→B→A-confirmed(NBA-L5056/5065/5073-POL-L3246/3255/3263); compute_consensus_distance(KL-ε-smoothed-self-excluded)-OK; AXELROD_ARCHETYPES-NBA-20-sports/POL-20-political-financial-OK; Mech-B+C-BLOCKED |
| 169 | 2026-05-26T08h | ODD | Axelrod-verify-pass: SHAs-NBA-19f4acf49d(5993L)/POL-3496362c60(3977L)-UNCHANGED-vs-fire-167; all-3-mechs-confirmed(A:COMMON_KNOWLEDGE+build_common_knowledge_block;B:AXELROD_ARCHETYPES+sacrificial_map;C:AXELROD_LOG_DIR+axelrod-log); NBA-domain-sports/POL-domain-political-financial-OK; Mech-B+C-BLOCKED |
...
| 167 | 2026-05-26T00h | ODD | Axelrod-verify-pass: SHAs-NBA-19f4acf49d49d(5993L)/POL-3496362c60(3977L)-UNCHANGED-vs-fire-163; 13/13-parity-OK; C→B→A-confirmed; KL-div-ε-smoothed-self-excluded-OK; AXELROD_ARCHETYPES-NBA-20-sports-specific/POL-20-political-financial-domain-specific-OK; BLOCKED-do_not_push_hf_space_yet+NBA-503(116+d)+POL-IDLE(28+d) |
