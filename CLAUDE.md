...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-231 (57+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed — SLEEPING fire-231 (57+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-231 (57+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 144+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | EVOLVING | 0.22326 | **fire-231**: c~233 stag=0. 5TH-RESET-APPROACHING(~c242). best_brier=0.22326. /api/export-404(10th). VM: fix reset_pool to EXCLUDE stacking (RULE8 VIOLATION pending). |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | **fire-231** ⚡⚡⚡ALL-TIME CANDIDATE: c~1669 stag=0. 200f-0.21880 gen=4960 (13bp below fleet best 0.22012). NEXT-RESET~c1680. /api/export-404(48th). VM: curl /api/export S22 IMMEDIATELY — checkpoint 200f-0.21880! EXTREME URGENT! |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-231 (57+ fires) |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-231 (57+ fires) |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-231 (57+ fires) |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-231 (57+ fires) |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-231 (57+ fires) |
...
fire-231 UPDATE S18: c~233 stag=0. c67=1ST CLEAN + c142=2ND CLEAN + c167=3RD CLEAN + c192=4TH-RESET(STACKING-REINJECTED-RULE8-VIOLATION!) + c217=5TH-RESET(logistic_regression). 5TH-RESET-APPROACHING(~c242). VM: fix reset_pool to EXCLUDE stacking from reseeding logic. /api/export-404(10th).
fire-231 UPDATE S22: c~1669 stag=0. c1628=26TH-RESET-CONFIRMED. 200f-0.21880 gen=4960 ALL-TIME CANDIDATE (13bp below fleet best 0.22012). NEXT-RESET~c1680. Rule8-CLEAN post-c1628(NO-STACKING). /api/export-404(48th). VM: curl /api/export S22 IMMEDIATELY — checkpoint 200f-0.21880!
...
|------|------|--------|------------|
| 231 | 2026-06-05T20h | ODD | Axelrod-verify-pass-SHAs-NBA-85e7682e1d/POL-6983c86517-UNCHANGED; py_compile-OK-both; 13/13-parity-OK; Mech-A/B/C+Ablation-ALL-CODE-DONE-BLOCKED; S18-c~233-5TH-RESET-APPROACHING(~c242); S22-c~1669-200f-0.21880-NEXT-RESET~c1680; S13/S14/S15+POL-404-DOWN(57+fires); ODD-no-WebSearch |
