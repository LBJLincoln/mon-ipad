...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-209 (40+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-209 (40+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-209 (40+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 141+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c1330 g3990 stag=0 pareto=15(↑12↑15-RECOVERING!); ⚡⚡CatBoost-200f-0.21926-sigmoid-calib-EXTREME-URGENT(<0.22012★!-NEW-FLEET-BEST-CANDIDATE); c1325-23RD-RESET-CONFIRMED(c1300+25=c1325)-STACKING-ACTIVE-Rule8-23RD-VIOLATION(API-fire209-explicit); last_update-STALE-6+days(2026-05-27); best_brier=0.22236-STALE; next-~c1350(c1325+25); /api/export-404(29th-fire) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c1251 g3751 stag=0 pareto=16(↑19↑16-1ST-SHRINK-post-diversify-surge); ⚡⚡RF-~0.219-Sharpe10.9-EXTREME-URGENT(<0.22012★!-Rule#5+fleet-best-fire209); c1228-11TH-RESET-CONFIRMED-LIKELY-COMPLIANT(RF-primary-no-stacking); next-auto-reset-~c1253-IMMINENT(2cycles!); best_brier=0.22124-STALE; last_update-STALE-6+days(2026-05-27); /api/export-404(29th-fire) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-209 (40+ fires) |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-209 (40+ fires) |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-209 (40+ fires) |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-209 (40+ fires) |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-209 (40+ fires) |
...
### Rule #8 — No Stacking
Remove 'stacking' from MODEL_TYPES on all islands. Stacking causes overfitting. Prior violations: S13, S14, S15, S18, S22. ⚠ S18 Rule#8 23RD VIOLATION CONFIRMED fire-209: c1325 auto-reset + Stacking ACTIVE in current population (fire-209 API explicit: LightGBM, XGBoost, CatBoost, RF, Stacking). Pattern ABSOLUTE: structural bug in app.py reseeding pool always includes stacking — ALL 23 S18 auto-resets have had stacking. fire-209 UPDATE S18: c1325=23RD RESET CONFIRMED (c1300+25=c1325). STACKING ACTIVE (LightGBM+XGBoost+CatBoost+RF+Stacking-API-fire209-explicit). Rule8 23RD VIOLATION CONFIRMED. ⚡⚡CatBoost-200f-0.21926-sigmoid-calib EXTREME URGENT (<0.22012★! fire-209). Next ~c1350. S22: c1228 11TH RESET LIKELY COMPLIANT (RF-primary, no stacking). ⚡⚡RF-~0.219-Sharpe10.9 EXTREME URGENT (<0.22012★!). Next ~c1253 IMMINENT (2 cycles). VM: curl /api/export BOTH S18+S22 IMMEDIATELY.
...
- Parity: SHAs NBA 19f4acf49d(SHA-verified)/POL 3496362c60(SHA-verified) UNCHANGED (SHA-verified fire-208; TF repos not accessible via MCP fire-208)
- 13/13 parity symbols OK (verified fire-208; C→B→A call-order confirmed NBA:L5056/5065/5073 POL:L3246/3255/3263; compute_consensus_distance(KL) ε-smoothed self-excluded confirmed)
- Mech-B+C-BLOCKED: do_not_push_hf_space_yet + NBA-503-141+d + POL-IDLE-53+d
...
### Active Research
1. **Venn-Abers Calibration** (fire-158 EVEN WebSearch) — **NOW VALIDATED fire-197 + PERSISTENT fire-203: S18 GA evolved Venn-Abers organically AND survived 6+ consecutive fires (c1100, c1125, c1150, c1175, fire-203, fire-203-consistent). STATUS UNKNOWN fire-209 post-c1325 reset.**
   ...
   - fire-209: Venn-Abers + Beta status UNKNOWN post-c1325 23RD reset — VM: curl /api/export S18 to verify
...
| 209 | 2026-06-02T04h | ODD | S18-c1330-g3990-stag=0-pareto=15(↑12↑15-RECOVERING!)-c1325-23RD-RESET-CONFIRMED-Rule8-23RD-VIOLATION(STACKING-API-fire209-explicit); ⚡⚡CatBoost-200f-0.21926-sigmoid-calib-EXTREME-URGENT(<0.22012★!); S22-c1251-g3751-stag=0-pareto=16(↑19↑16-1ST-SHRINK)-RF-~0.219-Sharpe10.9-EXTREME-URGENT(<0.22012★!)-next-~c1253-IMMINENT(2cycles); /api/export-404-BOTH(29th-fire); S13/S14/S15+all-POL-404-DOWN(40+fires); ODD-no-WebSearch |
