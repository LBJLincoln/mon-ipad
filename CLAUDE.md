...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-179 |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-179 |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST stable gen=6672 pareto=13 — SLEEPING fire-179 |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 122+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c800 g2400 stag=0 pareto=13(↑12→13-RECOVERING!); hard-resets-c750+c775-BOTH-CONFIRMED; RF-best-model-NO-STACKING-MENTIONED-fire179(Rule8-POSSIBLE-RESOLUTION-unconfirmed-without-api-export); VM: curl-/api/export-DIRECTLY; /api/export-404(WebFetch-6-fire-confirmed) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c720 g2160 stag=0 pareto(range-6-to-22); hard-resets-c678+c703-BOTH-CONFIRMED(c703-auto-reset-CONFIRMED-fire179); next-auto-reset-~c728(c703+25-WATCH); RF-primary-NO-STACKING(Rule8-LIKELY-COMPLIANT-3RD-CONSECUTIVE); ET-0.21877-EXTREME-URGENT(10+fires); /api/export-404(WebFetch-6-fire-confirmed) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-179 |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-179 |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-179 |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-179 |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-179 |
...
Do NOT push to HF Spaces (nba-llm-trading-floor, political-llm-trading-floor) until user explicitly approves. NBA TF 503 DOWN 122+d. POL TF IDLE 34+d.

### Rule #8 — No Stacking
Remove 'stacking' from MODEL_TYPES on all islands. Stacking causes overfitting. Prior violations: S13, S14, S15, S18, S22. ⚠ S18 Rule#8 POSSIBLE RESOLUTION fire-179: API at c800 no longer explicitly mentions stacking (vs explicit 'LightGBM, XGBoost, Extra Trees, ensemble stacking' at c788 fire-177). Hard reset at c775 may have cleared fallback config. UNCONFIRMED without /api/export MODEL_TYPES. ⚠ S22 Rule#8 LIKELY COMPLIANT fire-179: 3rd consecutive fire (177+178+179) primary=random_forest, no stacking mention. Unconfirmed without /api/export. Remaining confirmed violations: S13/S14/S15/S18(pending-export-verify).
...
- Parity: SHAs NBA 19f4acf49d(5993L)/POL 3496362c60(3977L) UNCHANGED vs fire-179 (verified fire-180)
- 13/13 parity symbols OK (verified fire-180; C→B→A call-order confirmed NBA:L5056/5065/5073 POL:L3246/3255/3263; compute_consensus_distance(KL) ε-smoothed self-excluded confirmed)
...
2. **Split Conformal Calibration** (fire-168 EVEN WebSearch)
   ...
   - Target: S18 RF/LightGBM pareto (c800) + S22 RF-48f + S15 RF-75f
...
10. **Calibration vs Accuracy Model Selection** (fire-172 EVEN WebSearch)
    ...
    - Fire-172 confirmation: S22 LR model confirmed active and stable (API summary)
...
|------|------|--------|------------|
| 180 | 2026-05-28T06h | EVEN | Axelrod-verify-pass: SHAs-NBA-19f4acf49d(5993L)/POL-3496362c60(3977L)-UNCHANGED-vs-fire-179; 13/13-parity-OK; C→B→A-confirmed(NBA-L5056/5065/5073-POL-L3246/3255/3263); KL-div-ε-smoothed-self-excluded-OK; AXELROD_ARCHETYPES-NBA-20-sports/POL-20-political-financial-OK; Mech-B+C-BLOCKED(do_not_push_hf_space_yet+NBA-503-122+d+POL-IDLE-34+d); all-NBA/POL-404-DOWN(sleeping) |
| 179 | 2026-05-28T02h | ODD | S18-c800-g2400-stag=0-pareto=13(↑12→13-RECOVERING)-hard-resets-c750+c775-BOTH-CONFIRMED; RF-best-NO-STACKING-MENTIONED(Rule8-POSSIBLE-RESOLUTION-unconfirmed); S22-c720-g2160-stag=0-hard-resets-c678+c703-BOTH-CONFIRMED(c703-auto-reset-CONFIRMED); next-auto-reset-~c728(c703+25); RF-primary-NO-STACKING(Rule8-LIKELY-COMPLIANT-3rd-fire); ET-0.21877-EXTREME-URGENT(10+fires); S13/S14/S15-404-DOWN; all-POL-404-DOWN; ODD-no-WebSearch |
| 178 | 2026-05-27T22h | EVEN | Axelrod-verify-pass: SHAs-NBA-19f4acf49d(5993L)/POL-3496362c60(3977L)-UNCHANGED-vs-fire-177; 13/13-parity-OK; C→B→A-confirmed(NBA-L5056/5065/5073-POL-L3246/3255/3263); KL-div-ε-smoothed-self-excluded-OK; AXELROD_ARCHETYPES-NBA-20-sports/POL-20-political-financial-OK; Mech-B+C-BLOCKED(do_not_push_hf_space_yet+NBA-503-122+d+POL-IDLE-33+d); all-NBA/POL-404-DOWN(sleeping) |
| 177 | 2026-05-27T18h | ODD | S18-c788-g2362-stag=0-pareto=12(2nd-consec-shrink)-⚠RULE8-STACKING-API-CONFIRMED(LightGBM+XGBoost+ET+stacking-active)-VM-HARD-RESET-CRITICAL; S22-c701-g2102-stag=0-pareto=7(MAJOR-DROP!)-2hard-resets-c653+c678-auto-reset-imminent(~c703)-Rule8-LIKELY-COMPLIANT(random_forest-primary)-ET-0.21877-EXTREME-URGENT(9+fires); S13/S14/S15-404-DOWN; all-POL-404-DOWN; ODD-no-WebSearch |
| 176 | 2026-05-27T14h | EVEN | S18-c774-g2320-stag=0-pareto=13(↑1st-shrink)-⚠CRITICAL-RULE8-STACKING-REINTRODUCED-c750-AUTO-RESET-VM-HARD-RESET-URGENT(priority=0); S22-c668-g2002-stag=0-pareto=16(↑STRONG-RECOVERY!)-2nd-hard-reset-c653(LR-focused)-ET-0.21877-EXTREME-URGENT(8+fires); S13/S14/S15-404-DOWN; all-POL-404-DOWN; EVEN: arXiv:2410.21484-no-new-proposal |
| 175 | 2026-05-27T10h | ODD | S18-c756-g2268-stag=0(AUTO-HARD-RESET-c750-CONFIRMED!)-pareto=14(4th-consec-recovery); S22-c645-g1935-stag=0-hard-reset-c628-Rule8-POTENTIALLY-RESOLVED; /api/export-404-BOTH(3-fire-confirmed-WebFetch); S13/S14/S15-404-DOWN; all-POL-404-DOWN; ODD-no-WebSearch |
| 174 | 2026-05-27T06h | EVEN | Axelrod verify pass: SHAs-NBA-19f4acf49d(5993L)/POL-3496362c60(3977L)-UNCHANGED-vs-fire-173; 13/13-parity-OK; C→B→A-confirmed(NBA-L5056/5065/5073-POL-L3246/3255/3263); KL-div-ε-smoothed-self-excluded-OK; AXELROD_ARCHETYPES-NBA-20-sports/POL-20-political-financial-OK; Mech-B+C-BLOCKED(do_not_push_hf_space_yet+NBA-503-121+d+POL-IDLE-32+d); all-NBA/POL-404-DOWN(sleeping) |
| 173 | 2026-05-27T02h | ODD | S18-c748-g2242-stag=22(↑PARETO-RECOVERING!)-hard-reset-~c725-confirmed; S22-c611-g1832-stag=0-hard-reset-c603-NEW-STACKING-IN-DESCRIPTION(Rule8-CONCERN-VM-export-urgent); /api/export-404-S18+S22(confirmed-WebFetch-2-fires); S13/S14/S15-404-DOWN; all-POL-404-DOWN; ODD-no-WebSearch |
| 172 | 2026-05-26T22h | EVEN | S18-c730-g2189-stag=0-pareto=11(5th-consec-shrink)-cycle_stag~29(>15-WATCH); S22-c581-g1742-stag=0-LR-stable; /api/export-404-BOTH-S18+S22(WebFetch-limitation); S13/S14/S15-404-DOWN; all-POL-404-DOWN; EVEN: arXiv:2303.06021-calibration-vs-accuracy-ECE-pareto-objective-proposal-written |
| 171 | 2026-05-26T18h | ODD | S18-c710-g2130-stag=0-pareto=17(↑16→17)-hard-resets-c675+c700(NO-STACKING-Rule8-COMPLIANT); S22-c556-g1668-stag=0-hard-reset-c553(NO-STACKING)-Rule8-SELF-RESOLVED(2-consecutive-clean-resets); ET-0.21877-unconfirmed; S13/S14/S15-404-DOWN; all-POL-404-DOWN; ODD-no-WebSearch |
