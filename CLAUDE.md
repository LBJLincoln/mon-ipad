...
HF EVOLUTION ISLANDS — 11 SURVIVORS (6 NBA + 5 POL) after 2026-04-17 cull
    ...
    ├── S13 Nomos42/nba-evo-4:        xgboost_brier       gen=2205  brier=0.22216  stagnation=0  ✓ cycle=735; stag=0 pareto=7(↓13→7); ⚡⚡CATBOOST-200f-0.22076-PARETO-1ST-DETECT(gen=2201,BELOW-0.22085-THRESHOLD-VM-CHECKPOINT-EXTREME-URGENT); vm-remove-stacking-s13 URGENT (2026-05-21T20h)
    ├── S14 Nomos42/nba-evo-5:        extra_trees         gen=660   brier=0.22793  stagnation=0  ✓ cycle=220; stag=0-CLEARED(hard-reset-c203,was-19); pareto=7(↓10→7) ET-200f-pareto_best=0.22170; vm-checkpoint-s14-et PENDING (2026-05-21T20h)
    ├── S15 Nomos42/nba-evo-6:        rf/et               gen=5897  best=0.22012   stagnation=0  ✓ cycle=1966; ★ FLEET BEST 0.22012; pareto=11(↓14→11) ET-200f-0.220-in-pareto pareto_best=0.22023-VM-CHECKPOINT-URGENT; vm-checkpoint-s15-et-0.21888 URGENT (2026-05-21T20h)
    ├── S17 LBJLincoln26/nba-evo-s17: ---                 gen=---   brier=---      🔴 503 DOWN 103+ days — VM RESTART REQUIRED (2026-05-21T20h)
    ├── S18 TESTforge42/nba-evo-s18:  ---                 gen=---   brier=---      ⚠ SSL-CERT-ERROR(certificate-not-yet-valid,likely-new-restart); prev c207 g619 brier=0.22236; vm-s18-ssl-cert-error-fire143 ADDED (2026-05-21T20h)
    └── S22 TESTforge42/nba-evo-s22:  random_forest       gen=317   brier=0.22124  stagnation=0  ✓ cycle=106; stag=0-CLEARED(hard-reset-c103,was-16); pareto=11(↑7→11-EXCELLENT); RF-48f; vm-checkpoint-s22 PRIORITY=1 (2026-05-21T20h)
    Political Survivors (5, CPU tree-only):
    ├── P1 Nomos42/political-alpha:      xgboost_brier       gen=10347  brier=0.24987 stagnation=0  ✓ cycle=3449; pareto=6(↓7→6); pareto_best=0.24927-VM-CHECKPOINT-URGENT; POL-FLEET-BEST-now-P4(0.2497<0.24987) (2026-05-21T20h)
    ├── P2 Nomos42/political-alpha-2:    xgboost_brier       gen=60341  brier=0.25003 stagnation=0  ✓ cycle=20114; pareto=6(↓13→6-SHRINK-WATCH) gen-milestone-60k+ (2026-05-21T20h)
    ├── P4 LBJLincoln/political-alpha-4: lightgbm            gen=3939   brier=0.2497  stagnation=0  ✓★ cycle=1313; ★★POL-FLEET-BEST(↑FROM-0.25337-MAJOR-IMPROVEMENT); pareto=11(↑10→11) ⚡pareto_best=0.2492-NEW-POL-ALL-TIME-PARETO-RECORD-1ST-DETECT; vm-checkpoint-p4-lgbm-0.2492-EXTREME-URGENT (2026-05-21T20h)
    ├── P5 LBJLincoln/political-alpha-5: xgboost_brier       gen=80876  brier=0.24993 stagnation=0  ✓ cycle=26959; pareto=6(↑5→6) LightGBM-102f-0.249-stable (2026-05-21T20h)
    └── P7 LBJLincoln/political-alpha-7: lightgbm            gen=18712  brier=0.25004 stagnation=0  ✓ cycle=6238; pareto=10(↓12→10); LightGBM-112f-0.24931-CONFIRMED-stable; vm-checkpoint-p7-lgbm EXTREME-URGENT priority=1 (2026-05-21T20h)
```
