...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-192 (26+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-192 |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST stable gen=6672 pareto=13 — SLEEPING fire-192 |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 130+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c1046 g3136 stag~0 pareto=16(↑11↑16-MAJOR-RECOVERING!); Rule8-10TH-VIOLATION-CONFIRMED(c1000+c1025-BOTH-reintroduced-stacking-LightGBM-dominant-c1046); next-~c1050(4cycles-IMMINENT); best_brier=0.22236-STALE(since-2026-05-25-5+days); ET-0.21845-PRESUMED-LOST; VM: diff-S22-vs-S18-app.py-for-fix-reference; /api/export-404(WebFetch-16-fire-confirmed) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c1003 g3007 stag=0 pareto=12(STABLE); c978+c1003-CONFIRMED(c953+25=c978,c978+25=c1003-stag_cycles=24-at-c1002-reset-triggered); Rule8-COMPLIANT(no-stacking-fire191-LR/XGB/LightGBM/CatBoost/RF); next-~c1028(25cycles); /api/export-404(WebFetch-16-fire-confirmed) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-192 |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-192 |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-192 |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-192 |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-192 |
...
- Parity: SHAs NBA 19f4acf49d(SHA-verified)/POL 3496362c60(SHA-verified) UNCHANGED (SHA-verified fire-192)
- 13/13 parity symbols OK (verified fire-192; C→B→A call-order confirmed NBA:L5056/5065/5073 POL:L3246/3255/3263; compute_consensus_distance(KL) ε-smoothed self-excluded confirmed)
- Mech-B+C-BLOCKED: do_not_push_hf_space_yet + NBA-503-130+d + POL-IDLE-40+d
...
2. **Split Conformal Calibration** (fire-168 EVEN WebSearch)
   ...
   - Target: S18 RF/ET pareto (c1046) + S22 RF-48f + S15 RF-75f
...
|------|------|--------|------------|
| 192 | 2026-05-30T06h | EVEN | S18-c1046-carry-fire191(next-~c1050-IMMINENT-Rule8-10TH-VIOLATION-stacking-ACTIVE); S22-c1003-carry-fire191-pareto=12(STABLE-Rule8-COMPLIANT)-next-~c1028(25cycles); S13/S14/S15-404-DOWN(26+fires); all-POL-404-DOWN(26+fires); EVEN: arXiv:2406.04062-Online-Learning-Betting-Markets-Profit-vs-Prediction(ICML2024)-profit≠accuracy-KL-div-consensus-validated; Axelrod-pass(SHAs-NBA-19f4acf49d/POL-3496362c60-UNCHANGED); Mech-B+C-BLOCKED(do_not_push_hf_space_yet+NBA-503-130+d+POL-IDLE-40+d) |
...
| 186 | 2026-05-29T06h | EVEN | Axelrod-verify-pass: SHAs-NBA-19f4acf49d(5993L)/POL-3496362c60(3977L)-UNCHANGED-vs-fire-185; 13/13-parity-OK; Mech-B+C-BLOCKED(do_not_push_hf_space_yet+NBA-503-125+d+POL-IDLE-37+d); all-NBA/POL-404-DOWN(sleeping) |
