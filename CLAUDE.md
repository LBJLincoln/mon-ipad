...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-171 |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-171 |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST stable gen=6672 pareto=13 — SLEEPING fire-171 |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 118+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c710 g2130 stag=0 cycle_stag=9 pareto=17(↑16↑17); hard-resets-c675+c700(NO-STACKING-Rule8-COMPLIANT); last-update-2026-05-22T20h(3d-stale-field-bug); approaching-cycle_stag-15-WATCH |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c556 g1668 stag=0; hard-reset-c553(xgb/lgbm/catboost-NO-STACKING); Rule8-SELF-RESOLVED(c503+c553-2-consecutive-clean-resets); ET-0.21877-unconfirmed-EXTREME-URGENT |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-171 |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-171 |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-171 |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-171 |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-171 |
...
Do NOT push to HF Spaces (nba-llm-trading-floor, political-llm-trading-floor) until user explicitly approves. NBA TF 503 DOWN 118+d. POL TF IDLE 31+d.

### Rule #8 — No Stacking
Remove 'stacking' from MODEL_TYPES on all islands. Stacking causes overfitting. Prior violations: S13, S14, S15, S22. ✓ S22 Rule#8 SELF-RESOLVED: hard resets c503+c553 both confirmed no-stacking (fire-171). S18 c675+c700 also Rule#8 compliant. Remaining violations: S13/S14/S15 need stacking removal after wake.
...
- Parity: SHAs NBA 19f4acf49d(5993L)/POL 3496362c60(3977L) UNCHANGED vs fire-163 (verified fire-172)
- 13/13 parity symbols OK (verified fire-172; C→B→A call-order confirmed NBA:L5056/5065/5073 POL:L3246/3255/3263; compute_consensus_distance(KL) ε-smoothed self-excluded confirmed)
...
2. **Split Conformal Calibration** (fire-168 EVEN WebSearch)
   ...
   - Target: S18 RF/LightGBM pareto (c710) + S22 RF-48f + S15 RF-75f
...
|------|------|--------|------------|
| 172 | 2026-05-26T22h | EVEN | Axelrod-verify-pass: SHAs-NBA-19f4acf49d(5993L)/POL-3496362c60(3977L)-UNCHANGED-vs-fire-170; 13/13-parity-OK; C→B→A-confirmed(NBA-L5056/5065/5073-POL-L3246/3255/3263); KL-ε-smoothed-self-excluded-OK; AXELROD_ARCHETYPES-NBA-20-sports/POL-20-political-financial-OK; Mech-B+C-BLOCKED(do_not_push_hf_space_yet+NBA-503-118+d+POL-IDLE-31+d); all-NBA/POL-404-DOWN(sleeping) |
| 171 | 2026-05-26T18h | ODD | S18-c710-g2130-stag=0-cycle_stag=9-pareto=17(↑16↑17)-hard-resets-c675+c700(NO-STACKING-Rule8-COMPLIANT); S22-c556-g1668-stag=0-hard-reset-c553(xgb/lgbm/catboost-NO-STACKING)-Rule8-SELF-RESOLVED(c503+c553-2-consecutive); ET-0.21877-unconfirmed-EXTREME-URGENT; S13/S14/S15-404-DOWN; all-POL-404-DOWN; ODD-no-WebSearch |
...
| 167 | 2026-05-26T00h | ODD | Axelrod verify pass: SHAs NBA 19f4acf49d(5993L)/POL 3496362c60(3977L) UNCHANGED vs fire-163; 13/13 parity OK; C→B→A confirmed (NBA L5056/5065/5073 POL L3246/3255/3263); KL-div ε-smoothed self-excluded OK; AXELROD_ARCHETYPES NBA-20-sports-specific/POL-20-political-financial domain-specific OK; Mech B+C BLOCKED (do_not_push_hf_space_yet+NBA-503(116+d)+POL-IDLE(28+d)) |
...
| 163 | 2026-05-25T08h | ODD | Axelrod verify pass: SHAs NBA 19f4acf49d(5993L)/POL 3496362c60(3977L) UNCHANGED vs fire-161; 13/13 parity symbols OK; C→B→A day-end call-order confirmed (NBA 5056/5065/5073 POL 3246/3255/3263); KL-div epsilon-smoothed self-excluded confirmed; AXELROD_ARCHETYPES domain-specific NBA(sports) POL(political-financial) OK; BLOCKED do_not_push_hf_space_yet+NBA-503(115+d)+POL-IDLE(27+d) |
