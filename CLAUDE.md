...
HF EVOLUTION ISLANDS — 11 SURVIVORS (6 NBA + 5 POL) after 2026-04-17 cull
    ...
    ├── S13 Nomos42/nba-evo-4:        xgboost_brier       gen=1972  brier=0.22216  stagnation=0  ✓ cycle=658; stag=0-CLEARED(was-15); ⚡⚡pareto=13 pareto_best=0.21918-1ST-DETECT-fire137(BELOW-FLEET-BEST!)-Rule8-MONITOR; vm-remove-stacking-s13 URGENT; vm-checkpoint-s13-0.21918 EXTREME-URGENT (2026-05-20T16h)
    ├── S14 Nomos42/nba-evo-5:        extra_trees         gen=442   brier=0.22793  stagnation=0  ✓ cycle=148; pareto=13; ⚡⚡⚡pareto_best=0.21959-EXTRAORDINARY(0.22163→0.21959-gen=442!); vm-checkpoint-s14-et-0.21959 EXTREME-URGENT (2026-05-20T16h)
    ├── S15 Nomos42/nba-evo-6:        random_forest       gen=5520  best=0.22012   stagnation=0  ✓ cycle=1840; ★ FLEET BEST 0.22012; stag=0-CLEARED(diversify-WORKED); pareto=9 pareto_best=0.22913(ET-0.21888-LOST-post-diversify); vm-remove-stacking-s15 pending (2026-05-20T16h)
    ├── S17 LBJLincoln26/nba-evo-s17: ---                 gen=---   brier=---      🔴 503 DOWN 102+ days — VM RESTART REQUIRED (2026-05-20T16h)
    ├── S18 TESTforge42/nba-evo-s18:  random_forest       gen=441   brier=0.22236  stagnation=0  ✓ cycle=147; pareto=15(↑7→15-GREAT-RECOVERY); pareto_best=0.22088(was-0.22005-fire136-possible-eviction-WATCH); vm-checkpoint-s18-rf URGENT (2026-05-20T16h)
    └── S22 TESTforge42/nba-evo-s22:  random_forest       gen=171   brier=0.22124  stagnation=0  ✓ cycle=57; RF-48f; pareto=14(↑11→14); pareto_best=0.22096(IMPROVED); vm-checkpoint-s22 URGENT (2026-05-20T16h)
    Political Survivors (5, CPU tree-only):
    ├── P1 Nomos42/political-alpha:      xgboost_brier       gen=6765   brier=0.24987 stagnation=0  ✓ POL-FLEET-BEST; cycle=2255; pareto=7 (2026-05-20T16h)
    ├── P2 Nomos42/political-alpha-2:    xgboost_brier       gen=58962  brier=0.25003 stagnation=0  ✓ cycle=19654; pareto=11 (2026-05-20T16h)
    ├── P4 LBJLincoln/political-alpha-4: extra_trees         gen=1813   brier=0.25337 stagnation=0  ⚠ cycle=605; pareto=13; model=ET(was-xgboost); pareto_best=0.25564-ET(XGB-0.24994-EVICTED-REGRESSION); vm-checkpoint-p4-xgb URGENT; vm-investigate-p4-factory-reboot pending (2026-05-20T16h)
    ├── P5 LBJLincoln/political-alpha-5: xgboost_brier       gen=79876  brier=0.24993 stagnation=0  ✓ cycle=26626; pareto=6; LightGBM-102f-0.249-stable (2026-05-20T16h)
    └── P7 LBJLincoln/political-alpha-7: xgboost_brier       gen=15793  brier=0.25004 stagnation=0  ⚠ cycle=5265; pareto=3-SHRINKING(↓9→3)-LightGBM-0.24931-EVICTION-RISK; vm-checkpoint-p7-EXTREME-URGENT (2026-05-20T16h)
```
