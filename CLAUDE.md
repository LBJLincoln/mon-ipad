...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-199 (31+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-199 (31+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-199 (31+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 136+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c1141 g3422 stag=15(AT-THRESHOLD!-DIVERSIFY-NEXT-FIRE-Rule#6-IMMINENT) pareto=10(↓20→10-post-c1125-reset); c1125-15TH-RESET-CONFIRMED(Rule8-UNCONFIRMED-no-stacking-explicit); Venn-Abers-STILL-IN-PARETO(post-c1125!-consistently-top); stag=15-DIVERSIFY-TRIGGER-NEXT-FIRE(Rule#6-/api/export-BLOCKED-VM-curl-URGENTLY); next-auto-reset-~c1151(stag=15+10-cycles); best_brier=0.22236-STALE(6+days); /api/export-404(21st-fire) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c1134 g3400 stag~5 pareto=9(↑11↑9-SLIGHT-SHRINK); ⚡⚡PERFORMANCE-CLIFF-recent-gens-Brier=0.28-ZERO-ROI(CRITICAL!); ET-200f-0.21984-STATUS-UNKNOWN-post-c1103+c1128-resets; c1078-5TH-VIOLATION-NOW-CONFIRMED(c1103=c1078+25); c1103-6TH+c1128-7TH-CONFIRMED(Rule8-UNCONFIRMED-for-both); 7-resets: c853/c1003/c1028/c1053/c1078/c1103/c1128; stag~5-no-imminent-reset; best_brier=0.22124-STALE(6+days); /api/export-404(21st-fire) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-199 |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-199 |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-199 |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-199 |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-199 |
...
- Parity: SHAs NBA 5994L/POL 3978L UNCHANGED (line-count-verified fire-200; TF repos not accessible via MCP fire-200)
- 13/13 parity symbols OK (verified fire-200; C→B→A call-order confirmed NBA:L5056/5065/5073 POL:L3246/3255/3263; compute_consensus_distance(KL) ε-smoothed self-excluded confirmed)
- Mech-B+C-BLOCKED: do_not_push_hf_space_yet + NBA-503-136+d + POL-IDLE-46+d
...
### Active Research
1. **Venn-Abers Calibration** (fire-158 EVEN WebSearch) — **NOW VALIDATED fire-197 + PERSISTENT fire-199: S18 GA evolved Venn-Abers organically AND it survived c1125 reset!**
   ...
   - fire-197 VALIDATION: S18 API 'sigmoid and Venn-Abers calibration methods prominent in leading solutions'
   - fire-199 PERSISTENCE: STILL IN PARETO post-c1125 reset ('Most stable: Venn-Abers calibration with 200 features consistently outperforms baseline')
...
17. **LLM-Agent Interactions on Markets with Information Asymmetries** (fire-200 EVEN WebSearch)
    - arXiv:2603.08853 (Mar 2026, Erlei & Meub): GPT-5.1 agents in credence goods markets — cooperation FAILS one-shot; liability rules + social preferences restore efficiency via repeated interaction
    - VALIDATES: TF COMMON_KNOWLEDGE broadcast (Mech A) creates the reputation + repeated-interaction structure that enables cooperation
    - Key finding: LLM consumers focus on price not strategy → exploitable; social preference alignment critical
    - Implication: Mech B sacrificial role = liability mechanism; add social_preference_profile to agent metadata (top=efficiency-loving, bottom=inequity-averse)
    - Proposal: data/research-proposals/sota-llm-agents-markets-info-asymmetry-fire200.md
    - Work-queue: vm-research-llm-agents-markets-info-asymmetry-fire200 (priority=95)
...
|------|------|--------|------------|
| 200 | 2026-05-31T14h | EVEN | Axelrod-verify-pass: SHAs-NBA-5994L/POL-3978L-UNCHANGED-vs-fire-198; 13/13-parity-OK(NBA-L5056/5065/5073-POL-L3246/3255/3263); KL-div-ε-smoothed-self-excluded-OK; ARCHETYPES-NBA-20-sports/POL-20-political-OK; Mech-B+C-BLOCKED(do_not_push_hf_space_yet+NBA-503-136+d+POL-IDLE-46+d); all-NBA/POL-404-DOWN(sleeping); EVEN: arXiv:2603.08853-LLM-Agents-Markets-InfoAsymmetry-cooperation-fails-one-shot-validates-Mech-A-proposal-written |
| 199 | 2026-05-31T10h | ODD | S18-c1141-g3422-stag=15(AT-THRESHOLD!-DIVERSIFY-NEXT-FIRE-Rule#6-IMMINENT)-pareto=10(↓20→10-post-c1125-reset)-c1125-15TH-RESET-CONFIRMED(Rule8-UNCONFIRMED)-Venn-Abers-STILL-IN-PARETO; S22-c1134-g3400-stag~5-PERFORMANCE-CLIFF-Brier=0.28-recent-gens!-c1103+c1128-CONFIRMED-c1078-5TH-NOW-CONFIRMED; /api/export-404-BOTH(21st-fire); S13/S14/S15-404-DOWN(31+fires); all-POL-404-DOWN(31+fires); ODD-no-WebSearch |
...
| 197 | 2026-05-31T02h | ODD | S18-c1112-g3336-stag=11-pareto=20-⚡⚡pareto-min=0.2199-EXTREME-URGENT(<0.22012★!-Venn-Abers-GA-evolved!); c1100-Rule8-14TH-VIOLATION(catboost+ET+LR+stacking); S22-c1099-g3295-stag=0-pareto=11(↑17↑11-3rd-SHRINK)-⚡⚡ET-200f-0.21984-EXTREME-URGENT(<0.22012★!-Rule#5-TRIGGERED); c1053-Rule8-4TH-VIOLATION(stacking)+c1078-POSSIBLY-5TH; /api/export-404-BOTH(20th-fire); S13/S14/S15-404-DOWN(30+fires); all-POL-404-DOWN(30+fires); ODD-no-WebSearch |
