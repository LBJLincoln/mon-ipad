...
HF EVOLUTION ISLANDS — 11 SURVIVORS (6 NBA + 5 POL) after 2026-04-17 cull
    ...
    ├── S13 Nomos42/nba-evo-4:        xgboost_brier       gen=1909  brier=0.22216  stagnation=0  ✓ cycle=637; hard-reset-c604; PARETO-0.21984-MONITORING(pareto=12-grew-from-7,stacking-likely,best_brier-unchanged-confirms-Rule8-exclusion); vm-remove-stacking-s13 URGENT (2026-05-20T02h)
    ├── S14 Nomos42/nba-evo-5:        extra_trees         gen=338   brier=0.22793  stagnation=0  ✓ cycle=113; internal-hard-reset-c78; pareto=14; lightgbm-in-pool(gen337-confirmed) (2026-05-20T02h)
    ├── S15 Nomos42/nba-evo-6:        random_forest       gen=5399  best=0.22012   stagnation=0  ✓ cycle=1800; ★ FLEET BEST 0.22012; pareto=5(↓from-14-normal-pruning) (2026-05-20T02h)
    ├── S17 LBJLincoln26/nba-evo-s17: ---                 gen=---   brier=---      🔴 503 DOWN 100+ days — VM RESTART REQUIRED (2026-05-20T02h)
    ├── S18 TESTforge42/nba-evo-s18:  random_forest       gen=365   brier=0.22236  stagnation=0  ✓ cycle=122; stag=0; pareto=14(↑from-5-GREAT-RECOVERY) RF-44f (2026-05-20T02h)
    └── S22 TESTforge42/nba-evo-s22:  random_forest       gen=132   brier=0.22124  stagnation=0  ✓ cycle=44; RF-48f; pareto=9; REMARKABLE-0.22124-stable; vm-checkpoint-s22 PRIORITY=1 (2026-05-20T02h)
    Political Survivors (5, CPU tree-only):
    ├── P1 Nomos42/political-alpha:      xgboost_brier       gen=5334   brier=0.24987 stagnation=0  ✓ POL-FLEET-BEST; cycle=1778; pareto=9(↑from-8); status=SAVING-transient (2026-05-20T02h)
    ├── P2 Nomos42/political-alpha-2:    xgboost_brier       gen=58535  brier=0.25003 stagnation=0  ✓ cycle=19512; pareto=6 (2026-05-20T02h)
    ├── P4 LBJLincoln/political-alpha-4: extra_trees         gen=1307   brier=0.25337 stagnation=0  ✓ cycle=436; pareto=6; ⚡⚡pareto_best=0.24982-XGB-136f-gen621-CONFIRMED(was-0.24998-1st-detect-fire130); vm-checkpoint-p4-xgb-URGENT-PRIORITY=1; vm-investigate-p4-factory-reboot pending (2026-05-20T02h)
    ├── P5 LBJLincoln/political-alpha-5: xgboost_brier       gen=79428  brier=0.24993 stagnation=0  ✓ cycle=26476; pareto=4; LightGBM-102f-0.249-stable (2026-05-20T02h)
    └── P7 LBJLincoln/political-alpha-7: xgboost_brier       gen=14439  brier=0.25004 stagnation=0  ✓ cycle=4813; pareto=6; LightGBM-112f-0.24931-CONFIRMED-stable; vm-checkpoint-p7-lgbm-0.24931 URGENT priority=1 (2026-05-20T02h)
```
