...
| S18 | TESTforge42/nba-evo-s18 | EVOLVING | 0.22326 | **fire-231**: c=246 g=736 stag=0 pareto=5(↓16→5-SEVERE-COLLAPSE!). c242=6TH-AUTO-RESET-CONFIRMED(c217+25=c242-EXACT). best_brier=0.22326 plateau. /api/export-404(10th). Next reset ~c267(21cy). CRITICAL: pareto=5 post-c242. VM: fix reset_pool EXCLUDE stacking before c267; curl /api/export S18 urgently. |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | **fire-231** ⚡⚡⚡ALL-TIME CANDIDATE ALIVE(3rd-fire): c=1671 g=5013 stag=0 pareto=12(↓15→12). 200f-0.21880 gen=4960 BELOW FLEET BEST 0.22012 by 13bp! Rule8 CLEAN. /api/export-404(48th). Next reset ~c1680(9cy-away-stag=0-SAFE). VM: curl /api/export S22 IMMEDIATELY — checkpoint 200f-0.21880! EXTREME URGENT! |
