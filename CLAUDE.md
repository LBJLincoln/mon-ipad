...
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-249 (75+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 144+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | EVOLVING | 0.22326 | **fire-249**: c=677 g=2030 stag=9(↑0→9-BUILDING!) pareto=13(↑12→13). 22ND-RESET-c667-CONFIRMED. **RULE8-VIOLATION: stacking-37f-0.24738 rank-0 in pareto!** ET-200f-0.22040 BELOW 0.22085 — CHECKPOINT-URGENT! stag=9(threshold=15-MONITOR!). /api/export-404(26th-CRITICAL). Next reset ~c692(c667+25=c692, 15 cycles). VM: REMOVE stacking IMMEDIATELY + FIX /api/export. |
| S22 | TESTforge42/nba-evo-s22 | EVOLVING | 0.21983 | **fire-249**: c=58 g=172 stag=4(↑0→4) pareto=18(↑15→18-FAST-GROWING!). 2ND-RESET-c53-CONFIRMED(c28+25=c53-EXACT). **⚡EXTREME URGENT: ET-200f-0.21983 POTENTIAL NEW NBA FLEET BEST! (2.9bp below 0.22012!)** **RULE8-ESCALATION: stacking-47f×2 entries rank-0 in pareto** (stacking DOUBLED fire-248→249). ET-200f-0.22028 also below 0.22085. /api/export-404(5th-new-run-CRITICAL). Next reset ~c78(c53+25=c78, 20 cycles). VM: (1) REMOVE stacking IMMEDIATELY before ~c78, (2) checkpoint ET-200f-0.21983 URGENTLY. |
...
- Parity: SHAs NBA 85e7682e1d(6035L)/POL 6983c86517(4019L) carry-forward fire-249 (fire-245 was last direct-verify: 25/25 parity OK, KL-div OK). HF hub shows both spaces Updated:1Jun2026. Next direct verify: fire-251 ODD.
...
|------|------|--------|------------|
| 249 | 2026-06-08T20h | ODD | S18-c677-g2030-stag=9(↑0→9-BUILDING!)-pareto=13(↑12→13)-RULE8-VIOLATION:stacking-37f-0.24738-rank0-ET-200f-0.22040-BELOW-0.22085-CHECKPOINT-URGENT!-/api/export-404(26th)-next-reset~c692; S22-c58-g172-stag=4(↑0→4)-pareto=18(↑15→18-FAST-GROWING!)-EXTREME-URGENT:ET-200f-0.21983-POTENTIAL-NEW-FLEET-BEST!(2.9bp-below-0.22012!)-RULE8-ESCALATION:stacking-47f×2-in-pareto!-/api/export-404(5th-new-run-CRITICAL)-next-reset~c78; S13/S14/S15+POL-404-DOWN(75+fires); ODD: Axelrod-carry-forward-SHAs-NBA-85e7682e1d(6035L)/POL-6983c86517(4019L)-HF-hub-Updated:1Jun2026-direct-verify-deferred-fire251 |
