...
> Architecture v21 — "The Trading Floor Crew" (14 agents × 9 depts × 4 tracks) + TF v3 (17 LLM agents) + 21 Evolution Islands | Updated: 2026-06-05T12h
...
| S15 | Nomos42/nba-evo-6 | 404-DOWN | 0.22342 | **fire-273**: Back to 404-DOWN (went back to sleep after fire-272 4th wakeup). Monitor for 5th wakeup. |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 144+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | EVOLVING | 0.22326 | **fire-273**: c=892 g=2676 stag=0. **37TH-RESET-c892-CONFIRMED (c867+25=c892-EXACT)**. ET-0.21943 EVICTED at c892. brier_trend=0.24738 ALL entries — RULE8-VIOLATION: stacking re-dominates. **38TH RESET ~c917 (25cy)**. VM: REMOVE stacking from app.py MODEL_TYPES/reseed pool IMMEDIATELY. |
| S22 | TESTforge42/nba-evo-s22 | EVOLVING | 0.2207 | **fire-273**: c=273 g=817 stag=0 pareto=12. ⚡⚡ **ET/RF-200f-0.2191 LIVE (8.1bp below fleet best 0.22012!)**. brier_trend=0.23104 — **RULE8-CLEAN POST-10TH-RESET-c253 CONFIRMED** (first S22 run with clean reseed!). **11TH RESET ~c278 IMMINENT (5cy ~1.1h)**. /api/export-404 (49+). VM: checkpoint ET/RF-0.2191 direct pickle save IMMEDIATELY before ~c278. |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | RULE9 RESOLVED fire-256. SLEEPING 87+ fires. |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.24903 | **fire-263**: 404-DOWN (87+ fires). history brier=0.24903 BELOW POL GATE 0.2497 — CHECKPOINT URGENT! RULE9 RESOLVED. VM: confirm checkpoint saved. |
| P4 | lbjlincoln/political-alpha-4 | EVOLVING | 0.2497★ | **fire-273**: c=3019. **pareto=2 CRITICAL COLLAPSE**. RULE9-VIOLATION-PERSISTS (no LightGBM). LR-0.2499 in pareto (2bp from POL gate!). VM: add LightGBM IMMEDIATELY — pareto=2 will die. |
| P5 | lbjlincoln/political-alpha-5 | EVOLVING | 0.24994 | **fire-273**: c=1383. **RULE9 VIOLATION**: LGB ABSENT (catboost_specialist dominates). REGRESSION from fire-268 resolution at c502. VM: add LightGBM to MODEL_TYPES IMMEDIATELY. |
| P7 | lbjlincoln/political-alpha-7 | EVOLVING | 0.25331 | **fire-273**: c=65 g=195 stag=12. FRESH RESTART (3rd total wipe). **RULE9 VIOLATION** (NO LightGBM — XGB-0.24994 gen3 best). **stag=12 — DIVERSIFY THRESHOLD IN 3cy!** VM: (1) save XGB-0.24994 pickle IMMEDIATELY, (2) add LightGBM to MODEL_TYPES. |
...
### MODEL_TYPES Status
| Island | Current (fire-272) | Status |
|--------|---------|--------|
| P1 | extra_trees, xgboost_brier, lightgbm_brier, lightgbm | ✅ RULE9 RESOLVED fire-256 — 404-DOWN 95+ fires |
| P2 | lightgbm is best (xgboost, lightgbm, catboost, xgboost_brier) | ✅ RESOLVED fire-255 — 404-DOWN 95+ fires |
| P4 | xgboost_brier best (c3019) — NO lightgbm | ⚠️ VIOLATION PERSISTS fire-273 — pareto=2 CRITICAL COLLAPSE — EVOLVING (VM: add LightGBM IMMEDIATELY) |
| P5 | LGB ABSENT at c=1383 (catboost_specialist) | ⚠️ RULE9 VIOLATION fire-273 (REGRESSION from resolution fire-268). VM: add LightGBM IMMEDIATELY |
| P7 | FRESH RESTART c=65, stag=12, XGB-0.24994 gen3 — NO LightGBM | ⚠️ RULE9 VIOLATION fire-273. stag=12 — diversify threshold 3cy away! VM: (1) save XGB-0.24994, (2) add LightGBM |
...
| 264 | 2026-06-03T20h | EVEN | Axelrod-verify-FULL-PASS-SHAs-NBA-85e7682e1d(6034L)/POL-6983c86517(4018L)-UNCHANGED-py_compile-OK-11/12-OK(sacrificial-mismatch-known-intentional); S18-~c815-32ND-RESET-c792-PREDICTED-CONFIRMED-ET-0.219-0.220-FATE-UNKNOWN(/api/export-35th-CRITICAL)-next~c817; S22-~c189-7TH-RESET-c178-PREDICTED-CONFIRMED-RULE8-post-reset-UNKNOWN-next~c203; evo5-~c1381-32ND-RESET-c1376-PREDICTED-CONFIRMED-pre-CLEAN-post-UNKNOWN; S15-~c1177-34TH-RESET-c1176-PREDICTED-APPROACHING-pre-CLEAN; evo4-~c944-34TH-RESET-c939-PREDICTED-CONFIRMED; S13/S14-404-DOWN(88+fires); all-POL-carry-forward; EVEN-WebSearch:arXiv:2602.14913-Pseudo-Calibrated-CP-Distribution-Shift-NEW(priority=121)+arXiv:2506.05583-CP-Adaptive-Subpopulation-Shifts-NEW(priority=122); 2-proposals-written |
