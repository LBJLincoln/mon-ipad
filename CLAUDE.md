...
> Architecture v21 — "The Trading Floor Crew" (14 agents × 9 depts × 4 tracks) + TF v3 (17 LLM agents) + 21 Evolution Islands | Updated: 2026-05-30T02h
...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-191 (25+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-191 |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST stable gen=6672 pareto=13 — SLEEPING fire-191 |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 129+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c1046 g3136 stag~0 pareto=16(↑11↑16-MAJOR-RECOVERING!); Rule8-10TH-VIOLATION-CONFIRMED(c1000+c1025-BOTH-reintroduced-stacking-LightGBM-dominant-c1046); next-~c1050(4cycles-IMMINENT); best_brier=0.22236-STALE(since-2026-05-25-5+days); ET-0.21845-PRESUMED-LOST; VM: diff-S22-vs-S18-app.py-for-fix-reference; /api/export-404(WebFetch-15-fire-confirmed) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c1003 g3007 stag=0 pareto=12(STABLE); c978+c1003-CONFIRMED(c953+25=c978,c978+25=c1003-stag_cycles=24-at-c1002-reset-triggered); Rule8-COMPLIANT(no-stacking-fire191-LR/XGB/LightGBM/CatBoost/RF); next-~c1028(25cycles); /api/export-404(WebFetch-15-fire-confirmed) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-191 |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-191 |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-191 |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-191 |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-191 |
...
Do NOT push to HF Spaces (nba-llm-trading-floor, political-llm-trading-floor) until user explicitly approves. NBA TF 503 DOWN 129+d. POL TF IDLE 39+d.
...
- Parity: blob SHAs NBA f455c4758a(468146chars)/POL f3bb5f31ce(196489chars) UNCHANGED by size analysis (verified fire-191)
- 13/13 parity symbols OK (carry-forward from fire-189; C→B→A call-order confirmed NBA:L5056/5065/5073 POL:L3246/3255/3263; compute_consensus_distance(KL) ε-smoothed self-excluded confirmed)
- Mech-B+C-BLOCKED: do_not_push_hf_space_yet + NBA-503-129+d + POL-IDLE-39+d
...
| 182 | 2026-05-28T14h | EVEN | Axelrod-verify-pass: SHAs-NBA-19f4acf49d(5993L)/POL-3496362c60(3977L)-UNCHANGED-vs-fire-181; 13/13-parity-OK; Mech-B+C-BLOCKED(do_not_push_hf_space_yet+NBA-503-123+d+POL-IDLE-35+d); all-NBA/POL-404-DOWN(sleeping) |
