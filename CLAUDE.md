...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-227 (53+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed — SLEEPING fire-227 (53+ fires) |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST RF-75f — 404-DOWN fire-227 (53+ fires sleeping) |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 144+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | EVOLVING | 0.22326 | **fire-227**: c=153 g=457 stag=0 pareto=10(recovering ↑9→10). best_brier=0.22326 (plateau). c142=2ND AUTO-RESET CONFIRMED (stag hit 25 from c67 base). next reset ~c167 (c142+25). /api/export-404(6th fire). VM: curl /api/export S18. |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | **fire-227** ⚡⚡EXTREME URGENT: c=1606 g=4816 stag=2 pareto=10. RF-200f-0.21953-gen=4814-BELOW-FLEET-BEST-0.22012! c1603=25TH-RESET-CONFIRMED(c1578+25=c1603-EXACT). Rule8-CLEAN(RF+LGB+CAT-NO-STACKING confirmed). next-reset~c1628. best_brier=0.22124(field-lag). /api/export-404(44th). VM: curl /api/export S22 IMMEDIATELY — checkpoint RF-200f-0.21953! |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-227 (53+ fires) |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-227 (53+ fires) |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-227 (53+ fires) |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-227 (53+ fires) |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-227 (53+ fires) |
...
fire-227 UPDATE S18: c=153 g=457 stag=0 pareto=10(recovering 9→10). c142=2ND AUTO-RESET CONFIRMED (stag hit 25 from c67 base). best_brier=0.22326 plateau. next reset ~c167 (c142+25). c67=1ST CLEAN + c142=2ND CLEAN — no stacking observed at either auto-reset. /api/export-404(6th). VM: curl /api/export S18 to formally confirm Rule8 at c142 pool.
fire-227 UPDATE S22: c=1606 g=4816 stag=2 pareto=10. c1603=25TH-RESET-CONFIRMED(c1578+25=c1603-EXACT). Rule8-CLEAN(RF+LGB+CAT-NO-STACKING confirmed from /api/status model_types_in_top5). RF-200f-0.21953-gen=4814-BELOW-FLEET-BEST-0.22012-EXTREME-URGENT! best_brier=0.22124(field-lag). next-reset~c1628. /api/export-404(44th). VM: curl /api/export IMMEDIATELY — checkpoint RF-200f-0.21953 before eviction at ~c1628!
...
- Parity: SHAs NBA 85e7682e1d(6035L)/POL 6983c86517(4019L) verified fire-227; fire-225 added +12L each for ablation flags (NBA:6023L→6035L, POL:4007L→4019L). 13/13 parity maintained.
...
|------|------|--------|------------|
| 227 | 2026-06-05T04h | ODD | S22-c1606-g4816-stag=2-pareto=10-c1603=25TH-RESET-CONFIRMED(c1578+25=c1603-EXACT)-RF-200f-0.21953-EXTREME-URGENT!-BELOW-FLEET-BEST-0.22012-Rule8-CLEAN(RF+LGB+CAT)-next-reset~c1628-/api/export-404(44th); S18-c153-g457-stag=0-pareto=10-c142=2ND-AUTO-RESET-next-reset~c167-best_brier=0.22326-plateau-/api/export-404(6th); S13/S14/S15-404-DOWN(53+fires); all-POL-404-DOWN(53+fires); ODD-no-WebSearch; Axelrod-SHAs-NBA-85e7682e1d/POL-6983c86517-UNCHANGED |
...
| 224 | 2026-06-04T16h | EVEN | S18-c84-g251-stag=0-pareto=14-c67=1ST-AUTO-RESET-CONFIRMED(XGB/LGB/CAT-NO-STACKING-RULE8-1ST-CLEAN-GEN0!)-best_brier=0.22326-gen124; S22-c1557-g4669-c1528=22ND-RESET+c1553=23RD-RESET-CONFIRMED(lgbm/RF/LR-NO-STACKING!)-RF200f-0.2197-PRESUMED-LOST(2-resets)-next-~c1578; /api/export-404-BOTH(S22-41st,S18-3rd); S13/S14/S15-404-DOWN(51+fires); all-POL-404-DOWN(51+fires); EVEN: arXiv:2602.19284-Localized-Conformal-Model-Selection-Feb2026-proposal-written |
