...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-185 (21+ fires) |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-185 |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST stable gen=6672 pareto=13 — SLEEPING fire-185 |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 124+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c931 g2791 stag=0(AUTO-RESET-c925!-stag-hit-25)-pareto=12(STABLE); ET-200f-Brier~0.221-0.223-top-pareto(near-0.22085-threshold); RF-44f-best_brier=0.22236(field-lag); CatBoost-0.21995-POSSIBLY-LOST(c850+c925-resets); c925-Rule8-POSSIBLE-1ST-CLEAN-RESET(5-archs-no-stacking-UNCONFIRMED); next-auto-reset-~c956(stag-triggered); /api/export-404(WebFetch-11-fire-confirmed) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c837 g2510 stag=0-pareto=48(↑13→48-MASSIVE-SURGE!-fire-185); c828/829-hard-reset-CONFIRMED(XGB+LGBM+RF-NO-STACKING-Rule8-8TH-CLEAN!); LR-43f-still-dominant(fire-185-API-explicit); ET-200f-sigmoid-top-pareto; RF-48f-best_brier=0.22124(FIELD-LAG-LIKELY-with-48-candidates); ET-0.21877-MAY-BE-IN-PARETO(15+fires-EXTREME-URGENT); next-auto-reset-~c853(c828+25-16cycles); /api/export-404(11-fire-confirmed) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-185 |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-185 |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-185 |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-185 |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-185 |
...
Do NOT push to HF Spaces (nba-llm-trading-floor, political-llm-trading-floor) until user explicitly approves. NBA TF 503 DOWN 124+d. POL TF IDLE 36+d.

### Rule #8 — No Stacking
Remove 'stacking' from MODEL_TYPES on all islands. Stacking causes overfitting. Prior violations: S13, S14, S15, S18, S22. ⚠ S18 Rule#8 5TH VIOLATION CONFIRMED fire-183: c850 auto-reset description explicitly includes 'stacking variants'. Pattern confirmed: ALL 5 auto-resets (c750/c775/c800/c825/c850) reintroduce stacking via broken fallback in app.py. VM: Fix permanently — remove 'stacking' from the reseeding pool in app.py auto-reset code. fire-184 UPDATE: S18 stag=16 (>15 Rule#6 diversify needed) pareto=12 (19→15→12, 3rd consecutive shrink post-c850); API reports 'ensemble methods with 200 features' for top Brier candidates — possible stacking still active. Auto-reset ~c901 (stag-triggered: 9 more cycles to stag=25). CatBoost-0.21995 gen=2505 (fire-181) POSSIBLY LOST in c850 reset — verify via /api/export. fire-185 UPDATE: S18 c925 auto-reset CONFIRMED (stag hit 25 from stag=16 at fire-184, +9 cycles). Reset description: 'reseeding 36 individuals across five model architectures, boosting mutation to 0.15' — NO explicit stacking mention. POSSIBLE FIRST CLEAN AUTO-RESET in S18 history (c750/c775/c800/c825/c850 ALL had stacking explicitly). Pareto=12 STABLE. ET 200f Brier~0.221-0.223 in pareto. Unconfirmed without /api/export (11th WebFetch failure). Next auto-reset ~c956. VM: fix auto-reset fallback PERMANENTLY before ~c956. ⚠ S22 Rule#8 COMPLIANT 8th consecutive fire (177+178+179+180+181+183+184+185): c828/829 reset description 'XGBoost, LightGBM, random forests' — no stacking. LR 43f dominating (calibration-focused). Remaining confirmed violations: S13/S14/S15 (sleeping, pending checkpoint+verify).
...
2. **Split Conformal Calibration** (fire-168 EVEN WebSearch)
   ...
   - Target: S18 RF/LightGBM pareto (c931) + S22 RF-48f + S15 RF-75f
...
10. **Calibration vs Accuracy Model Selection** (fire-172 EVEN WebSearch)
    ...
    - fire-185 VALIDATION (8th fire): S22 LR 43f CONFIRMED dominating in API (explicit: '43-feature logistic regression dominating recent evolution despite initial random forest leadership') — calibration-focused linear model wins in evolved population
