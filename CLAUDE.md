...
HF EVOLUTION ISLANDS — 11 SURVIVORS (6 NBA + 5 POL) after 2026-04-17 cull
    ...
    ├── S13 Nomos42/nba-evo-4:        xgboost_brier       gen=1887  brier=0.22216  stagnation=0  ✓ cycle=629; hard-reset-c604(stag=25); LR+stacking in pool (Rule#8 violation URGENT vm-remove-stacking-s13); pareto=7; ⚡PARETO-0.21984-1ST-DETECT(fire-133,WARNING-possible-stacking-Rule8-monitor-fire134) (2026-05-19T22h)
    ├── S14 Nomos42/nba-evo-5:        extra_trees         gen=296   brier=0.22793  stagnation=0  ✓ cycle=99; internal-hard-reset-c78(cycle-stag=25); cycle-level-stag~21c-post-reset(island-manages-internally) (2026-05-19T22h)
    ├── S15 Nomos42/nba-evo-6:        random_forest       gen=5352  best=0.22012   stagnation=0  ✓ cycle=1784; ★ FLEET BEST 0.22012; hard-reset-c1726; pareto=14(↑from-10) (2026-05-19T22h)
    ├── S17 LBJLincoln26/nba-evo-s17: ---                 gen=---   brier=---      🔴 503 DOWN 100+ days — VM RESTART REQUIRED (2026-05-19T22h)
    ├── S18 TESTforge42/nba-evo-s18:  random_forest       gen=312   brier=0.22236  stagnation=0  ✓ cycle=104; stag-CLEARED(11→0-fire133); pareto=5(was-17); recovering-reboot-rapid-recovery (2026-05-19T22h)
    └── S22 TESTforge42/nba-evo-s22:  random_forest       gen=109   brier=0.22124  stagnation=0  ✓ cycle=37; recovering-factory-reboot; RF-48f; pareto=12; REMARKABLE-0.22124-stable; vm-checkpoint-s22 PRIORITY=1 (2026-05-19T22h)
    Political Survivors (5, CPU tree-only):
    ├── P1 Nomos42/political-alpha:      xgboost_brier       gen=4781   brier=0.24987 stagnation=0  ✓ POL-FLEET-BEST; cycle=1594; pareto=8(↑from-6); feature_candidates=272-awaiting-Space-reload (2026-05-19T22h)
    ├── P2 Nomos42/political-alpha-2:    xgboost_brier       gen=58370  brier=0.25003 stagnation=0  ✓ cycle=19457; pareto=8(↑from-6); feature_candidates=272-awaiting-reload (2026-05-19T22h)
    ├── P4 LBJLincoln/political-alpha-4: extra_trees         gen=1020   brier=0.25337 stagnation=0  ⚠ FACTORY-REBOOT-fire130; cycle=340; pareto=7; xgb-0.24998-DROPPED(evicted-gen1020-fire133); CatBoost-0.25019-pareto-rank0(new-leader); vm-investigate-p4-factory-reboot pending (2026-05-19T22h)
    ├── P5 LBJLincoln/political-alpha-5: xgboost_brier       gen=79183  brier=0.24993 stagnation=0  ✓ cycle=26395; pareto=4; top_performer-LightGBM-102f-0.249-gen75933-stable (2026-05-19T22h)
    └── P7 LBJLincoln/political-alpha-7: xgboost_brier       gen=13532  brier=0.25004 stagnation=0  ✓ cycle=4511; pareto=6(↑3→6-GROWING-more-secure); LightGBM-0.24931-CONFIRMED-more-secure; vm-checkpoint-p7-lgbm-0.24931 URGENT priority=1 (2026-05-19T22h)
```
