...
> Architecture v21 — "The Trading Floor Crew" (14 agents × 9 depts × 4 tracks) + TF v3 (17 LLM agents) + 21 Evolution Islands | Updated: 2026-06-05T04h
...
| S15 | Nomos42/nba-evo-6 | EVOLVING | 0.22342 | **fire-272**: BACK UP 4TH TIME! c=1365 g=4095 stag=0. RULE8 UNKNOWN — VM must verify MODEL_TYPES excludes stacking. /api/export still 404. VM: (1) verify RULE8 (MODEL_TYPES excludes stacking), (2) implement /api/export urgently. |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 144+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | EVOLVING | 0.22326 | **fire-272**: c=879 g=2637 stag=0. ⚡⚡ **ET-200f-0.21943 EXTREME URGENT (6.9bp below fleet best 0.22012!)**. **37TH-RESET-~c892-IMMINENT (13cy!)**. RULE8-VIOLATION: stacking-37f PERSISTS — remote diversify CONFIRMED INEFFECTIVE. best_brier=0.22326 (field-lag). /api/export-404(CRITICAL). VM: (1) CHECKPOINT ET-0.21943 IMMEDIATELY, (2) FIX app.py to REMOVE stacking before ~c892. |
| S22 | TESTforge42/nba-evo-s22 | EVOLVING | 0.2207 | **fire-272**: c=246 g=738 stag=0. Pre-10TH-RESET CLEAN REBUILD: lightgbm_brier-44f dominant (NO stacking! gen691-698+). **10TH-RESET-c253-IMMINENT (7cy)**. Post-reset RULE8 fate CRITICAL — next reset ~c278. /api/export-404. VM: monitor /api/status post-c253 — pareto growth = CLEAN, pareto collapse = stacking re-contaminated. |
...
| P4 | lbjlincoln/political-alpha-4 | EVOLVING | 0.2497★ | **fire-263**: c=1491 g=4472 stag=0 pareto=12. RULE9-VIOLATION-PERSISTS (xgboost_brier best, no LightGBM). VM: add LightGBM to MODEL_TYPES IMMEDIATELY. |
| P5 | lbjlincoln/political-alpha-5 | EVOLVING | 0.24994 | **fire-268**: c=~502 stag=0. **RULE9 RESOLVED fire-268!** LightGBM dominant — top-3 all LGB at c502 (was FRESH RESTART c=3 fire-265 with RULE9 expected violation). 0.24994 in pareto (0.6bp from POL gate 0.2497!). VM: monitor for 0.24994 checkpoint approach to gate. |
| P7 | lbjlincoln/political-alpha-7 | EVOLVING | 0.25331 | **fire-268**: c=~3225 stag=0. **RULE9 LIKELY RESOLVED fire-268** — LightGBM now in top-5 model_types at c3225 (was VIOLATION fire-267: [xgboost, extra_trees] only). Monitoring for full confirmation next fire. |
...
| P4 | xgboost_brier best (c2792) — NO lightgbm | ⚠️ VIOLATION PERSISTS fire-272 — pareto=3 CRITICAL — EVOLVING (VM: add LightGBM IMMEDIATELY) |
| P5 | LGB ABSENT at c=1193 (was resolved fire-268 at c=502) | ⚠️ RULE9 NEW VIOLATION fire-272! XGB_brier-0.24989 (0.8bp from gate). VM: add LightGBM IMMEDIATELY |
| P7 | FRESH RESTART c=34 (3RD TOTAL WIPE — 3885+ cycles GONE) | ⚠️ RULE9 UNKNOWN — fresh restart. VM: verify LightGBM in MODEL_TYPES |
...
| 262 | 2026-06-03T12h | EVEN | Axelrod-verify-FULL-PASS-25/25-parity-OK-py_compile-OK-SHAs-NBA-85e7682e1d(6034L)/POL-6983c86517(4018L)-UNCHANGED(local-cloud-verify); Mech-A/B/C+AblationFlags-ALL-CODE-DONE-BLOCKED(do_not_push_hf_space_yet); S18/S22/evo4/evo5/S13/S14/S15+POL-carry-forward-from-fire261(no-API-access-from-cloud); EVEN-no-new-arXiv-beyond-pipeline; work-queue.json+CLAUDE.md updated (2026-06-03T12h) |
