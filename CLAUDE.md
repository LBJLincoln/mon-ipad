...
|--------|---------|--------|-----------|-------|
| S13 | TESTforge42/nba-evo-s13 | 404-DOWN | 0.22216 (field-lag) | CatBoost-200f-0.21992 gen=2831 EXTREME URGENT — still 404-DOWN fire-177 |
| S14 | TESTforge42/nba-evo-s14 | 404-DOWN | 0.22054 RF-48f | BELOW THRESHOLD confirmed fire-157+158 — SLEEPING fire-177 |
| S15 | LBJLincoln26/nba-evo-6 | 404-DOWN | 0.22012★ | FLEET BEST stable gen=6672 pareto=13 — SLEEPING fire-177 |
| S17 | LBJLincoln26/nba-evo-s17 | 503 DOWN 122+d | — | PAUSED |
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c788 g2362 stag=0 pareto=12(↓13→12-2nd-consec-shrink); ⚠CRITICAL-RULE8-STACKING-API-CONFIRMED-fire177(LightGBM+XGBoost+ET+stacking-ALL-ACTIVE-API-explicit); VM-HARD-RESET-URGENT(priority=0); /api/export-404(WebFetch-5-fire-confirmed) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c701 g2102 stag=0 pareto=7(↓16→7-MAJOR-DROP!); 2hard-resets-c653+c678(LR-focused); auto-reset-imminent(~c703=c678+25); Rule8-LIKELY-COMPLIANT(random_forest-primary-fire177); ET-0.21877-EXTREME-URGENT(9+fires); /api/export-404(WebFetch-5-fire-confirmed) |

### POL Islands (active)
| Island | HF Repo | Status | Best Brier | Notes |
|--------|---------|--------|-----------|-------|
| P1 | TESTforge42/political-evo-p1 | 404-DOWN | pareto_best=0.24902 | LightGBM-105f 3RD-OBSERVE fire-158 ALL-TIME RECORD — SLEEPING fire-177 |
| P2 | TESTforge42/political-evo-p2 | 404-DOWN | 0.249 | pareto=3 CRITICAL-SHRINK fire-158 — SLEEPING fire-177 |
| P4 | TESTforge42/political-evo-p4 | 404-DOWN | 0.2497★ | POL FLEET BEST pareto=5 oscillation — SLEEPING fire-177 |
| P5 | TESTforge42/political-evo-p5 | 404-DOWN | 0.24993 | pareto=6 RECOVERING fire-158 — SLEEPING fire-177 |
| P7 | TESTforge42/political-evo-p7 | 404-DOWN | 0.24931 | LightGBM-112f stable pareto=7 — SLEEPING fire-177 |
...
Do NOT push to HF Spaces (nba-llm-trading-floor, political-llm-trading-floor) until user explicitly approves. NBA TF 503 DOWN 122+d. POL TF IDLE 33+d.

### Rule #8 — No Stacking
Remove 'stacking' from MODEL_TYPES on all islands. Stacking causes overfitting. Prior violations: S13, S14, S15, S22. ⚠ S18 RULE#8 CRITICAL VIOLATION API-CONFIRMED fire-177: /api/status explicitly lists 'LightGBM, XGBoost, Extra Trees, and ensemble stacking approaches with sigmoid/beta calibration methods'. c750 auto-reset fallback STILL hardcodes stacking — NOT fixed across fires 175/176/177. VM must: (1) hard-reset immediately WITHOUT stacking, (2) permanently fix auto-reset reseeding config to exclude 'stacking'. Item: vm-s18-rule8-stacking-priority0 (priority=0 CRITICAL). ⚠ S22 Rule#8 LIKELY RESOLVED fire-177: c701 primary=random_forest, no stacking mention (2 consecutive fires fire-176+177). Still unconfirmed without /api/export MODEL_TYPES. Remaining confirmed violations: S13/S14/S15/S18.
...
- Parity: SHAs NBA 19f4acf49d(5993L)/POL 3496362c60(3977L) UNCHANGED vs fire-177 (verified fire-178)
- 13/13 parity symbols OK (verified fire-178; C→B→A call-order confirmed NBA:L5056/5065/5073 POL:L3246/3255/3263; compute_consensus_distance(KL) ε-smoothed self-excluded confirmed)
...
2. **Split Conformal Calibration** (fire-168 EVEN WebSearch)
   ...
   - Target: S18 RF/LightGBM pareto (c788) + S22 RF-48f + S15 RF-75f
...
| 177 | 2026-05-27T18h | ODD | S18-c788-g2362-stag=0-pareto=12(↓13→12-2nd-consec-shrink)-⚠RULE8-STACKING-API-CONFIRMED(LightGBM+XGBoost+ET+stacking-active)-VM-HARD-RESET-CRITICAL; S22-c701-g2102-stag=0-pareto=7(↓16→7-MAJOR-DROP!)-2hard-resets-c653+c678-auto-reset-imminent(~c703)-Rule8-LIKELY-COMPLIANT(random_forest-primary)-ET-0.21877-EXTREME-URGENT(9+fires); S13/S14/S15-404-DOWN; all-POL-404-DOWN; ODD-no-WebSearch |
| 176 | 2026-05-27T14h | EVEN | S18-c774-g2320-stag=0-pareto=13(↓14→13-1st-shrink)-⚠CRITICAL-RULE8-STACKING-REINTRODUCED-c750-AUTO-RESET(xgb+lgbm_brier+catboost+lr+stacking)-VM-HARD-RESET-URGENT(priority=0); S22-c668-g2002-stag=0-pareto=16(↑10→16-STRONG-RECOVERY!)-2nd-hard-reset-c653(NEW-LR-focused)-ET+sigmoid-top-performers-Rule8-LIKELY-COMPLIANT-ET-0.21877-EXTREME-URGENT(8+fires); S13/S14/S15-404-DOWN; all-POL-404-DOWN; EVEN: arXiv:2410.21484-no-new-proposal; vm-s18-rule8-stacking-c750-fire176 ADDED |
| 175 | 2026-05-27T10h | ODD | S18-c756-g2268-stag=0(AUTO-HARD-RESET-c750-CONFIRMED!)-pareto=14(↑13→14-4th-consec-recovery); S22-c645-g1935-stag=0-hard-reset-c628-NEW-Rule8-POTENTIALLY-RESOLVED(no-stacking-description-fire175); /api/export-404-BOTH(3-fire-confirmed-WebFetch); S13/S14/S15-404-DOWN; all-POL-404-DOWN; ODD-no-WebSearch |
...
| 173 | 2026-05-27T02h | ODD | S18-c748-g2242-stag=22(↑11→13-PARETO-RECOVERING!)-hard-reset-~c725-confirmed; S22-c611-g1832-stag=0-hard-reset-c603-NEW-STACKING-IN-DESCRIPTION(Rule8-CONCERN-VM-export-urgent); /api/export-404-S18+S22(confirmed-WebFetch-limitation-2-fires); S13/S14/S15-404-DOWN; all-POL-404-DOWN; ODD-no-WebSearch |
| 172 | 2026-05-26T22h | EVEN | S18-c730-g2189-stag=0-pareto=11(↑17→11-5th-consec-shrink)-cycle_stag~29(>15-WATCH); S22-c581-g1742-stag=0-LR-stable-summary; /api/export-404-BOTH-S18+S22(WebFetch-limitation-VM-must-curl-verify); S13/S14/S15-404-DOWN; all-POL-404-DOWN(sleeping); EVEN: arXiv:2303.06021-calibration-vs-accuracy-ECE-pareto-objective-proposal-written |
| 171 | 2026-05-26T18h | ODD | S18-c710-g2130-stag=0-cycle_stag=9-pareto=17(↑16→17)-hard-resets-c675+c700(NO-STACKING-Rule8-COMPLIANT); S22-c556-g1668-stag=0-hard-reset-c553(xgb/lgbm/catboost-NO-STACKING)-Rule8-SELF-RESOLVED(c503+c553-2-consecutive-clean-resets); ET-0.21877-unconfirmed; S13/S14/S15-404-DOWN; all-POL-404-DOWN; ODD-no-WebSearch |
| 170 | 2026-05-26T14h | EVEN | Axelrod verify pass: SHAs-NBA-19f4acf49d(5993L)/POL-3496362c60(3977L)-UNCHANGED-vs-fire-163; 13/13-parity-OK; C→B→A-confirmed; compute_consensus_distance(KL)-ε-smoothed-self-excluded-OK; AXELROD_ARCHETYPES-NBA-20-sports/POL-20-political-financial-OK; Mech-B+C-BLOCKED; all-NBA/POL-404-DOWN(sleeping) |
| 169 | 2026-05-26T08h | ODD | Axelrod-verify-pass: SHAs-NBA-19f4acf49d(5993L)/POL-3496362c60(3977L)-UNCHANGED-vs-fire-167; all-3-mechs-confirmed(A:COMMON_KNOWLEDGE+build_common_knowledge_block;B:AXELROD_ARCHETYPES+sacrificial_map;C:AXELROD_LOG_DIR+axelrod-log); NBA-domain-sports/POL-domain-political-financial-OK; Mech-B+C-BLOCKED; all-NBA/POL-404-DOWN(sleeping) |
