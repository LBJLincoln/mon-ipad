...
| S18 | TESTforge42/nba-evo-s18 | UP | 0.22236 | c1024 g3071 stag=0 pareto=11(↑10↑11-RECOVERING!); Rule8-9TH-VIOLATION-c1009-DIVERSIFY-INDUCED(stacking-70f-via-remote-diversify-c1008-CRITICAL-fix-BOTH-auto-reset+diversify-pool!); next-auto-reset-~c1025-IMMINENT(1cycle-from-c1024!); ET-0.21845-PRESUMED-LOST(best_brier-0.22236-unchanged-5days-STALE); RF-200f-lr_meta-top-composite; remote-diversify-c982/c995/c1008/c1022; /api/export-404(WebFetch-14-fire-confirmed) |
| S22 | TESTforge42/nba-evo-s22 | UP | 0.22124 | c977 g2931 stag=0; c953-CONFIRMED(c928+25=c953-fire190); next-auto-reset-~c978-IMMINENT(c953+25=c978-1cycle-from-c977!); c953-Rule8-LIKELY-CLEAN(no-stacking-fire190); best_model_type=RF(LR-dominance-ended-c934→c977); c903+c928+c953-resets-confirmed; /api/export-404(WebFetch-14-fire-confirmed) |
...
- Parity: SHAs NBA 19f4acf49d(5994L)/POL 3496362c60(3978L) UNCHANGED vs fire-190 (verified fire-191)
- 13/13 parity symbols OK (verified fire-191; C→B→A call-order confirmed NBA:L5056/5065/5073 POL:L3246/3255/3263; compute_consensus_distance(KL) ε-smoothed self-excluded confirmed)
- Mech-B+C-BLOCKED: do_not_push_hf_space_yet + NBA-503-128+d + POL-IDLE-39+d
...
13. **Long-Sequence LSTM for NBA (multi-season dataset)** (fire-190 EVEN WebSearch)
    ...
    - Synergies: arXiv:2508.02725 LSTM+Brier-loss NCAA-validated, MDPI/2078-2489/17/1/56 MC-dropout wrapper
...
|------|------|--------|------------|
| 191 | 2026-05-30T02h | ODD | Axelrod-verify-pass: SHAs-NBA-19f4acf49d(5994L)/POL-3496362c60(3978L)-UNCHANGED-vs-fire-190; 13/13-parity-OK; C→B→A-confirmed(NBA-L5056/5065/5073-POL-L3246/3255/3263); KL-div-ε-smoothed-self-excluded-OK; AXELROD_ARCHETYPES-NBA-20-sports/POL-20-political-financial-OK; Mech-B+C-BLOCKED(do_not_push_hf_space_yet+NBA-503-128+d+POL-IDLE-39+d); all-NBA/POL-404-DOWN(sleeping) |
| 190 | 2026-05-29T22h | EVEN | S18-c1024-g3071-stag=0-pareto=11(RECOVERING!)-Rule8-9TH-VIOLATION-c1009-DIVERSIFY-INDUCED(stacking-70f-remote-diversify-c1008-CRITICAL-fix-BOTH-auto-reset+diversify-pool); next-auto-reset-~c1025-IMMINENT(1cycle!); ET-0.21845-PRESUMED-LOST(5days-stale); S22-c977-g2931-stag=0-pareto=12-c953-CONFIRMED(c928+25=c953)-next-~c978-IMMINENT(1cycle!)-c953-Rule8-LIKELY-CLEAN; S13/S14/S15-404-DOWN(24+fires); all-POL-404-DOWN(24+fires); EVEN: arXiv:2512.08591-Long-Sequence-LSTM-NBA-8seasons-9840games-proposal-written |
| 189 | 2026-05-29T18h | ODD | Axelrod-verify-pass: SHAs-NBA-19f4acf49d(5994L)/POL-3496362c60(3978L)-UNCHANGED-vs-fire-188; 13/13-parity-OK; C→B→A-confirmed(NBA-L5056/5065/5073-POL-L3246/3255/3263); KL-div-ε-smoothed-self-excluded-OK; AXELROD_ARCHETYPES-NBA-20-sports/POL-20-political-financial-OK; Mech-B+C-BLOCKED(do_not_push_hf_space_yet+NBA-503-127+d+POL-IDLE-38+d); all-NBA/POL-404-DOWN(sleeping) |
