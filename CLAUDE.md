...
HF EVOLUTION ISLANDS — 11 SURVIVORS (6 NBA + 5 POL) after 2026-04-17 cull
    ...
    ├── S13 Nomos42/nba-evo-4:        xgboost_brier       gen=594   brier=0.22344  stagnation=0  ✓ cycle=198; stag CLEARED 8→0; hard resets 101+126; ⚠ stacking in MODEL_TYPES vm-remove-stacking-s13 (2026-05-15T06h)
    ├── S14 Nomos42/nba-evo-5:        extra_trees         gen=2953  brier=0.22336  stagnation=0  ✓ cycle=985; hard reset cycle=978 (25-stag); ⚠ stacking in MODEL_TYPES vm-remove-stacking-s14 (2026-05-15T06h)
    ├── S15 Nomos42/nba-evo-6:        random_forest       gen=3227  best=0.22012   stagnation=0  ✓ cycle=1076; ★ FLEET BEST 0.22012 stable; CatBoost 200f 0.21932 unconfirmed 2nd brain fire (2026-05-15T06h)
    ├── S17 LBJLincoln26/nba-evo-s17: ---                 gen=---   brier=---      🔴 503 DOWN 72+ days — VM RESTART REQUIRED (2026-05-15T06h)
    ├── S18 TESTforge42/nba-evo-s18:  xgboost_brier       gen=7305  brier=0.22315  stagnation=0  ✓ cycle=2435; stag RECOVERED; resets 2201+2226+2351 (2026-05-15T06h)
    └── S22 TESTforge42/nba-evo-s22:  extra_trees         gen=2298  brier=0.22551  stagnation=0  ✓ cycle=766; hard resets 690+715+740; vm-add-lightgbm-s22-s13 + vm-remove-stacking-s22 PENDING VM (2026-05-15T06h)
    Political Survivors (5, CPU tree-only):
    ├── P1 Nomos42/political-alpha:      xgboost_brier       gen=59997  brier=0.2499  stagnation=0  ✓ cycle=19999 stable; milestone (2026-05-15T06h)
    ├── P2 Nomos42/political-alpha-2:    xgboost_brier       gen=49726  brier=0.25003 stagnation=0  ✓ cycle=16576; ⚡ in-pop LightGBM 123f 0.249 field-lag 7+ fires (PENDING VAL) (2026-05-15T06h)
    ├── P4 LBJLincoln/political-alpha-4: xgboost_brier       gen=79605  brier=0.24992 stagnation=0  ✓ cycle=26535; ★ POL FLEET BEST alltime=0.24904; in-pop LightGBM 108f gen=79604 (2026-05-15T06h)
    ├── P5 LBJLincoln/political-alpha-5: xgboost_brier       gen=67756  brier=0.24993 stagnation=0  ✓ cycle=22586; LightGBM persistent 5+ fires (2026-05-15T06h)
    └── P7 LBJLincoln/political-alpha-7: lightgbm            gen=71018  brier=0.25412 stagnation=0  ⚠ cycle=23673; FIELD-LAG 6+ fires; vm-diversify-p7-fire109 URGENT (cloud POST blocked) (2026-05-15T06h)
```
