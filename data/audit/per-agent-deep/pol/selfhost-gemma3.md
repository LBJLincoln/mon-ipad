...
> **Cash:** 0.45% — 45% cash held to satisfy ≥75% deployment requirement while avoiding sector overconcentration in saturated tech/finance signals.

| event | category | odds | edge | stake | won | profit | rationale |
|---|---|---:|---:|---:|:---:|---:|---|
| 13 | insider_trade:long | — | — | $10.00 | ✓ | +3.85 | UNH insider trade (event 13) reinforces healthcare sector strength with consistent SEC Form 4 signals. Sector_trends show healthcare as top performer with 100% win rate. |

## Day 31 — 2025-02-19 (bankroll: $103.85 → $99.71)
> **Strategy:** STRUCTURAL DIVERGE [qwen-quant] (edge=6.2%): My Handshake canon rejects healthcare-heavy consensus; tech insider clusters (AMZN/GOOGL/META) offer higher sector-beta >0.8 with clear Form 4 signals. Focus on tech ETFs to exploit momentum divergence from council's healthcare tilt.
> **Cash:** 0.35% — Cash held to maintain ≥3 distinct sectors and comply with DMAD anti-consensus gate; allocations prioritize non-consensus tech sector per Handshake canon.

| event | category | odds | edge | stake | won | profit | rationale |
|---|---|---:|---:|---:|:---:|---:|---|
| 1 | insider_trade:long | — | — | $9.35 | ✗ | -1.67 | AMZN insider trades (events 1-3) with SEC Form 4 signals and donor sector=tech delivered=NO indicate bullish momentum; tech sector-beta 0.83 supports XLK exposure. |
| 15 | insider_trade:long | — | — | $7.79 | ✗ | -0.27 | GOOGL insider trades (event 15) with SEC Form 4 and donor sector=tech delivered=NO signal bullish momentum; tech sector trend avg_ret=+0.0037 supports XLK allocation. |
