...
- **Final Capital:** $100,401.14
- **ROI:** +0.4011%
- **Sharpe Ratio:** 9.348
- **Record:** 52W-43L
- **Win Rate:** 54.7%
- **Peak Capital:** $100,401.14
- **Max Drawdown:** 0.1%
- **Wagered:** $146,403.20
...
|----------|--------|-----|----------|
| sector_rotation | 19 | $+230.67 | 57.9% |
| insider_follow | 34 | $+191.62 | 58.8% |
| pairs_trading | 42 | $-21.15 | 50.0% |
...
|-----|------|--------|--------|-----|---------|
| 1 | 2026-03-12 | 3 | 8 | $-6.27 | $99,993.73 |
| 2 | 2026-03-13 | 10 | 8 | $+62.35 | $100,056.08 |
| 3 | 2026-03-16 | 10 | 8 | $-15.15 | $100,040.93 |
| 4 | 2026-03-17 | 16 | 8 | $+46.49 | $100,087.42 |
| 5 | 2026-03-18 | 16 | 8 | $+6.00 | $100,093.42 |
| 6 | 2026-03-19 | 6 | 8 | $-40.08 | $100,053.34 |
| 7 | 2026-03-20 | 10 | 8 | $-61.49 | $99,991.85 |
| 8 | 2026-03-23 | 34 | 8 | $+26.72 | $100,018.57 |
| 9 | 2026-03-24 | 26 | 8 | $+64.84 | $100,083.41 |
| 10 | 2026-03-25 | 10 | 8 | $+71.59 | $100,155.00 |
| 11 | 2026-03-26 | 971 | 7 | $+123.91 | $100,278.91 |
| 12 | 20260326 | 8 | 8 | $+122.23 | $100,401.14 |

## Trade Log (first 30 + last 30 of 95 total)
...
- **Strategy:** insider_follow | **Signal:** 0.300
- **Size:** $1,500.28 | **Return:** -1.128%
- **Loss** -> P&L $-16.92
- **Reasoning:** strategy=insider_follow | signal=0.300 short | beta=1.1

### 2026-03-24 | WMT | long
- **Strategy:** insider_follow | **Signal:** 0.300
- **Size:** $1,500.28 | **Return:** +1.171%
- **Win** -> P&L $+17.57
- **Reasoning:** strategy=insider_follow | signal=0.300 long | beta=1.0

### 2026-03-24 | XOM | long
- **Strategy:** insider_follow | **Signal:** 0.300
- **Size:** $1,500.28 | **Return:** +2.022%
- **Win** -> P&L $+30.34
- **Reasoning:** strategy=insider_follow | signal=0.300 long | beta=1.0

### 2026-03-24 | CVX | long
- **Strategy:** insider_follow | **Signal:** 0.300
- **Size:** $1,500.28 | **Return:** -0.002%
- **Loss** -> P&L $-0.02
- **Reasoning:** strategy=insider_follow | signal=0.300 long | beta=0.9

### 2026-03-24 | COP | long
- **Strategy:** sector_rotation | **Signal:** 0.300
- **Size:** $1,800.33 | **Return:** +0.284%
- **Win** -> P&L $+5.12
- **Reasoning:** strategy=sector_rotation | signal=0.300 long | beta=1.1

### 2026-03-24 | OXY | long
- **Strategy:** pairs_trading | **Signal:** 0.300
- **Size:** $1,200.22 | **Return:** +1.362%
- **Win** -> P&L $+16.35
- **Reasoning:** strategy=pairs_trading | signal=0.300 long | beta=1.4

### 2026-03-24 | HAL | long
- **Strategy:** pairs_trading | **Signal:** 0.300
- **Size:** $1,200.22 | **Return:** -0.750%
- **Loss** -> P&L $-9.00
- **Reasoning:** strategy=pairs_trading | signal=0.300 long | beta=1.3

### 2026-03-25 | SPY | long
- **Strategy:** sector_rotation | **Signal:** 1.000
- **Size:** $3,002.50 | **Return:** +3.261%
- **Win** -> P&L $+97.90
- **Reasoning:** strategy=sector_rotation | signal=1.000 long | event=fed_rule | beta=1.0

### 2026-03-25 | JPM | short
- **Strategy:** sector_rotation | **Signal:** 0.300
- **Size:** $1,801.50 | **Return:** -0.475%
- **Loss** -> P&L $-8.56
- **Reasoning:** strategy=sector_rotation | signal=0.300 short | beta=1.1

### 2026-03-25 | WMT | long
- **Strategy:** pairs_trading | **Signal:** 0.300
- **Size:** $1,201.00 | **Return:** +1.011%
- **Win** -> P&L $+12.14
- **Reasoning:** strategy=pairs_trading | signal=0.300 long | beta=1.0

### 2026-03-25 | XOM | long
- **Strategy:** insider_follow | **Signal:** 0.300
- **Size:** $1,501.25 | **Return:** -1.325%
- **Loss** -> P&L $-19.89
- **Reasoning:** strategy=insider_follow | signal=0.300 long | beta=1.0

### 2026-03-25 | CVX | long
- **Strategy:** pairs_trading | **Signal:** 0.300
- **Size:** $1,201.00 | **Return:** +0.405%
- **Win** -> P&L $+4.86
- **Reasoning:** strategy=pairs_trading | signal=0.300 long | beta=0.9

### 2026-03-25 | COP | long
- **Strategy:** pairs_trading | **Signal:** 0.300
- **Size:** $1,201.00 | **Return:** -1.710%
- **Loss** -> P&L $-20.54
- **Reasoning:** strategy=pairs_trading | signal=0.300 long | beta=1.1

### 2026-03-25 | HAL | long
- **Strategy:** insider_follow | **Signal:** 0.300
- **Size:** $1,501.25 | **Return:** +1.827%
- **Win** -> P&L $+27.43
- **Reasoning:** strategy=insider_follow | signal=0.300 long | beta=1.3

### 2026-03-25 | GS | long
- **Strategy:** pairs_trading | **Signal:** 0.300
- **Size:** $1,201.00 | **Return:** -1.811%
- **Loss** -> P&L $-21.75
- **Reasoning:** strategy=pairs_trading | signal=0.300 long | beta=1.3

### 2026-03-26 | JPM | short
- **Strategy:** sector_rotation | **Signal:** 0.300
- **Size:** $1,802.79 | **Return:** -0.546%
- **Loss** -> P&L $-9.85
- **Reasoning:** strategy=sector_rotation | signal=0.300 short | beta=1.1

### 2026-03-26 | WMT | long
- **Strategy:** insider_follow | **Signal:** 0.300
- **Size:** $1,502.33 | **Return:** +1.082%
- **Win** -> P&L $+16.25
- **Reasoning:** strategy=insider_follow | signal=0.300 long | beta=1.0

### 2026-03-26 | XOM | long
- **Strategy:** sector_rotation | **Signal:** 1.000
- **Size:** $3,004.65 | **Return:** +0.425%
- **Win** -> P&L $+12.78
- **Reasoning:** strategy=sector_rotation | signal=1.000 long | event=insider_trade | beta=1.0

### 2026-03-26 | CVX | short
- **Strategy:** sector_rotation | **Signal:** 1.000
- **Size:** $3,004.65 | **Return:** +3.564%
- **Win** -> P&L $+107.08
- **Reasoning:** strategy=sector_rotation | signal=1.000 short | event=insider_trade | beta=0.9

### 2026-03-26 | COP | long
- **Strategy:** sector_rotation | **Signal:** 0.300
- **Size:** $1,802.79 | **Return:** +0.642%
- **Win** -> P&L $+11.57
- **Reasoning:** strategy=sector_rotation | signal=0.300 long | beta=1.1

### 2026-03-26 | OXY | long
- **Strategy:** sector_rotation | **Signal:** 1.000
- **Size:** $3,004.65 | **Return:** -0.802%
- **Loss** -> P&L $-24.10
- **Reasoning:** strategy=sector_rotation | signal=1.000 long | event=insider_trade | beta=1.4

### 2026-03-26 | HAL | long
- **Strategy:** pairs_trading | **Signal:** 0.300
- **Size:** $901.39 | **Return:** +1.129%
- **Win** -> P&L $+10.18
- **Reasoning:** strategy=pairs_trading | signal=0.300 long | beta=1.3

### 20260326 | JPM | short
- **Strategy:** insider_follow | **Signal:** 0.300
- **Size:** $1,504.18 | **Return:** +1.329%
- **Win** -> P&L $+19.99
- **Reasoning:** strategy=insider_follow | signal=0.300 short | beta=1.1

### 20260326 | WMT | long
- **Strategy:** insider_follow | **Signal:** 0.300
- **Size:** $1,504.18 | **Return:** +2.878%
- **Win** -> P&L $+43.30
- **Reasoning:** strategy=insider_follow | signal=0.300 long | beta=1.0

### 20260326 | XOM | long
- **Strategy:** insider_follow | **Signal:** 0.300
- **Size:** $1,504.18 | **Return:** +0.419%
- **Win** -> P&L $+6.30
- **Reasoning:** strategy=insider_follow | signal=0.300 long | beta=1.0

### 20260326 | CVX | long
- **Strategy:** pairs_trading | **Signal:** 0.300
- **Size:** $1,203.35 | **Return:** +2.102%
- **Win** -> P&L $+25.29
- **Reasoning:** strategy=pairs_trading | signal=0.300 long | beta=0.9

### 20260326 | COP | long
- **Strategy:** pairs_trading | **Signal:** 0.300
- **Size:** $1,203.35 | **Return:** +0.788%
- **Win** -> P&L $+9.49
- **Reasoning:** strategy=pairs_trading | signal=0.300 long | beta=1.1

### 20260326 | OXY | long
- **Strategy:** sector_rotation | **Signal:** 0.300
- **Size:** $1,805.02 | **Return:** +0.912%
- **Win** -> P&L $+16.45
- **Reasoning:** strategy=sector_rotation | signal=0.300 long | beta=1.4

### 20260326 | BLK | short
- **Strategy:** pairs_trading | **Signal:** 0.300
- **Size:** $1,203.35 | **Return:** -1.308%
- **Loss** -> P&L $-15.74
- **Reasoning:** strategy=pairs_trading | signal=0.300 short | beta=1.1

### 20260326 | AXP | long
- **Strategy:** insider_follow | **Signal:** 0.300
- **Size:** $1,504.18 | **Return:** +1.140%
- **Win** -> P&L $+17.15
- **Reasoning:** strategy=insider_follow | signal=0.300 long | beta=1.0
