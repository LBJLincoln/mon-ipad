# Repo Scout Agent Memory

## User Profile
- [user_role.md](user_role.md) — Quant sports AI founder running NBA prediction system

## Project State
- [project_scan_history.md](project_scan_history.md) — History of repo scans and what was found
...
- [project_nba_data_sources.md](project_nba_data_sources.md) — Complete map of free NBA data: GitHub repos, Kaggle datasets, APIs. Full doc at /home/lahargnedebartoli/mon-ipad/docs/REPO-SCOUT-NBA-DATA.md
...
- [project_pixel_dashboard_apr2026.md](project_pixel_dashboard_apr2026.md) — 12 pixel-art game dashboard refs. Winner: pixel-agents(6.1k★) as base clone. Stack: Next.js 15 + Canvas 2D + Pixelact UI. Full report: /home/lahargnedebartoli/nomos-nba-agent/data/results/pixel-dashboard-scout.json
