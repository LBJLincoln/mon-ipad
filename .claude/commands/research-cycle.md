---
name: research-cycle
description: Run one research cycle: Claude Code agents search papers/repos/odds → extract proposals → rank
---

Run one research cycle: Claude Code agents search papers, repos, and market data → extract proposals → report.
NOTE: This is NOT a Karpathy loop. It does NOT train models or measure metrics. Use /karpathy-loop for real iteration.
