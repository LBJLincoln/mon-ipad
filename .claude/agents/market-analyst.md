...
2. **The Odds API** (key in env): Read ODDS_API_KEY from `/home/lahargnedebartoli/nomos-nba-agent/.env.local`
3. **Previous market data**: `/home/lahargnedebartoli/nomos-nba-agent/data/results/crew-market.json`
4. **Live odds snapshots**: `/home/lahargnedebartoli/mon-ipad/data/nba-agent/live-odds.json`

## Tasks
1. Fetch current NBA odds from Bovada and The Odds API
2. Compare with our model predictions (read `/home/lahargnedebartoli/nomos-nba-agent/data/results/predictions-*.json`)
...
## Output
Write to `/home/lahargnedebartoli/nomos-nba-agent/data/results/crew-market.json` as JSON:
```json
{
  "agent": "market",
  "timestamp": "ISO8601",
